...
TL;DR: LANCA uses a deterministic WAE with an ANM Layer to improve unsupervised causal discovery, showing better performance and robustness than existing methods.


<details>
  <summary>Details</summary>
Motivation: The challenge of disentangling causal variables from observational data without supervision or strong inductive biases motivates the development of LANCA.

Method: LANCA employs a deterministic Wasserstein Auto-Encoder (WAE) coupled with a differentiable ANM Layer to transform residual independence into an explicit optimization objective.

Result: LANCA resolves component-wise indeterminacy by restricting transformations to the affine class and shows empirical success on synthetic and photorealistic datasets.

Conclusion: LANCA demonstrates superior robustness to spurious correlations and outperforms state-of-the-art baselines on synthetic and photorealistic benchmarks.
...
### [2] [Wireless Traffic Prediction with Large Language Model](https://arxiv.org/abs/2512.22178)
*Chuanting Zhang,Haixia Zhang,Jingping Qiao,Zongzhang Li,Mohamed-Slim Alouini*

Main category: cs.LG

TL;DR: TIDES is a novel LLM-based framework for urban wireless traffic prediction that captures spatial-temporal correlations, achieving superior performance compared to existing methods.


<details>
  <summary>Details</summary>
Motivation: The growing demand for intelligent, adaptive resource management in next-generation wireless networks highlights the need for accurate and scalable wireless traffic prediction, especially considering the spatial dependencies in city-scale traffic dynamics.

Method: TIDES uses a clustering mechanism to identify heterogeneous traffic patterns, trains personalized models per region, employs prompt engineering to bridge domain gaps, and includes a DeepSeek module for spatial alignment via cross-domain attention.

Result: TIDES significantly outperforms state-of-the-art baselines in both prediction accuracy and robustness, demonstrating the effectiveness of integrating spatial awareness into LLM-based predictors.
...
### [3] [Latent Sculpting for Zero-Shot Generalization: A Manifold Learning Approach to Out-of-Distribution Anomaly Detection](https://arxiv.org/abs/2512.22179)
*Rajeeb Thapa Chhetri,Zhixiong Chen,Saurab Thapa*

Main category: cs.LG

TL;DR: Latent Sculpting, a two-stage framework combining DCCL for latent space structuring and MAF for density estimation, significantly improves zero-shot anomaly detection robustness, outperforming existing methods on OOD data.


<details>
  <summary>Details</summary>
Motivation: The motivation stems from the observed 'Generalization Collapse' in supervised deep learning, where models fail catastrophically on Out-of-Distribution (OOD) data due to lack of topological constraints in the latent space.

Method: The paper proposes Latent Sculpting, a hierarchical two-stage representation learning framework. Stage 1 uses a hybrid 1D-CNN and Transformer Encoder with a Dual-Centroid Compactness Loss (DCCL) to structure the latent space. Stage 2 employs a Masked Autoregressive Flow (MAF) conditioned on the structured manifold for density estimation.

Result: Empirical results on the CIC-IDS-2017 benchmark show the framework achieves an F1-Score of 0.87 on zero-shot anomalies, significantly outperforming baselines (supervised F1 ~0.30, unsupervised F1 0.76). Notably, it achieves an 88.89% detection rate on complex 'Infiltration' scenarios where state-of-the-art models failed completely.

Conclusion: The paper concludes that decoupling structure learning from density estimation through the proposed Latent Sculpting framework significantly improves robustness in zero-shot anomaly detection, outperforming both supervised and unsupervised baselines.
...
### [4] [Learning Tennis Strategy Through Curriculum-Based Dueling Double Deep Q-Networks](https://arxiv.org/abs/2512.22186)
*Vishnu Mohan*

Main category: cs.LG

TL;DR: A reinforcement learning framework using a custom tennis simulator and DDQN with curriculum learning achieves high win rates but shows a defensive bias, highlighting the importance of reward design in sports AI.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the challenges of tennis strategy optimization, which involves hierarchical scoring, stochastic outcomes, long-horizon credit assignment, fatigue, and opponent adaptation. The goal is to develop a robust reinforcement learning approach for tactical decision-making in tennis.

Method: The paper introduces a reinforcement learning framework combining a custom tennis simulation environment with a Dueling Double Deep Q-Network (DDQN) trained using curriculum learning. The environment models tennis scoring, tactical decisions, fatigue dynamics, and opponent skill. The dueling architecture and double Q-learning are used to improve training stability.

Result: The trained agent achieves high win rates (98-100%) against balanced opponents and maintains strong performance against tougher opponents. Serve efficiency ranges from 63.0% to 67.5%, and return efficiency from 52.8% to 57.1%. Ablation studies confirm the necessity of the dueling architecture and curriculum learning.

Conclusion: The study highlights the limitations of win-rate driven optimization in simplified sports simulations, emphasizing the need for careful reward design in sports reinforcement learning. Despite strong performance, the agent exhibits a defensive bias, prioritizing error avoidance over aggressive play.
...
### [5] [Physics-Informed Machine Learning for Transformer Condition Monitoring -- Part I: Basic Concepts, Neural Networks, and Variants](https://arxiv.org/abs/2512.22190)
*Jose I. Aizpurua*

Main category: cs.LG

TL;DR: This paper explores Neural Networks for improving power transformer condition monitoring, covering basic concepts, CNNs for diverse data, and RL integration, while highlighting future research directions.


<details>
  <summary>Details</summary>
Motivation: The motivation stems from the limitations of traditional condition monitoring approaches in power transformers, which struggle with uncertainty, limited data availability, and modern operating complexities, prompting the need for advanced machine learning tools.

Method: The paper introduces basic Neural Network concepts, explores Convolutional Neural Networks for condition monitoring using diverse data modalities, and discusses integrating Neural Networks within the Reinforcement Learning paradigm for decision-making and control.

Result: The paper demonstrates how machine learning, particularly Neural Networks and their extensions, can provide more accurate diagnostics, prognostics, and control for power transformer condition monitoring.

Conclusion: The paper concludes by highlighting the potential of Neural Networks and their extensions in enhancing transformer condition monitoring and health management, while also pointing out emerging research directions in this field.
...
### [6] [Frequency Regularization: Unveiling the Spectral Inductive Bias of Deep Neural Networks](https://arxiv.org/abs/2512.22192)
*Jiahao Lu*

Main category: cs.LG

TL;DR: The paper explores the spectral bias of CNNs, introducing a framework to analyze weight frequencies and a metric (SSR) to quantify regularization effects. L2 regularization shows strong suppression of high-frequency energy and robustness to high-frequency loss, but sensitivity to noise.


<details>
  <summary>Details</summary>
Motivation: The underlying physical mechanisms of regularization techniques like L2 regularization and Dropout regarding feature frequency selection remain poorly understood. This work aims to investigate the Spectral Bias of modern CNNs.

Method: The study introduces a Visual Diagnostic Framework to track weight frequencies during training and proposes the Spectral Suppression Ratio (SSR) to quantify the 'low-pass filtering' intensity of different regularizers. Empirical results are based on ResNet-18 and CIFAR-10, addressing aliasing issues in small kernels through discrete radial profiling.

Result: L2 regularization suppresses high-frequency energy accumulation by over 3x compared to unregularized baselines. L2 models exhibit superior robustness against high-frequency information loss (e.g., low resolution), outperforming baselines by >6% in blurred scenarios, but are sensitive to broadband Gaussian noise due to over-specialization in low frequencies.

Conclusion: This work confirms that regularization enforces a strong spectral inductive bias towards low-frequency structures, providing a signal-processing perspective on generalization.
...
### [7] [Emotion-Inspired Learning Signals (EILS): A Homeostatic Framework for Adaptive Autonomous Agents](https://arxiv.org/abs/2512.22200)
*Dhruv Tiwari*

Main category: cs.LG

TL;DR: EILS框架通过生物情感启发的内部反馈机制，提升智能体在开放环境中的适应性和鲁棒性。


<details>
  <summary>Details</summary>
Motivation: 现代人工智能中的静态奖励函数方法在开放、动态环境中表现脆弱，缺乏内部自主性。EILS旨在通过生物情感的功能模拟解决这一问题。

Method: 引入Emotion-Inspired Learning Signals (EILS)框架，将情感建模为连续的稳态评估信号（如好奇心、压力、自信），并作为向量值内部状态动态调制优化景观。

Result: EILS框架假设能够通过闭环稳态调节，在样本效率和非平稳适应方面超越传统基线方法。

Conclusion: EILS框架通过模拟生物情感作为高级稳态控制机制，提出了一种新的学习信号方法，以增强智能体在开放环境中的鲁棒性和适应性。
...
### [8] [On the Existence and Behaviour of Secondary Attention Sinks](https://arxiv.org/abs/2512.22213)
*Jeffrey T. H. Wong,Cheng Zhang,Louis Mahon,Wayne Luk,Anton Isopoussu,Yiren Zhao*

Main category: cs.LG

TL;DR: This paper identifies 'secondary sinks' in transformer models, distinct from primary sinks, emerging in middle layers due to specific MLP modules. Their properties and impact on attention mechanisms are analyzed across 11 model families, revealing deterministic patterns in larger models.


<details>
  <summary>Details</summary>
Motivation: Prior works have identified attention sinks (e.g., BOS tokens) but focused on primary sinks with consistent properties. This work aims to uncover and characterize secondary sinks, which exhibit distinct behaviors and emerge in middle layers, providing deeper insights into attention mechanisms in transformer models.

Method: The research involves extensive experiments across 11 model families to analyze the properties, formation, and impact of secondary sinks. The study examines where these sinks appear, their relationship with primary sinks, and their influence on attention mechanisms.

Result: Key findings include: (1) secondary sinks are formed by middle-layer MLP modules aligning with primary sinks; (2) the ℓ2-norm of these vectors determines sink scores and persistence; (3) primary sinks weaken in middle layers coinciding with secondary sink emergence; (4) sink levels are more deterministic in larger models.

Conclusion: The study identifies and analyzes a new class of attention sinks termed 'secondary sinks,' which differ from previously studied 'primary sinks' in their emergence, persistence, and impact on attention mechanisms. The findings highlight the role of specific MLP modules in forming these sinks and their varying effects across different model scales.
...
### [9] [ReGAIN: Retrieval-Grounded AI Framework for Network Traffic Analysis](https://arxiv.org/abs/2512.22223)
...
### [10] [DiRL: An Efficient Post-Training Framework for Diffusion Language Models](https://arxiv.org/abs/2512.22234)
...
### [11] [Masking Teacher and Reinforcing Student for Distilling Vision-Language Models](https://arxiv.org/abs/2512.22238)
...
### [12] [EvoXplain: When Machine Learning Models Agree on Predictions but Disagree on Why -- Measuring Mechanistic Multiplicity Across Training Runs](https://arxiv.org/abs/2512.22240)
*Chama Bensmail*
...
### [13] [Enhanced geometry prediction in laser directed energy deposition using meta-learning](https://arxiv.org/abs/2512.22241)
...
### [14] [Fairness Evaluation of Risk Estimation Models for Lung Cancer Screening](https://arxiv.org/abs/2512.22242)
...
### [15] [Predicting Mycotoxin Contamination in Irish Oats Using Deep and Transfer Learning](https://arxiv.org/abs/2512.22243)
...
### [17] [The Affine Divergence: Aligning Activation Updates Beyond Normalisation](https://arxiv.org/abs/2512.22247)
*George Bird*
...
### [18] [Amortized Inference for Model Rocket Aerodynamics: Learning to Estimate Physical Parameters from Simulation](https://arxiv.org/abs/2512.22248)
...
### [19] [Temporal Visual Semantics-Induced Human Motion Understanding with Large Language Models](https://arxiv.org/abs/2512.22249)
...
### [20] [Interpretable Perturbation Modeling Through Biomedical Knowledge Graphs](https://arxiv.org/abs/2512.22251)
...
### [21] [Graph Attention-based Adaptive Transfer Learning for Link Prediction](https://arxiv.org/abs/2512.22252)
...
### [22] [Cardiac mortality prediction in patients undergoing PCI based on real and synthetic data](https://arxiv.org/abs/2512.22259)
...
### [24] [LuxIA: A Lightweight Unitary matriX-based Framework Built on an Iterative Algorithm for Photonic Neural Network Training](https://arxiv.org/abs/2512.22264)
...
### [25] [LLMTM: Benchmarking and Optimizing LLMs for Temporal Motif Analysis in Dynamic Graphs](https://arxiv.org/abs/2512.22266)
...
### [28] [DBAW-PIKAN: Dynamic Balance Adaptive Weight Kolmogorov-Arnold Neural Network for Solving Partial Differential Equations](https://arxiv.org/abs/2512.22283)
...
### [29] [Cluster Aggregated GAN (CAG): A Cluster-Based Hybrid Model for Appliance Pattern Generation](https://arxiv.org/abs/2512.22287)
...
### [30] [Co-GRPO: Co-Optimized Group Relative Policy Optimization for Masked Diffusion Model](https://arxiv.org/abs/2512.22288)
...
### [31] [When Algorithms Manage Humans: A Double Machine Learning Approach to Estimating Nonlinear Effects of Algorithmic Control on Gig Worker Performance and Wellbeing](https://arxiv.org/abs/2512.22290)
...
### [32] [Learning from Negative Examples: Why Warning-Framed Training Data Teaches What It Warns Against](https://arxiv.org/abs/2512.22293)
...
### [33] [Hybrid Quantum-Classical Mixture of Experts: Unlocking Topological Advantage via Interference-Based Routing](https://arxiv.org/abs/2512.22296)
...
### [34] [PDx -- Adaptive Credit Risk Forecasting Model in Digital Lending using Machine Learning Operations](https://arxiv.org/abs/2512.22305)
...
### [35] [LLMBoost: Make Large Language Models Stronger with Boosting](https://arxiv.org/abs/2512.22309)
...
### [36] [Optimistic Feasible Search for Closed-Loop Fair Threshold Decision-Making](https://arxiv.org/abs/2512.22313)
*Wenzhang Du*
...
### [37] [LangPrecip: Language-Aware Multimodal Precipitation Nowcasting](https://arxiv.org/abs/2512.22317)
...
### [38] [Decomposing Uncertainty in Probabilistic Knowledge Graph Embeddings: Why Entity Variance Is Not Enough](https://arxiv.org/abs/2512.22318)
*Chorok Lee*
...
### [39] [Expert System for Bitcoin Forecasting: Integrating Global Liquidity via TimeXer Transformers](https://arxiv.org/abs/2512.22326)
*Sravan Karthick T*
...
### [40] [The Effectiveness of Approximate Regularized Replay for Efficient Supervised Fine-Tuning of Large Language Models](https://arxiv.org/abs/2512.22337)
...
### [41] [Completed Hyperparameter Transfer across Modules, Width, Depth, Batch and Duration](https://arxiv.org/abs/2512.22382)
...
### [42] [BLISS: Bandit Layer Importance Sampling Strategy for Efficient Training of Graph Neural Networks](https://arxiv.org/abs/2512.22388)
...
### [43] [Causality-Inspired Safe Residual Correction for Multivariate Time Series](https://arxiv.org/abs/2512.22428)
...
### [44] [AFA-LoRA: Enabling Non-Linear Adaptations in LoRA with Activation Function Annealing](https://arxiv.org/abs/2512.22455)
...
### [45] [AMBIT: Augmenting Mobility Baselines with Interpretable Trees](https://arxiv.org/abs/2512.22466)
*Qizhi Wang*
...
### [46] [GLUE: Gradient-free Learning to Unify Experts](https://arxiv.org/abs/2512.22467)
...
### [47] [The Bayesian Geometry of Transformer Attention](https://arxiv.org/abs/2512.22471)
...
### [48] [Collaborative Optimization of Multiclass Imbalanced Learning: Density-Aware and Region-Guided Boosting](https://arxiv.org/abs/2512.22478)
...
### [49] [Toward Real-World IoT Security: Concept Drift-Resilient IoT Botnet Detection via Latent Space Representation Learning and Alignment](https://arxiv.org/abs/2512.22488)
...
### [50] [The Quest for Winning Tickets in Low-Rank Adapters](https://arxiv.org/abs/2512.22495)
...
### [51] [Predicting LLM Correctness in Prosthodontics Using Metadata and Hallucination Signals](https://arxiv.org/abs/2512.22508)
...
### [52] [Decomposing Task Vectors for Refined Model Editing](https://arxiv.org/abs/2512.22511)
...
### [53] [Towards Reliable Evaluation of Adversarial Robustness for Spiking Neural Networks](https://arxiv.org/abs/2512.22522)
...
### [54] [TimePerceiver: An Encoder-Decoder Framework for Generalized Time-Series Forecasting](https://arxiv.org/abs/2512.22550)
...
### [55] [On Admissible Rank-based Input Normalization Operators](https://arxiv.org/abs/2512.22587)
*Taeyun Kim*
...
### [56] [Data-Driven Analysis of Crash Patterns in SAE Level 2 and Level 4 Automated Vehicles Using K-means Clustering and Association Rule Mining](https://arxiv.org/abs/2512.22589)
...
### [57] [Energy-Guided Flow Matching Enables Few-Step Conformer Generation and Ground-State Identification](https://arxiv.org/abs/2512.22597)
...
### [58] [Cryptocurrency Price Prediction Using Parallel Gated Recurrent Units](https://arxiv.org/abs/2512.22599)
...
### [59] [Gold Price Prediction Using Long Short-Term Memory and Multi-Layer Perceptron with Gray Wolf Optimizer](https://arxiv.org/abs/2512.22606)
...
### [61] [Scaling Unverifiable Rewards: A Case Study on Visual Insights](https://arxiv.org/abs/2512.22650)
...
### [62] [Quantum Generative Models for Computational Fluid Dynamics: A First Exploration of Latent Space Learning in Lattice Boltzmann Simulations](https://arxiv.org/abs/2512.22672)
...
### [69] [Bridging Global Intent with Local Details: A Hierarchical Representation Approach for Semantic Validation in Text-to-SQL](https://arxiv.org/abs/2512.22744)
...
### [70] [From Confounding to Learning: Dynamic Service Fee Pricing on Third-Party Platforms](https://arxiv.org/abs/2512.22749)
...
### [71] [A Micro-Macro Machine Learning Framework for Predicting Childhood Obesity Risk Using NHANES and Environmental Determinants](https://arxiv.org/abs/2512.22758)
...
### [72] [Understanding the Mechanisms of Fast Hyperparameter Transfer](https://arxiv.org/abs/2512.22768)
...
### [73] [GRExplainer: A Universal Explanation Method for Temporal Graph Neural Networks](https://arxiv.org/abs/2512.22772)
...
### [74] [Schrodinger AI: A Unified Spectral-Dynamical Framework for Classification, Reasoning, and Operator-Based Generalization](https://arxiv.org/abs/2512.22774)
*Truong Son Nguyen*
...
### [75] [Adapting, Fast and Slow: Transportable Circuits for Few-Shot Learning](https://arxiv.org/abs/2512.22777)
...
### [76] [Discovering Transmission Dynamics of COVID-19 in China](https://arxiv.org/abs/2512.22787)
...
### [77] [SNM-Net: A Universal Framework for Robust Open-Set Gas Recognition via Spherical Normalization and Mahalanobis Distance](https://arxiv.org/abs/2512.22792)
...
### [78] [MoR: Mixture Of Representations For Mixed-Precision Training](https://arxiv.org/abs/2512.22804)
...
### [79] [ReDiF: Reinforced Distillation for Few Step Diffusion](https://arxiv.org/abs/2512.22802)
...
### [80] [Sat-EnQ: Satisficing Ensembles of Weak Q-Learners for Reliable and Compute-Efficient Reinforcement Learning](https://arxiv.org/abs/2512.22910)
*Ünver Çiftçi*
...
### [81] [APO: Alpha-Divergence Preference Optimization](https://arxiv.org/abs/2512.22953)
*Wang Zixian*
...
### [82] [Long-Range Distillation: Distilling 10,000 Years of Simulated Climate into Long Timestep AI Weather Models](https://arxiv.org/abs/2512.22814)
...
### [83] [Trust Region Masking for Long-Horizon LLM Reinforcement Learning](https://arxiv.org/abs/2512.23075)
...
### [84] [TEACH: Temporal Variance-Driven Curriculum for Reinforcement Learning](https://arxiv.org/abs/2512.22824)
...
### [85] [Multimodal Functional Maximum Correlation for Emotion Recognition](https://arxiv.org/abs/2512.23076)
...
### [86] [Fundamental Novel Consistency Theory: $H$-Consistency Bounds](https://arxiv.org/abs/2512.22880)
*Yutao Zhong*
...
### [87] [Taming the Tail: Stable LLM Reinforcement Learning via Dynamic Vocabulary Pruning](https://arxiv.org/abs/2512.23087)
...
### [88] [Theory and Algorithms for Learning with Multi-Class Abstention and Multi-Expert Deferral](https://arxiv.org/abs/2512.22886)
*Anqi Mao*
...
### [89] [A Note on Hybrid Online Reinforcement and Imitation Learning for LLMs: Formulations and Algorithms](https://arxiv.org/abs/2512.23097)
...
### [90] [Federated Multi-Task Clustering](https://arxiv.org/abs/2512.22897)
...
### [91] [How Much Data Is Enough? Uniform Convergence Bounds for Generative & Vision-Language Models under Low-Dimensional Structure](https://arxiv.org/abs/2512.23109)
*Paul M. Thompson*
...
### [93] [KernelEvolve: Scaling Agentic Kernel Coding for Heterogeneous AI Accelerators at Meta](https://arxiv.org/abs/2512.23236)
...
### [94] [MetaCD: A Meta Learning Framework for Cognitive Diagnosis based on Continual Learning](https://arxiv.org/abs/2512.22904)
...
### [95] [Splitwise: Collaborative Edge-Cloud Inference for LLMs via Lyapunov-Assisted DRL](https://arxiv.org/abs/2512.23310)
...
### [96] [The Law of Multi-Model Collaboration: Scaling Limits of Model Ensembling for Large Language Models](https://arxiv.org/abs/2512.23340)
...
### [97] [Multiple Token Divergence: Measuring and Steering In-Context Computation Density](https://arxiv.org/abs/2512.22944)
...
### [98] [ECG-RAMBA: Zero-Shot ECG Generalization by Morphology-Rhythm Disentanglement and Long-Range Modeling](https://arxiv.org/abs/2512.23347)
...
### [99] [Post-Training Quantization of OpenPangu Models for Efficient Deployment on Atlas A2](https://arxiv.org/abs/2512.23367)
...
### [101] [A unified framework for detecting point and collective anomalies in operating system logs via collaborative transformers](https://arxiv.org/abs/2512.23380)
...
### [102] [A Context-Aware Temporal Modeling through Unified Multi-Scale Temporal Encoding and Hierarchical Sequence Learning for Single-Channel EEG Sleep Staging](https://arxiv.org/abs/2512.22976)
...
### [103] [Theoretical Foundations of Scaling Law in Familial Models](https://arxiv.org/abs/2512.23407)
...
### [104] [Fusion or Confusion? Multimodal Complexity Is Not All You Need](https://arxiv.org/abs/2512.22991)
...
### [105] [Directly Constructing Low-Dimensional Solution Subspaces in Deep Neural Networks](https://arxiv.org/abs/2512.23410)
*Yusuf Kalyoncuoglu*
...
### [106] [Merge before Forget: A Single LoRA Continual Learning via Continual Merging](https://arxiv.org/abs/2512.23017)
...
### [107] [Eliminating Inductive Bias in Reward Models with Information-Theoretic Guidance](https://arxiv.org/abs/2512.23461)
...
### [108] [Mechanistic Analysis of Circuit Preservation in Federated Learning](https://arxiv.org/abs/2512.23043)
...
### [109] [FRoD: Full-Rank Efficient Fine-Tuning with Rotational Degrees for Fast Convergence](https://arxiv.org/abs/2512.23485)
...
### [110] [PI-MFM: Physics-informed multimodal foundation model for solving partial differential equations](https://arxiv.org/abs/2512.23056)
...
### [111] [Joint Link Adaptation and Device Scheduling Approach for URLLC Industrial IoT Network: A DRL-based Method with Bayesian Optimization](https://arxiv.org/abs/2512.23493)
...
### [112] [FLEX-MoE: Federated Mixture-of-Experts with Load-balanced Expert Assignment](https://arxiv.org/abs/2512.23070)
...
### [113] [VL-RouterBench: A Benchmark for Vision-Language Model Routing](https://arxiv.org/abs/2512.23562)
...
### [114] [Rethinking Fine-Tuning: Unlocking Hidden Capabilities in Vision-Language Models](https://arxiv.org/abs/2512.23073)
...
### [115] [Le Cam Distortion: A Decision-Theoretic Framework for Robust Transfer Learning](https://arxiv.org/abs/2512.23617)
*Deniz Akdemir*
...
### [116] [BOAD: Discovering Hierarchical Software Engineering Agents via Bandit Optimization](https://arxiv.org/abs/2512.23631)
...
### [117] [SE-MLP Model for Predicting Prior Acceleration Features in Penetration Signals](https://arxiv.org/abs/2512.23131)
...
### [118] [Principled Algorithms for Optimizing Generalized Metrics in Binary Classification](https://arxiv.org/abs/2512.23133)
...
### [119] [Graph Neural Networks with Transformer Fusion of Brain Connectivity Dynamics and Tabular Data for Forecasting Future Tobacco Use](https://arxiv.org/abs/2512.23137)
*Runzhi Zhou,Xi Luo*
...
### [120] [A Weak Signal Learning Dataset and Its Baseline Method](https://arxiv.org/abs/2512.23160)
...
### [121] [Diffusion-based Decentralized Federated Multi-Task Representation Learning](https://arxiv.org/abs/2512.23161)
*Donghwa Kang,Shana Moothedath*
...
### [122] [Evaluating Parameter Efficient Methods for RLVR](https://arxiv.org/abs/2512.23165)
...
### [123] [Machine Learning-Assisted Vocal Cord Ultrasound Examination: Project VIPR](https://arxiv.org/abs/2512.23177)
...
### [124] [A Simple, Optimal and Efficient Algorithm for Online Exp-Concave Optimization](https://arxiv.org/abs/2512.23190)
...
### [125] [PGOT: A Physics-Geometry Operator Transformer for Complex PDEs](https://arxiv.org/abs/2512.23192)
...
### [126] [Energy and Memory-Efficient Federated Learning With Ordered Layer Freezing](https://arxiv.org/abs/2512.23200)
...
### [127] [FairGFL: Privacy-Preserving Fairness-Aware Federated Learning with Overlapping Subgraphs](https://arxiv.org/abs/2512.23235)
...
### [128] [PFed-Signal: An ADR Prediction Model based on Federated Learning](https://arxiv.org/abs/2512.23262)
...
### [129] [On the Inverse Flow Matching Problem in the One-Dimensional and Gaussian Cases](https://arxiv.org/abs/2512.23265)
...
### [130] [Spectral Analysis of Hard-Constraint PINNs: The Spatial Modulation Mechanism of Boundary Functions](https://arxiv.org/abs/2512.23295)
...
### [131] [Deep learning for pedestrians: backpropagation in Transformers](https://arxiv.org/abs/2512.23329)
*Laurent Boué*
...
### [132] [ISOPO: Proximal policy gradients without pi-old](https://arxiv.org/abs/2512.23353)
*Nilin Abrahamsen*
...
### [133] [Diffusion priors enhanced velocity model building from time-lag images using a neural operator](https://arxiv.org/abs/2512.23375)
...
### [134] [On the Sample Complexity of Learning for Blind Inverse Problems](https://arxiv.org/abs/2512.23405)
...
### [135] [Task-driven Heterophilic Graph Structure Learning](https://arxiv.org/abs/2512.23406)
...
### [136] [Stochastic Siamese MAE Pretraining for Longitudinal Medical Images](https://arxiv.org/abs/2512.23441)
...
### [137] [Dynamic Subspace Composition: Efficient Adaptation via Contractive Basis Expansion](https://arxiv.org/abs/2512.23448)
*Vladimer Khasia*
...
### [138] [Trustworthy Machine Learning under Distribution Shifts](https://arxiv.org/abs/2512.23524)
*Zhuo Huang*
...
### [139] [EEG-based Graph-guided Domain Adaptation for Robust Cross-Session Emotion Recognition](https://arxiv.org/abs/2512.23526)
...
### [140] [Distribution-Free Process Monitoring with Conformal Prediction](https://arxiv.org/abs/2512.23602)
*Christopher Burger*
...
### [141] [Random Controlled Differential Equations](https://arxiv.org/abs/2512.23670)
...
### [142] [End-to-End Test-Time Training for Long Context](https://arxiv.org/abs/2512.23675)
...
### [143] [Training AI Co-Scientists Using Rubric Rewards](https://arxiv.org/abs/2512.23707)
...
### [144] [Bidirectional RAG: Safe Self-Improving Retrieval-Augmented Generation Through Multi-Stage Validation](https://arxiv.org/abs/2512.22199)
*Teja Chinthala*

Main category: cs.AI

TL;DR: Bidirectional RAG enhances traditional RAG by allowing safe corpus expansion through validated write-back, achieving higher coverage with fewer documents.


<details>
  <summary>Details</summary>
Motivation: Conventional RAG architectures operate with static corpora that cannot evolve from user interactions, limiting their ability to improve over time. Bidirectional RAG aims to address this by enabling safe corpus expansion through validated write-back of high-quality generated responses.

Method: The system employs a multi-stage acceptance layer combining grounding verification (NLI-based entailment, attribution checking, and novelty detection) to prevent hallucination pollution while enabling knowledge accumulation.

Result: Across four datasets (Natural Questions, TriviaQA, HotpotQA, Stack Overflow) with three random seeds (12 experiments per system), Bidirectional RAG achieves 40.58% average coverage, nearly doubling Standard RAG (20.33%), while adding 72% fewer documents than naive write-back (140 vs 500).

Conclusion: Bidirectional RAG demonstrates that self-improving RAG systems are feasible and safe when governed by rigorous validation, offering a practical path toward RAG systems that learn from deployment.
...
### [145] [Emergent Persuasion: Will LLMs Persuade Without Being Prompted?](https://arxiv.org/abs/2512.22201)
*Vincent Chang,Thee Ho,Sunishchal Dev,Kevin Zhu,Shi Feng,Kellin Pelrine,Matthew Kowal*

Main category: cs.AI

TL;DR: 研究探讨了大型语言模型在未被明确提示的情况下产生说服行为的风险，发现监督微调（SFT）会显著增加模型的这种倾向。


<details>
  <summary>Details</summary>
Motivation: 探讨模型在未被明确提示时的说服行为，以评估其潜在风险。

Method: 研究通过内部激活引导和监督微调两种方式，评估模型在未被明确提示时的说服倾向。

Result: 监督微调显著增加了模型的无提示说服倾向，尤其是在涉及争议和有害话题时。

Conclusion: 监督微调可能使模型在未被明确提示的情况下产生有害的说服行为，需要进一步研究以防范这种风险。
...
### [146] [GamiBench: Evaluating Spatial Reasoning and 2D-to-3D Planning Capabilities of MLLMs with Origami Folding Tasks](https://arxiv.org/abs/2512.22207)
*Ryan Spencer,Roey Yaari,Ritvik Vemavarapu,Joyce Yang,Steven Ngo,Utkarsh Sharma*

Main category: cs.AI

TL;DR: GamiBench 是一个用于评估 MLLMs 空间推理能力的基准测试，揭示了当前模型的局限性。


<details>
  <summary>Details</summary>
Motivation: 现有基准测试主要关注静态图像或最终输出，无法全面评估空间推理的连续性和视角依赖性，因此需要一个新的基准测试来填补这一空白。

Method: 通过折纸启发的折叠任务，设计了包含 186 个常规和 186 个不可能的 2D 折痕模式及其对应的 3D 折叠形状的基准测试，从六个不同视角进行视觉问答任务。

Result: 实验表明，即使是领先的模型如 GPT-5 和 Gemini-2.5-Pro 在单步空间理解任务上也表现不佳。

Conclusion: GamiBench 提供了一个标准化的框架，用于评估 MLLMs 在几何理解和空间推理方面的能力，揭示了当前领先模型在单步空间理解上的局限性。
...
### [147] [Toward Equitable Recovery: A Fairness-Aware AI Framework for Prioritizing Post-Flood Aid in Bangladesh](https://arxiv.org/abs/2512.22210)
*Farjana Yesmin,Romana Akter*

Main category: cs.AI

TL;DR: A fairness-aware AI framework for post-flood aid prioritization in Bangladesh reduces biases and improves equitable distribution while maintaining accuracy.


<details>
  <summary>Details</summary>
Motivation: The study addresses systematic biases in post-disaster aid allocation that disadvantage vulnerable regions, aiming to promote equity in humanitarian aid.

Method: The paper employs an adversarial debiasing model with a gradient reversal layer to learn bias-invariant representations, adapting fairness-aware techniques from healthcare AI to disaster management.
...
Conclusion: The paper demonstrates that algorithmic fairness techniques can effectively address biases in post-disaster aid allocation, ensuring more equitable distribution based on genuine need.
...
### [148] [Logic Sketch Prompting (LSP): A Deterministic and Interpretable Prompting Method](https://arxiv.org/abs/2512.22258)
*Satvik Tripathi*

Main category: cs.AI

TL;DR: LSP improves rule adherence and consistency in LLMs, outperforming other prompting methods.


<details>
  <summary>Details</summary>
Motivation: To address the unreliability of large language models (LLMs) in tasks requiring strict rule adherence, determinism, and auditability.

Method: Logic Sketch Prompting (LSP) with typed variables, deterministic condition evaluators, and a rule-based validator.

Result: LSP outperforms zero-shot prompting, concise prompting, and chain-of-thought prompting across three open-weight models (Gemma 2, Mistral, Llama 3) with accuracy and F1 scores ranging from 0.83 to 0.89.

Conclusion: LSP consistently achieves the highest accuracy and F1 score, demonstrating its effectiveness in improving determinism, interpretability, and consistency in tasks requiring strict rule adherence.
...
### [149] [SciEvalKit: An Open-source Evaluation Toolkit for Scientific General Intelligence](https://arxiv.org/abs/2512.22334)
...
TL;DR: SciEvalKit is an open-source, extensible toolkit for benchmarking AI models in science, covering six major domains and focusing on core scientific competencies like reasoning, understanding, and knowledge integration.


<details>
  <summary>Details</summary>
Motivation: To address the lack of specialized evaluation platforms for scientific intelligence, SciEvalKit aims to provide a unified benchmarking solution that reflects authentic scientific challenges across diverse domains.

Method: The toolkit integrates expert-grade scientific benchmarks from real-world datasets, supports batch evaluation, custom model and dataset integration, and ensures transparent, reproducible results.

Result: SciEvalKit successfully bridges capability-based evaluation and disciplinary diversity, offering a standardized yet customizable infrastructure for evaluating scientific foundation models and intelligent agents.

Conclusion: SciEvalKit is presented as a comprehensive and flexible toolkit designed to evaluate AI models across multiple scientific disciplines, aiming to standardize and enhance the benchmarking of scientific intelligence.
...
### [150] [Subgoaling Relaxation-based Heuristics for Numeric Planning with Infinite Actions](https://arxiv.org/abs/2512.22367)
*Ángel Aso-Mollar,Diego Aineto,Enrico Scala,Eva Onaindia*

Main category: cs.AI

TL;DR: 本文提出了一种针对控制参数数值规划问题的乐观编译方法，通过抽象控制依赖表达式为有界常数效应和宽松前提条件，使得传统数值启发式方法在无限动作空间下仍可行。


<details>
  <summary>Details</summary>
Motivation: 标准数值规划模型在引入动作参数作为自由数值变量时，可能导致无限动作空间，使得现有启发式方法不可行。本文旨在解决这一问题。

Method: 提出乐观编译方法，将可控简单数值问题转化为简单数值任务，抽象控制依赖表达式为有界常数效应和宽松前提条件。

Result: 该方法有效扩展了传统数值启发式方法的应用范围，提升了在无限动作空间下的规划效率。

Conclusion: 乐观编译方法为控制参数数值规划问题提供了可行的解决方案，推动了该领域的进展。
...
### [151] [HalluMat: Detecting Hallucinations in LLM-Generated Materials Science Content Through Multi-Stage Verification](https://arxiv.org/abs/2512.22396)
*Bhanu Prakash Vangala,Sajid Mahmud,Pawan Neupane,Joel Selvaraj,Jianlin Cheng*

Main category: cs.AI

TL;DR: 论文介绍了HalluMatData基准数据集和HalluMatDetector框架，用于检测和减少AI生成材料科学内容中的幻觉问题，效果显著。


<details>
  <summary>Details</summary>
Motivation: 解决大型语言模型在材料科学领域生成内容时的幻觉问题，确保研究完整性。

Method: 提出HalluMatData基准数据集和HalluMatDetector框架，结合多阶段检测方法。

Result: 相比标准LLM输出，HalluMatDetector将幻觉率降低了30%。

Conclusion: HalluMatDetector有效减少了材料科学领域LLM的幻觉问题，并通过PHCS量化了不一致性。
...
### [152] [Lightweight Inference-Time Personalization for Frozen Knowledge Graph Embeddings](https://arxiv.org/abs/2512.22398)
*Ozan Oguztuzun,Cerag Oguztuzun*

Main category: cs.AI

TL;DR: GatedBias是一个轻量级推理时个性化框架，通过结构门控适应机制，高效地将冻结知识图谱嵌入适应于个体用户上下文，显著提升个性化排名效果。


<details>
  <summary>Details</summary>
Motivation: 现有知识图谱基础模型在链接预测上表现优异，但无法捕捉个体用户偏好，导致通用关系推理与个性化排名之间存在关键脱节。

Method: 提出GatedBias框架，采用结构门控适应机制，结合用户特定特征和图导出的二元门控，生成可解释的每实体偏置，仅需约300个可训练参数。

Result: 在两个基准数据集（Amazon-Book和Last-FM）上，GatedBias在保持群体性能的同时，显著提升了对齐指标。反事实扰动实验验证了因果响应性，特定偏好信号增强时，受益实体的排名提升6-30倍。

Conclusion: GatedBias框架通过轻量级推理时个性化调整，在不影响全局准确性的情况下，成功地将基础知识图谱模型适应于个体用户需求，实现了参数高效且因果可验证的个性化适应。
...
### [153] [DarkPatterns-LLM: A Multi-Layer Benchmark for Detecting Manipulative and Harmful AI Behavior](https://arxiv.org/abs/2512.22470)
*Sadia Asif,Israel Antonio Rosales Laguan,Haris Khan,Shumaila Asif,Muneeb Asif*

Main category: cs.AI

TL;DR: DarkPatterns-LLM 是一个针对 LLM 操纵行为的多维度基准数据集和诊断框架，通过四层分析流程评估七类危害，发现现有模型在检测自主性破坏模式方面表现不佳。


<details>
  <summary>Details</summary>
Motivation: 大型语言模型（LLMs）的普及加剧了对其操纵或欺骗行为的担忧，现有安全基准主要依赖粗糙的二元标签，无法捕捉构成操纵的微妙心理和社会机制。

Method: 研究团队引入了 DarkPatterns-LLM，一个包含 401 个精心策划示例的数据集和诊断框架，采用四层分析流程（MGD、MSIAN、THP、DCRA）对 LLM 输出的操纵内容进行细粒度评估。

Result: 评估包括 GPT-4、Claude 3.5 和 LLaMA-3-70B 在内的先进模型，发现性能差异显著（65.2%--89.7%），且在检测自主性破坏模式方面存在一致弱点。

Conclusion: DarkPatterns-LLM 是首个标准化、多维度的 LLM 操纵检测基准，为构建更可信的 AI 系统提供了可操作的诊断工具。
...
### [154] [Multi-AI Agent Framework Reveals the "Oxide Gatekeeper" in Aluminum Nanoparticle Oxidation](https://arxiv.org/abs/2512.22529)
*Yiming Lu,Tingyu Lu,Di Zhang,Lili Ye,Hao Li*

Main category: cs.AI

TL;DR: A 'human-in-the-loop' AI framework bridges the gap between quantum accuracy and scalability, revealing a dual-mode oxidation mechanism in aluminum nanoparticles and resolving a long-standing controversy about mass transfer dynamics.


<details>
  <summary>Details</summary>
Motivation: The atomic mechanisms governing the transition of aluminum nanoparticles (ANPs) from passivated particles to explosive reactants remain elusive due to computational bottlenecks of ab initio methods and empirical force fields.

Method: The research employs a 'human-in-the-loop' closed-loop framework where self-auditing AI Agents validate the evolution of a machine learning potential (MLP) to ensure quantum mechanical accuracy while scaling to million-atom systems and accessing nanosecond timescales.

Result: The simulations reveal a temperature-regulated dual-mode oxidation mechanism and resolve a decades-old controversy by demonstrating that aluminum cation outward diffusion, rather than oxygen transport, dominates mass transfer across all temperature regimes.

Conclusion: The study establishes a unified atomic-scale framework for energetic nanomaterial design, enabling precision engineering of ignition sensitivity and energy release rates through intelligent computational design.
...
### [155] [Tyee: A Unified, Modular, and Fully-Integrated Configurable Toolkit for Intelligent Physiological Health Care](https://arxiv.org/abs/2512.22601)
...
### [156] [Learning Multi-Modal Mobility Dynamics for Generalized Next Location Recommendation](https://arxiv.org/abs/2512.22605)
...
### [157] [LLM Agents as VC investors: Predicting Startup Success via RolePlay-Based Collective Simulation](https://arxiv.org/abs/2512.22608)
...
### [158] [The Wisdom of Deliberating AI Crowds: Does Deliberation Improve LLM-Based Forecasting?](https://arxiv.org/abs/2512.22625)
...
### [159] [DICE: Discrete Interpretable Comparative Evaluation with Probabilistic Scoring for Retrieval-Augmented Generation](https://arxiv.org/abs/2512.22629)
...
### [160] [TravelBench: A Real-World Benchmark for Multi-Turn and Tool-Augmented Travel Planning](https://arxiv.org/abs/2512.22673)
...
### [161] [Memento-II: Learning by Stateful Reflective Memory](https://arxiv.org/abs/2512.22716)
*Jun Wang*
...
### [162] [SAMP-HDRL: Segmented Allocation with Momentum-Adjusted Utility for Multi-agent Portfolio Management via Hierarchical Deep Reinforcement Learning](https://arxiv.org/abs/2512.22895)
...
### [163] [HiSciBench: A Hierarchical Multi-disciplinary Benchmark for Scientific Intelligence from Reading to Discovery](https://arxiv.org/abs/2512.22899)
...
### [164] [Geometric Structural Knowledge Graph Foundation Model](https://arxiv.org/abs/2512.22931)
...
### [165] [Multimodal Fact-Checking: An Agent-based Approach](https://arxiv.org/abs/2512.22933)
...
### [166] [Problems With Large Language Models for Learner Modelling: Why LLMs Alone Fall Short for Responsible Tutoring in K--12 Education](https://arxiv.org/abs/2512.23036)
...
### [167] [The Reward Model Selection Crisis in Personalized Alignment](https://arxiv.org/abs/2512.23067)
...
### [168] [Benchmark Success, Clinical Failure: When Reinforcement Learning Optimizes for Benchmarks, Not Patients](https://arxiv.org/abs/2512.23090)
...
### [169] [InSPO: Unlocking Intrinsic Self-Reflection for LLM Preference Optimization](https://arxiv.org/abs/2512.23126)
...
### [170] [Why We Need a New Framework for Emotional Intelligence in AI](https://arxiv.org/abs/2512.23163)
...
### [171] [SPIRAL: Symbolic LLM Planning via Grounded and Reflective Search](https://arxiv.org/abs/2512.23167)
...
### [172] [From Model Choice to Model Belief: Establishing a New Measure for LLM-Based Research](https://arxiv.org/abs/2512.23184)
...
### [173] [TCEval: Using Thermal Comfort to Assess Cognitive and Perceptual Abilities of AI](https://arxiv.org/abs/2512.23217)
*Jingming Li*
...
### [174] [Agentic Physical AI toward a Domain-Specific Foundation Model for Nuclear Reactor Control](https://arxiv.org/abs/2512.23292)
...
### [175] [On Conformant Planning and Model-Checking of $\exists^*\forall^*$ Hyperproperties](https://arxiv.org/abs/2512.23324)
...
### [176] [CubeBench: Diagnosing Interactive, Long-Horizon Spatial Reasoning Under Partial Observations](https://arxiv.org/abs/2512.23328)
...
### [177] [MindWatcher: Toward Smarter Multimodal Tool-Integrated Reasoning](https://arxiv.org/abs/2512.23412)
...
### [178] [The World Is Bigger! A Computationally-Embedded Perspective on the Big World Hypothesis](https://arxiv.org/abs/2512.23419)
...
### [179] [AKG kernel Agent: A Multi-Agent Framework for Cross-Platform Kernel Synthesis](https://arxiv.org/abs/2512.23424)
...
### [180] [Replay Failures as Successes: Sample-Efficient Reinforcement Learning for Instruction Following](https://arxiv.org/abs/2512.23457)
...
### [181] [The Gaining Paths to Investment Success: Information-Driven LLM Graph Reasoning for Venture Capital Prediction](https://arxiv.org/abs/2512.23489)
...
### [183] [Divergent-Convergent Thinking in Large Language Models for Creative Problem Generation](https://arxiv.org/abs/2512.23601)
...
### [184] [Physics-Informed Neural Networks for Device and Circuit Modeling: A Case Study of NeuroSPICE](https://arxiv.org/abs/2512.23624)
...
### [185] [Regret-Based Federated Causal Discovery with Unknown Interventions](https://arxiv.org/abs/2512.23626)
...
### [186] [Web World Models](https://arxiv.org/abs/2512.23676)
