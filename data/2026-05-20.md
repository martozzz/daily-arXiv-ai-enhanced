...
TL;DR: 提出了一种用于文档理解的微服务架构，能够处理数千份多页文档/小时，重点关注生产环境中的实际部署问题


<details>
  <summary>Details</summary>
Motivation: 学术界过度关注新模型开发，而文献中缺乏关于将文档理解模型扩展到生产规模的实际经验，现有研究在模型定义和生产部署之间存在巨大差距

Method: 设计了微服务架构，封装了分类、OCR和LLM结构化字段提取的多模型流水线；采用了混合分类、GPU推理与CPU编排分离、异步处理IO绑定操作、独立水平扩展等设计决策

Result: 通过批量性能分析发现：1) OCR（而非语言模型解析）主导端到端延迟；2) 系统在达到共享GPU推理容量而非工作进程数量确定的并发度时达到饱和；能够处理数千份多页文档/小时

Conclusion: 为从业者提供了构建超越基准测试的实际可用的文档理解系统的具体架构模式，有效实现了模型在生产环境中的操作化部署，弥合了研究与实践之间的差距
...
### [2] [DecisionBench: A Benchmark for Emergent Delegation in Long-Horizon Agentic Workflows](https://arxiv.org/abs/2605.19099)
*Yuxuan Gao,Megan Wang,Yi Ling Yu,Zijian Carl Ma,Ao Qu*

Main category: cs.AI

TL;DR: DecisionBench是一个用于评估长时程智能体工作流中涌现委托行为的基准测试框架，包含固定任务集、模型池、委托接口、技能标注层和多维度评估指标，旨在系统评估不同委托策略的有效性。


<details>
  <summary>Details</summary>
Motivation: 当前智能体工作流评估缺乏系统性基准来测量委托行为的质量和效果，特别是长时程任务中的多模型协作。需要建立标准化的评估框架来比较不同委托策略的性能，发现委托决策中的信号和优化空间。

Method: 构建包含GAIA、tau-bench、BFCL等多回合任务的固定任务集，11个模型组成的同行模型池，标准化委托接口(call_model加可选read_profile)，确定性技能标注层，以及涵盖质量、成本、延迟、委托率、路由保真度、厂商自偏好和反事实委托上限的多维度指标套件。

Result: 通过5种条件的参考测试(23,375个任务实例)发现：(1)不同意识条件下平均最终任务质量无显著差异，仅评估质量会错过编排信号；(2)路由保真度在7.5%-29.5%之间变化，交付通道比描述内容更重要；(3)反事实上限显示完美委托比当前性能高15-31个百分点，存在较大优化空间。

Conclusion: DecisionBench为智能体委托研究提供了标准化评估框架，揭示了当前委托策略存在显著优化空间，强调了多维度评估的重要性。研究人员可在此基础上开发更有效的编排方法，充分利用模型池的潜在能力。
...
### [3] [Not all uncertainty is alike: volatility, stochasticity, and exploration](https://arxiv.org/abs/2605.19215)
*Payam Piray*

Main category: cs.AI

TL;DR: 该论文研究了不同环境不确定性来源对探索-利用权衡的影响，发现波动性促进探索而随机性抑制探索，提出了CAUSE探索奖励框架。


<details>
  <summary>Details</summary>
Motivation: 生物和人工智能中的自适应决策需要在已知结果的利用和不确定替代方案的探索之间取得平衡。虽然先前的研究表明不确定性通常促进探索，但它们通常将不同来源的环境不确定性视为等效的。

Method: 将Gittins指数框架扩展到具有潜在动态的高斯状态空间多臂老虎机，推导出Cause-Aware Uncertainty-Sensitive Exploration (CAUSE)框架，这是一种通过控制即推理获得的闭式探索奖励。

Result: CAUSE在具有异构噪声结构的环境中优于标准探索策略，并且改进了在静止设置中达到最优但在动荡设置中未能转移最优性的每臂Gittins策略。波动性增强探索，而随机性抑制探索。

Conclusion: 学习和探索受相同噪声推理不对称性支配，该框架预测病理性噪声推理会产生反向而非仅仅是受损的探索，这对精神病学状况的计算模型具有重要意义。
...
### [4] [Causal Evidence for Attention Head Imbalance in Modality Conflict Hallucination](https://arxiv.org/abs/2605.19250)
*Jinrui Jiang,Zhangtai Wu,Zhen Wu,Xinyu Dai*

Main category: cs.AI

TL;DR: 本文提出了一种机制性分析方法来理解多模态大语言模型中的模态冲突幻觉现象，识别了导致幻觉的驱动头与抵抗幻觉的抵抗头，并提出了MACI干预方法有效减少了幻觉。


<details>
  <summary>Details</summary>
Motivation: 当多模态大语言模型(MLLMs)优先考虑错误的文本前提而不是矛盾的视觉证据时，会发生模态冲突幻觉。本文旨在理解为什么视觉证据在生成过程中无法占据主导地位，从机制角度研究哪些内部组件驱动或抵抗这种失败。

Method: 1. 使用路径修补技术对五个开源MLLM进行头部级因果分析；2. 识别出具有相反因果作用的注意力头：幻觉驱动头和幻觉抵抗头；3. 提出MACI(模态冲突感知因果干预)，这是一种条件干预方法，在检测到冲突时抑制因果识别的幻觉驱动头。

Result: 1. 发现一致的不对称性：驱动效应分布更广泛且总体权重更大，而抵抗效应集中在少数高重要性头部；2. MACI在MMMC基准测试中实现了最大的幻觉减少，在五个MLLM上都优于其他推理时基线；3. MACI在幻觉-准确性权衡方面表现良好，并且能零样本迁移到SCI-SemanticConflict测试。

Conclusion: 通过机制分析揭示了MLLM中模态冲突幻觉的根本原因：分布式驱动影响和局部化抵抗共同形成了不平衡的路由结构，导致生成偏向错误前提。提出的MACI干预方法通过条件性地抑制幻觉驱动头，有效地减少了幻觉，展现了良好的实用性和迁移性。
...
### [5] [Swimming with Whales: Analysis of Power Imbalances in Stake-Weighted Governance](https://arxiv.org/abs/2605.19264)
...
### [6] [MOCHA: Multi-Objective Chebyshev Annealing for Agent Skill Optimization](https://arxiv.org/abs/2605.19330)
...
### [7] [Agentic Trading: When LLM Agents Meet Financial Markets](https://arxiv.org/abs/2605.19337)
...
### [8] [Generative Recursive Reasoning](https://arxiv.org/abs/2605.19376)
...
### [9] [Generative Auto-Bidding with Unified Modeling and Exploration](https://arxiv.org/abs/2605.19457)
...
### [10] [Beyond Mode Collapse: Distribution Matching for Diverse Reasoning](https://arxiv.org/abs/2605.19461)
...
### [11] [Position: The Turing-Completeness of Real-World Autoregressive Transformers Relies Heavily on Context Management](https://arxiv.org/abs/2605.19514)
...
### [12] [BLINKG: A Benchmark for LLM-Integrated Knowledge Graph Generation](https://arxiv.org/abs/2605.19518)
...
### [13] [Library Drift: Diagnosing and Fixing a Silent Failure Mode in Self-Evolving LLM Skill Libraries](https://arxiv.org/abs/2605.19576)
...
### [14] [SceneCode: Executable World Programs for Editable Indoor Scenes with Articulated Objects](https://arxiv.org/abs/2605.19587)
...
### [15] [Towards Multi-Model LLM Schedulers: Empirical Insights into Offloading and Preemption](https://arxiv.org/abs/2605.19593)
...
### [16] [When Tabular Foundation Models Meet Strategic Tabular Data: A Prior Alignment Approach](https://arxiv.org/abs/2605.19662)
...
### [17] [Transforming Constraint Programs to Input for Local Search](https://arxiv.org/abs/2605.19671)
...
### [18] [EngiAI: A Multi-Agent Framework and Benchmark Suite for LLM-Driven Engineering Design](https://arxiv.org/abs/2605.19743)
...
### [19] [Memory-Augmented Reinforcement Learning Agent for CAD Generation](https://arxiv.org/abs/2605.19748)
...
### [20] [CogScale: Scalable Benchmark for Sequence Processing](https://arxiv.org/abs/2605.19758)
...
### [21] [What Really Improves Mathematical Reasoning: Structured Reasoning Signals Beyond Pure Code](https://arxiv.org/abs/2605.19762)
...
### [22] [GroupAffect-4: A Multimodal Dataset of Four-Person Collaborative Interaction](https://arxiv.org/abs/2605.19765)
...
### [23] [Minimax Optimal Variance-Aware Regret Bounds for Multinomial Logistic MDPs](https://arxiv.org/abs/2605.19768)
...
### [24] [OpenComputer: Verifiable Software Worlds for Computer-Use Agents](https://arxiv.org/abs/2605.19769)
...
### [28] [From Prompts to Pavement Through Time: Temporal Grounding in Agentic Scene-to-Plan Reasoning](https://arxiv.org/abs/2605.19824)
...
### [29] [Streamlined Constraint Reasoning via CNN Pattern Recognition on Enumerated Solutions](https://arxiv.org/abs/2605.19895)
*Patrick Spracklen*
...
### [30] [Probabilistic Tiny Recursive Model](https://arxiv.org/abs/2605.19943)
...
### [31] [GeoX: Mastering Geospatial Reasoning Through Self-Play and Verifiable Rewards](https://arxiv.org/abs/2605.20006)
...
### [32] [When Skills Don't Help: A Negative Result on Procedural Knowledge for Tool-Grounded Agents in Offensive Cybersecurity](https://arxiv.org/abs/2605.20023)
...
### [33] [AutoResearchClaw: Self-Reinforcing Autonomous Research with Human-AI Collaboration](https://arxiv.org/abs/2605.20025)
...
### [34] [Using Aristotle API for AI-Assisted Theorem Proving in Lean 4: A Formalisation Case Study of the Grasshopper Problem](https://arxiv.org/abs/2605.20120)
...
### [35] [Not Every Rubric Teaches Equally: Policy-Aware Rubric Rewards for RLVR](https://arxiv.org/abs/2605.20164)
...
### [36] [HaorFloodAlert: Deseasonalized ML Ensemble for 72-Hour Flood Prediction in Bangladesh Haor Wetlands](https://arxiv.org/abs/2605.20167)
...
### [37] [A Methodology for Selecting and Composing Runtime Architecture Patterns for Production LLM Agents](https://arxiv.org/abs/2605.20173)
*Vasundra Srinivasan*
...
### [38] [Position: Let's Develop Data Probes to Fundamentally Understand How Data Affects LLM Performance](https://arxiv.org/abs/2605.18801)
...
### [40] [Projecting Latent RL Actions: Towards Generalizable and Scalable Graph Combinatorial Optimization](https://arxiv.org/abs/2605.19721)
...
### [41] [PEEK: Context Map as an Orientation Cache for Long-Context LLM Agents](https://arxiv.org/abs/2605.19932)
...
### [42] [Dimensional Balance Improves Large Scale Spatiotemporal Prediction Performance](https://arxiv.org/abs/2605.18793)
*Jing Chen,Shixiang Pan,Yujie Fan,Haocheng Ye,Haitao Xu,Wenqiang Xu*

Main category: cs.LG

TL;DR: 提出一个可扩展的自适应框架，通过协调时空特征表示来解决现有方法在性能瓶颈和跨领域可迁移性方面的限制。该方法通过低秩矩阵嵌入压缩空间维度，并扩展时间范围来捕捉长期依赖关系。


<details>
  <summary>Details</summary>
Motivation: 准确的时空模式分析在城市交通、气象和公共卫生监测等领域至关重要，但现有方法面临性能瓶颈，通常只能获得渐进式改进，且跨领域可迁移性有限。时空熵测量显示，较大的不匹配通常伴随着更高的预测不确定性，特别是在固定模型能力预算下。

Method: 提出一个可扩展的自适应框架来协调空间和时间特征表示：1) 通过低秩矩阵嵌入压缩空间维度以保留基本结构；2) 扩展时间范围来捕捉长期依赖关系，减轻由时间异质性引起的累积误差。

Result: 在城市交通、气象和流行病数据集上的广泛实验表明，该方法在这些评估领域中获得了显著的精度提升和广泛的适用性，表明该框架对超越当前研究的广泛时空任务具有潜力。

Conclusion: 该研究提出了一个有效的时空模式分析框架，通过协调空间和时间特征表示来解决现有方法的性能瓶颈。实验证明该方法在多个领域具有显著优势，并具有广泛的应用潜力。代码已在GitHub上开源。
...
### [43] [UCCI: Calibrated Uncertainty for Cost-Optimal LLM Cascade Routing](https://arxiv.org/abs/2605.18796)
*Varun Kotte*

Main category: cs.LG

TL;DR: UCCI是一个基于校准优先的LLM级联路由器，通过将token级边际不确定性映射到每查询错误概率，并使用受约束的成本最小化选择升级阈值，从而降低推理成本。


<details>
  <summary>Details</summary>
Motivation: 大多数已部署的路由器使用未校准的置信度分数，需要针对每个工作负载进行阈值调优，这导致LLM级联和模型路由的潜力未能充分发挥。

Method: 提出UCCI方法：1)通过等渗回归将token级边际不确定性映射到每查询错误概率；2)通过受约束的成本最小化选择升级阈值；3)在三个明确假设下，校准分数上的阈值策略是成本最优的。

Result: 在生产命名实体识别任务中，使用4B和12B指令调优LLM在H100 GPU上服务75,000个查询：1)推理成本降低31%；2)预期校准误差从0.12降至0.03；3)在相同操作点上优于熵阈值、拆分一致性路由和FrugalGPT风格学习阈值。

Conclusion: UCCI通过校准优先的方法有效实现了LLM级联路由，显著降低了推理成本并提高了校准精度，在真实生产环境中展示了优越性能。
...
### [44] [Simply Stabilizing the Loop via Fully Looped Transformer](https://arxiv.org/abs/2605.18797)
*Rao Fu,Zixuan Yang,Jiankun Zhang,Jing Ma,Hechang Chen,Yu Li,Yi Chang*

Main category: cs.LG

TL;DR: Fully Looped Transformer通过两种参数免费修改解决了Looped Transformer训练不稳定问题，能够在最多12次循环迭代下稳定训练，并在推理时通过调整循环迭代次数平衡性能与计算成本。


<details>
  <summary>Details</summary>
Motivation: Looped Transformer通过重复使用相同的Transformer块来提供增加计算换取性能提升的替代方案，不需要增加参数数量或上下文长度。然而，当循环迭代次数增加时，Looped Transformer存在训练不稳定性问题。

Method: 1）完全循环架构：将跨循环信号分布到所有层以缓解残差爆炸；2）注意力注入：重用现有注意力块来抑制梯度振荡。这两种都是参数免费的修改。

Result: Fully Looped Transformer能够稳定训练多达12个循环迭代，而其他基线循环模型在此情况下会崩溃。在Looped Transformer不崩溃的较温和设置下，Fully Looped Transformer仍然将平均下游任务性能提升了13.2%。

Conclusion: Fully Looped Transformer通过解决梯度振荡和残差爆炸问题，显著改善了训练稳定性，增强了下游性能，并通过在推理时调整循环迭代次数，为不同的测试时间计算预算提供了初步的适应性。
...
### [45] [Accurate Evaluation of Quickest Changepoint Detectors via Non-parametric Survival Analysis](https://arxiv.org/abs/2605.18798)
*Taiki Miyagawa,Akinori F. Ebihara*

Main category: cs.LG

TL;DR: 本文提出了用于快速变化点检测（QCD）中平均运行长度（ARL）和平均检测延迟（ADD）的非参数估计器KM-ARL和KM-ADD，解决了实际数据中序列长度有限且不规则的问题。


<details>
  <summary>Details</summary>
Motivation: 在实际应用中，ARL和ADD虽然被广泛用作理论和仿真研究中的最优性标准，但在实际数据集中的应用受到有限和不规则序列长度的阻碍，需要能够适应这些现实约束的估计方法。

Method: 通过将QCD与生存分析进行类比，利用序列截断下的检测概率建模，提出了非参数估计器KM-ARL和KM-ADD。推导了估计偏差界限，并证明了除非需要外推，否则它们是渐近无偏的。

Result: 在模拟和真实数据集上的实验表明，KM-ARL和KM-ADD具有实际应用价值，增强了对有限和不规则序列长度的鲁棒性，提高了可解释性，并促进了经验直观的模型选择。

Conclusion: 该方法提供了一种实用的解决方案，使QCD理论标准能够更好地应用于实际数据分析中，并通过开源Python代码为实践者提供了即用型实现。
...
### [46] [ReCrit: Transition-Aware Reinforcement Learning for Scientific Critic Reasoning](https://arxiv.org/abs/2605.18799)
...
TL;DR: ReCrit：一种基于转换感知强化学习的框架，用于改善大语言模型在科学推理中的批评者交互能力，通过将初始回答到批评后回答的行为分解为四个象限并针对性奖励/惩罚来提高模型对批评的正确响应。


<details>
  <summary>Details</summary>
Motivation: 大型语言模型在科学推理中不仅可能回答错误，还可能在被用户批评后放弃最初正确的科学解决方案。这特别危险，因为用户批评可能会将有效答案变成错误答案。现有方法主要关注最终答案准确性，而忽略了回答在批评交互过程中的转换问题。

Method: 提出ReCrit框架，将批评者交互视为跨轮次的正确性转换问题而非最终答案准确性问题。将Initial-to-Critic行为分解为四个象限：纠正(Correction)、迎合(Sycophancy)、鲁棒性(Robustness)和边界(Boundary)。采用转换感知的强化学习方法，奖励纠正和鲁棒性，惩罚迎合，将持久性错误视为弱边界信号。为了实际交互训练，使用动态异步展开和尾部自适应完成来减少展开等待。

Result: 在三个科学推理基准测试ChemBench、TRQA和EarthSE上，ReCrit将Qwen3.5-4B的平均批评者准确率从38.15提高到51.49，将Qwen3.5-9B的平均批评者准确率从45.40提高到55.59。消融研究表明，最终答案奖励提供的交互级增益很小，而转换感知奖励和象限加权产生更可区分的训练信号和更大的净批评者阶段改进。

Conclusion: ReCrit框架通过将批评者交互建模为转换问题，并针对不同行为类型设计针对性奖励机制，有效提高了大语言模型在科学推理中对批评的正确响应能力，为解决模型在批评交互中的科学准确性下降问题提供了有效解决方案。
...
### [47] [Theory-optimal Quantization Based on Flatness](https://arxiv.org/abs/2605.18800)
*Xiusheng Huang,Zhe Li,Xuanwu Yin,Lu Wang,Yequan Wang,Dong Li,Emad Barsoum,Kang Liu*

Main category: cs.LG

TL;DR: 提出了一种名为BDQ（Bidirectional Diagonal Quantization）的新型大语言模型后训练量化方法，通过优化矩阵变换有效分散激活异常值，在低比特量化中取得了优异性能。


<details>
  <summary>Details</summary>
Motivation: 大语言模型量化面临的主要挑战是激活异常值，特别是在低比特精度下会显著降低模型性能。现有方法通过线性变换处理异常值，但变换后的权重和激活仍存在集中化的异常值模式。

Method: 1. 建立量化误差与异常值的数学模型关系；2. 引入"Flatness"指标量化异常值分布；3. 推导基于Flatness的理论最优解；4. 提出BDQ框架，通过学习对角线操作策略性地在矩阵维度间分散异常值幅度。

Result: 1. 在LLaMA-3-8B模型上实现W4A4量化时准确率下降小于1%；2. 在更具挑战性的W2A4KV16设置下，相比现有最佳方法，在DeepSeek-R1-Distill-LLaMA-70B模型上性能差距减少39.1%；3. 建立了新的量化基准。

Conclusion: BDQ通过优化的双向对角线变换有效分散异常值模式，为大语言模型后训练量化提供了新的有效解决方案，特别是在极低比特量化场景下表现优异。
...
### [48] [PROWL: Prioritized Regret-Driven Optimization for World Model Learning](https://arxiv.org/abs/2605.18803)
*Ahmet H. Güzel,Jenny Seidenschwarz,Benjamin Graham,Jonathan Sadeghi,Jeffrey Hawke,Jack Parker-Holder,Ilija Bogunovic*

Main category: cs.LG

TL;DR: PROWL：通过KL约束对抗课程训练改进视频世界模型的稳健性，利用主动发现的失败轨迹进行对抗性训练，解决了稀有但关键的交互场景中模型失效问题。


<details>
  <summary>Details</summary>
Motivation: 现代动作条件视频世界模型在短期视觉真实感上表现良好，但在稀有、交互关键的状态转换上不可靠，这些转换对下游规划和策略性能至关重要。被动演示数据系统性地对这些高影响力状态欠采样，需要通过主动暴露模型失败来改进稳健性。

Method: 1) 引入KL约束对抗课程：训练策略暴露扩散世界模型的高误差轨迹，同时保持在行为分布附近；2) 世界模型在对抗发现的轨迹上持续微调，形成对抗训练循环；3) 提出优先级对抗轨迹(PAT)缓冲区，基于预测误差、动作保真度和学习进度重新排序轨迹，专注于未解决的失败模式。

Result: 在MineRL框架中实现并评估，PROWL在保持分布外的轨迹上表现优于仅使用被动数据训练的模型，能揭示弱行为约束下的奖励黑客行为，表明有效的对抗世界模型训练需要平衡探索性失败发现与显式行为正则化。

Conclusion: 可扩展的世界模型不仅受益于更大的数据集，还受益于有选择地生成信息丰富的训练数据。对抗性训练可以将罕见失败转化为稳定、近分布的训练信号，而不偏离分布外利用。
...
### [49] [Block-Based Double Decoders](https://arxiv.org/abs/2605.18807)
*Asher Labovich,Benjamin Bradley,Vanessa Alexander,Chaitanya Harsha*

Main category: cs.LG

TL;DR: 提出基于块的双解码器架构，使用双重因果块注意力掩码，结合解码器训练效率和编码器-解码器推理效率，大幅减少KV缓存内存和计算开销。


<details>
  <summary>Details</summary>
Motivation: 编码器-解码器模型在推理时间上比纯解码器模型有优势，但它们的预训练目标存在监督稀疏和序列长度动态变化的问题，这限制了它们在大规模实践中的应用。

Method: 提出基于块的双解码器架构，采用双重因果块注意力掩码进行训练，实现了完整的损失监督和静态序列打包，结合了纯解码器模型的训练效率和编码器-解码器模型的推理效率。

Result: 在扩展定律实验中，基于块的双解码器显著优于编码器-解码器模型，并在不同规模上与纯解码器模型表现相近。推理时能减少至少2/3的KV缓存内存和每标记计算，同时保留了预填充缓存和其他现有推理优化。

Conclusion: 基于块的双解码器架构成功解决了编码器-解码器模型的预训练效率问题，实现了高效的训练和推理，为大规模应用提供了可行的解决方案。
...
### [50] [Compositional Literary Primitives in Instruction-Tuned LLMs: Cross-Architectural SAE Features for Self, Style, and Affect](https://arxiv.org/abs/2605.18808)
*Joao Paulo Cavalcante Presa,Savio Salvarino Teles de Oliveira*

Main category: cs.LG

TL;DR: 使用稀疏自编码器在两个指令微调大语言模型（Llama 3.1 8B-Instruct和Gemma 2 9B-IT）的中深度残差流中发现了文学基元的组合架构，包含四类特征：命名门、自我聚类、风格调节器和组合情绪。


<details>
  <summary>Details</summary>
Motivation: 研究大语言模型是否具有可解释的文学基元组合架构，探索模型内部表示中是否存在类似于文学创作的元素和模式。

Method: 在Llama和Gemma模型的中深度残差流上应用稀疏自编码器提取特征，使用三级验证流程（对数透镜、LLM评分、5-LLM评判小组）和27类情绪分类法进行评估。

Result: 发现了四类特征：1）命名门促进目标情感的词汇标记；2）11个自我聚类的一人称注册特征；3）风格调节器（展示不讲述和陌生化）；4）需要多特征引导的组合情绪。Llama模型实现了27/27情绪覆盖，Gemma达到23/27，仅"崇拜"情绪失败。

Conclusion: 两个架构都包含同时作为注册标记和情绪发射器的自我特征，包括每个架构中最受RLHF加载的自我特征。模型输出存在架构差异：Llama更直接命名情感，而Gemma通过场景和意象唤起情感。验证流程计算成本低（单GPU，每个情绪特征发现周期约15分钟）。
...
### [51] [D-PACE: Dynamic Position-Aware Cross-Entropy for Parallel Speculative Drafting](https://arxiv.org/abs/2605.18810)
*Tianyu Wu,Yu Yao,Zhenting Qi,Han Zheng,Zhuohan Wang,Haoran Ma,Lawrence Liao,Himabindu Lakkaraju,Ju Li,Yilun Du*

Main category: cs.LG

TL;DR: 论文提出了D-PACE（动态位置感知交叉熵）损失函数，这是一种新的多令牌草案训练方法，通过动态调整训练权重来优化推测解码中的并行草案生成。


<details>
  <summary>Details</summary>
Motivation: 现有基于扩散的并行草案模型（如DFlash）在训练时使用固定位置依赖的权重调度，如头依赖权重或块位置衰减。这些方法无法适应训练过程中限制接受的位置变化，因此需要一种能够动态调整训练权重的优化方法。

Method: 提出了D-PACE损失函数，从可微分的预期接受草案长度替代函数推导出每个位置的训练权重，将每个位置的权重与其对数概率梯度贡献相匹配。该方法将训练信号转向当前限制接受的位置，随着草案模型的改进而动态调整。

Result: 在六个基准测试、两个Qwen3-4B草案深度、两个解码温度和两个额外目标模型上，D-PACE一致提高了实际时钟加速和平均发射长度，仅增加了2.3%的训练时间开销，且无需改变草案模型架构或推理过程。

Conclusion: D-PACE通过动态位置感知的训练权重优化，显著改善了推测解码中并行草案模型的性能，在保持架构不变的前提下实现了更好的加速效果和接受长度。
...
### [52] [PASC: Pipeline-Aware Conformal Prediction with Joint Coverage Guarantees for Multi-Stage NLP and LLM Pipelines](https://arxiv.org/abs/2605.18812)
*Varun Kotte*

Main category: cs.LG

TL;DR: PASC（Pipeline-Aware Split Conformal）是一种为多阶段NLP/LLM管道提供联合不确定性量化的方法，通过将多阶段联合覆盖问题简化为单个标量共形预测问题，确保所有K个阶段同时以至少1-α的概率被覆盖，相比传统方法更紧致且高效。


<details>
  <summary>Details</summary>
Motivation: 现代NLP和LLM系统通常是多阶段管道（如NER→NED→实体类型，检索增强生成，智能体链等），各阶段的误差会累积。现有不确定性量化方法要么独立校准每个阶段（无法保证联合覆盖），要么使用Bonferroni联合边界（联合覆盖但过于保守），缺乏高效准确的联合不确定性量化方法。

Method: PASC方法将多阶段联合覆盖问题简化为单个标量共形预测问题，基于联合最大非共形性分数。它计算一个单一的分位数，为所有K个阶段提供有限样本、无分布保证，确保所有阶段同时以至少1-α的概率被覆盖，且紧致度达到1/(n+1)因子内。

Result: 在CoNLL-2003数据集上的三阶段NER→NED→实体类型管道中，PASC达到96.4%的端到端覆盖，而Bonferroni为93.4%，独立CP为86.5%（平均预测集大小相同为1.083）。在分布转移到WNUT-17 Twitter和WikiNEuRal Wikipedia数据时，PASC维持目标覆盖，而独立CP崩溃到59%。PASC运行速度快1.7倍于Bonferroni，可扩展到K=6阶段（独立CP端到端覆盖降至0.53）。

Conclusion: PASC提供了一种高效、紧致且可扩展的方法来解决NLP/LLM管道中的联合不确定性量化问题。它显著优于现有的独立校准和Bonferroni方法，在实际分布转移下保持鲁棒性，且计算效率高。该方法可广泛应用于复合LLM系统和智能体管道。
...
### [53] [Composition of Memory Experts for Diffusion World Models](https://arxiv.org/abs/2605.18813)
*Sebastian Stapf,Pablo Acuaviva Huertos,Aram Davtyan,Paolo Favaro*

Main category: cs.LG

TL;DR: 论文提出了一种基于扩散模型的世界建模框架，通过集成异构记忆专家的乘积专家方法，解决传统架构在记忆效率和保真度之间的权衡问题


<details>
  <summary>Details</summary>
Motivation: 现有世界模型架构面临基本的内存权衡：Transformer保留局部细节但受限于二次方注意力计算开销，而循环和状态空间模型虽然计算效率更高但会压缩历史信息导致保真度损失

Method: 引入基于扩散模型的框架，采用对比性乘积专家公式集成异构记忆模型，包括：短期记忆专家捕捉精细局部动态，长期记忆专家通过轻量级测试时微调在外部扩散权重中存储事件历史，以及空间长期记忆专家确保几何和空间一致性

Result: 在模拟和真实世界基准测试中，该方法提高了时间一致性、过去观测的回忆能力以及导航性能，避免了模式崩溃，能够扩展到长上下文而无需二次方计算成本

Conclusion: 该研究为构建和操作记忆增强的扩散世界模型建立了一种新颖范式，通过解耦未来-过去一致性并集成专门化专家系统，克服了现有架构在记忆效率和保真度之间的基本权衡
...
### [54] [DynaTrain: Fast Online Parallelism Switching for Elastic LLM Training](https://arxiv.org/abs/2605.18815)
...
### [55] [Symmetry in the Wild: The Role of Equivariance in Neural Fluid Surrogates](https://arxiv.org/abs/2605.18816)
...
### [56] [Efficient Conditioning Why Pseudo Observation Batch Bayesian Optimization Works When It Does not](https://arxiv.org/abs/2605.18819)
...
### [57] [Emergence of Frontier Superposition: Möbius attractor and Cascade Supervision](https://arxiv.org/abs/2605.18820)
...
### [58] [Quantum Adversarial Machine Learning: From Classical Adaptations to Quantum-Native Methods](https://arxiv.org/abs/2605.18821)
...
### [59] [Not All Tokens Are Worth Caching: Learning Semantic-Aware Eviction for LLM Prefix Caches](https://arxiv.org/abs/2605.18825)
...
### [60] [The Routing and Filtering Structure of Attention](https://arxiv.org/abs/2605.18826)
...
### [61] [Lossless Anti-Distillation Sampling](https://arxiv.org/abs/2605.18829)
...
### [62] [In-Context Learning Operates as Concept Subspace Learning](https://arxiv.org/abs/2605.18830)
...
### [63] [VCR: Learning Valid Contextual Representation for Incomplete Wearable Signals](https://arxiv.org/abs/2605.18837)
...
### [64] [Lying Is Just a Phase: The Hidden Alignment Transition in Language Model Scaling](https://arxiv.org/abs/2605.18838)
*Adil Amin*
...
### [65] [An Integrated Forecasting Prototype for Emergency Department Boarding Time to Support Proactive Operational Decision Making](https://arxiv.org/abs/2605.18839)
...
### [66] [From Cumulative Constraints to Adaptive Runtime Safety Control for Nonstationary Reinforcement Learning](https://arxiv.org/abs/2605.18841)
...
### [67] [Safe Continual Reinforcement Learning under Nonstationarity via Adaptive Safety Constraints](https://arxiv.org/abs/2605.18842)
*Timofey Tomashevskiy*
...
### [68] [First-Passage Prediction of Grokking Delay: ACalibrated Law under AdamW with Causal Validation](https://arxiv.org/abs/2605.18845)
...
### [69] [Exact Linear Attention](https://arxiv.org/abs/2605.18848)
*Weinuo Ou*
...
### [70] [INSIGHTS: Demonstration-Based Summaries of Time Series Predictors](https://arxiv.org/abs/2605.18849)
...
### [71] [INAR-VL: Input-Aware Routing for Edge-Cloud Vision-Language Inference](https://arxiv.org/abs/2605.18853)
...
### [72] [Delta Attention Residuals](https://arxiv.org/abs/2605.18855)
...
### [73] [Towards Family-Grouped Hierarchical Federated Learning on Sub-5KB Models: A Feasibility Study of Privacy-Preserving ECG Monitoring for Ultra-Resource-Constrained Wearables](https://arxiv.org/abs/2605.18862)
*Hangyu Wu*
...
### [74] [SAGE: Shaping Anchors for Guided Exploration in RLVR of LLMs](https://arxiv.org/abs/2605.18864)
...
### [75] [From Sparsity to Simplicity: Enabling Simpler Sequential Replacements via Sparse Attention Distillation](https://arxiv.org/abs/2605.18865)
...
### [76] [FLUIDSPLAT: Reconstructing Physical Fields from Sparse Sensors via Gaussian Primitives](https://arxiv.org/abs/2605.18866)
...
### [77] [EVA-0: Test-Time Model Evolution with Only Two Forward Passes per Sample](https://arxiv.org/abs/2605.18867)
...
### [78] [MO-CAPO: Multi-Objective Cost-Aware Prompt Optimization](https://arxiv.org/abs/2605.18869)
...
### [79] [A Multi-Dimensional Clustering Approach for Identifying Inborn Errors of Immunity](https://arxiv.org/abs/2605.18880)
...
### [80] [Prediction Is Not Physics: Learning and Evaluating Conserved Quantities in Neural Simulators](https://arxiv.org/abs/2605.18883)
...
### [82] [Data-Free Client Contribution Estimation via Logit Maximization for Federated Learning](https://arxiv.org/abs/2605.18892)
...
### [83] [Position: Graph Condensation Needs a Reset -- Move Beyond Full-dataset Training and Model-Dependence](https://arxiv.org/abs/2605.18893)
...
### [84] [Don't Let Bandit Feedback Pull Continual LLM-Recommender Updates Off Target](https://arxiv.org/abs/2605.18899)
...
### [85] [Metric-Gradient Projection for Stable Multi-Agent Policy Learning](https://arxiv.org/abs/2605.18809)
...
### [87] [Stability and Discretization Error of State Space Model Neural Operators](https://arxiv.org/abs/2605.18905)
...
### [88] [Does Your Wildfire Prediction Model Actually Work, or Just Score Well?](https://arxiv.org/abs/2605.18911)
...
### [89] [Hybrid-LoRA: Bridging Full Fine-Tuning and Low-Rank Adaptation for Post-Training](https://arxiv.org/abs/2605.18822)
...
### [90] [HypergraphFormer: Learning Hypergraphs from LLMs for Editable Floor Plan Generation](https://arxiv.org/abs/2605.18932)
...
### [91] [FedMental: Evaluating Federated Learning for Mental Health Detection from Social Media Data](https://arxiv.org/abs/2605.18936)
...
### [92] [Precision Tracked Transformer via Kalman Filtering, Kriging and Process Noise](https://arxiv.org/abs/2605.18832)
...
### [93] [Shaping the Prior: How Synthetic Task Distributions Determine Tabular Foundation Model Quality](https://arxiv.org/abs/2605.18971)
...
### [94] [Automated Big Data Quality Assessment using Knowledge Graph Embeddings](https://arxiv.org/abs/2605.18833)
...
### [95] [The Growing Pains of Frontier Models: When Leaderboards Stop Separating and What to Measure Next](https://arxiv.org/abs/2605.18840)
*Adil Amin*
...
### [96] [Deep Neural Sheaf Diffusion](https://arxiv.org/abs/2605.19021)
...
### [97] [Learning When to Adapt](https://arxiv.org/abs/2605.19028)
...
### [98] [KVBuffer: IO-aware Serving for Linear Attention](https://arxiv.org/abs/2605.19049)
...
### [99] [Transformers Linearly Represent Highly Structured World Models](https://arxiv.org/abs/2605.18847)
...
### [100] [Mapping Uncharted Symmetries: Machine Discovery in Combinatorics](https://arxiv.org/abs/2605.19063)
...
### [101] [Riemannian Networks over Full-Rank Correlation Matrices](https://arxiv.org/abs/2605.19073)
...
### [102] [Robust Checkpoint Selection for Multimodal LLMs via Agentic Evaluation and Stability-Aware Ranking](https://arxiv.org/abs/2605.18852)
...
### [103] [The impact of observation density on Bayesian inversion of latent dynamics in shock-dominated flows](https://arxiv.org/abs/2605.19076)
...
### [104] [When Individually Calibrated Models Become Collectively Miscalibrated](https://arxiv.org/abs/2605.18858)
*Zhaohui Wang*
...
### [105] [MANGO: Meta-Adaptive Network Gradient Optimization for Online Continual Learning](https://arxiv.org/abs/2605.19080)
...
### [107] [Chessformer: A Unified Architecture for Chess Modeling](https://arxiv.org/abs/2605.19091)
...
### [108] [Counterfactual Likelihood Tests for Indirect Influence in Private Reasoning Channels](https://arxiv.org/abs/2605.19092)
...
### [109] [ScheduleFree+: Scaling Learning-Rate-Free & Schedule-Free Learning to Large Language Models](https://arxiv.org/abs/2605.19095)
*Aaron Defazio*
...
### [110] [Performance Monitoring of Proton Exchange Membrane Water Electrolyzer by Transformers-Based Machine Learning Model](https://arxiv.org/abs/2605.19107)
...
### [111] [EgoBabyVLM: Benchmarking Cross-Modal Learning from Naturalistic Egocentric Video Data](https://arxiv.org/abs/2605.19130)
...
### [112] [CLIC: Contextual Language-Informed Cardiac Pathology Classification](https://arxiv.org/abs/2605.19132)
...
### [113] [Identifiable Multimodal Causal Representation Learning under Partial Latent Sharing](https://arxiv.org/abs/2605.19135)
...
### [114] [GRASP: Deterministic argument ranking in interaction graphs](https://arxiv.org/abs/2605.19141)
...
### [115] [EUPHORIA: Efficient Universal Planning via Hybrid Optimization for Robust Industrial Robotic Assembly](https://arxiv.org/abs/2605.18872)
...
### [116] [PMF-CL: Pareto-Minimal-Forgetting Continual Learner for Conflicting Tasks](https://arxiv.org/abs/2605.19145)
...
### [118] [To Call or Not to Call: Diagnosing Intrinsic Over-Calling Bias in LLM Agents](https://arxiv.org/abs/2605.18882)
...
### [119] [Bridge: Retrieval-Augmented Spatiotemporal Modeling for Urban Delivery Demand](https://arxiv.org/abs/2605.19172)
...
### [120] [Planner-Admissible Graph-PDE Value Extensions for Sparse Goal-Conditioned Planning](https://arxiv.org/abs/2605.19185)
*Shiheng Zhang*
...
### [121] [Soft Learning](https://arxiv.org/abs/2605.18889)
...
### [123] [Worst-Group Equalized Odds Regularization for Multi-Attribute Fair Medical Image Classification](https://arxiv.org/abs/2605.19214)
...
### [124] [DeRegiME: Deep Regime Mixtures for Probabilistic Forecasting under Distribution Shift](https://arxiv.org/abs/2605.19231)
...
### [125] [Dynamic Model Merging Made Slim](https://arxiv.org/abs/2605.18904)
...
### [127] [Euclidean Embedding of Data Using Local Distances](https://arxiv.org/abs/2605.19243)
*Dimitris Arabadjis*
...
### [128] [Beyond Extrapolation: Knowledge Utilization Paradigm with Bidirectional Inspiration for Time Series Forecasting](https://arxiv.org/abs/2605.19249)
...
### [129] [ExECG: An Explainable AI Framework for ECG models](https://arxiv.org/abs/2605.19258)
...
### [130] [Backdooring Masked Diffusion Language Models](https://arxiv.org/abs/2605.19262)
...
### [131] [Distilling Linearized Behavior for Effective Task Arithmetic](https://arxiv.org/abs/2605.18993)
...
### [132] [From Simple to Complex: Curriculum-Guided Physics-Informed Neural Networks via Gaussian Mixture Models](https://arxiv.org/abs/2605.19263)
...
### [133] [CODA: Rewriting Transformer Blocks as GEMM-Epilogue Programs](https://arxiv.org/abs/2605.19269)
...
### [134] [EviTrack: Selection over Sampling for Delayed Disambiguation](https://arxiv.org/abs/2605.19283)
*Omer Haq*
...
### [135] [Cross-Paradigm Knowledge Distillation: A Comprehensive Study of Bidirectional Transfer Between Random Forests and Deep Neural Networks for Big Data Applications](https://arxiv.org/abs/2605.19299)
...
### [136] [A Two-Phase Adaptive Balanced Penalty Method for Controllable Pareto Front Learning under Split Feasibility Conditions](https://arxiv.org/abs/2605.19306)
...
### [138] [Inference-Time Scaling in Diffusion Models through Iterative Partial Refinement](https://arxiv.org/abs/2605.19317)
...
### [139] [BrainDyn: A Sheaf Neural ODE for Generative Brain Dynamics](https://arxiv.org/abs/2605.19324)
...
### [144] [Understanding Dynamics of Adam in Zero-Sum Games: An ODE Approach](https://arxiv.org/abs/2605.19392)
...
### [145] [TIDE: Asymmetric Neural Circuits for Stabilized Temporal Inhibitory-Excitatory Dynamics](https://arxiv.org/abs/2605.19403)
...
### [149] [CEPO: RLVR Self-Distillation using Contrastive Evidence Policy Optimization](https://arxiv.org/abs/2605.19436)
...
### [151] [Implicit Bias of Mirror Flow in Homogeneous Neural Networks: Sparse and Dense Feature Learning](https://arxiv.org/abs/2605.19458)
...
### [152] [Quantifying the Pre-training Dividend: Generative versus Latent Self-Supervised Learning for Time Series Foundation Models](https://arxiv.org/abs/2605.19462)
...
### [153] [Sampling-Based Safe Reinforcement Learning](https://arxiv.org/abs/2605.19469)
...
### [158] [AR1-ZO: Topology-Aware Rank-1 Zeroth-Order Queries for High-Rank LoRA Fine-Tuning](https://arxiv.org/abs/2605.19767)
...
### [159] [Latent Laplace Diffusion for Irregular Multivariate Time Series](https://arxiv.org/abs/2605.19805)
...
### [160] [Online Market Making and the Value of Observing the Order Book](https://arxiv.org/abs/2605.19584)
...
### [161] [FLUXtrapolation: A benchmark on extrapolating ecosystem fluxes](https://arxiv.org/abs/2605.19812)
...
### [162] [Physics-Informed Graph Neural Network Surrogates for Turbulent Nanoparticle Dispersion in Dental Clinical Environments](https://arxiv.org/abs/2605.19589)
...
### [163] [ST-TGExplainer: Disentangling Stability and Transition Patterns for Temporal GNN Interpretability](https://arxiv.org/abs/2605.19822)
...
### [164] [A Family of Divergence Measures for Evaluating the Reconstruction Quality of Explainable Ensemble Trees](https://arxiv.org/abs/2605.19618)
...
### [165] [Smooth Piecewise Cutting for Neural Operator to Handle Discontinuities and Sharp Transitions](https://arxiv.org/abs/2605.19823)
...
### [166] [A Closed-loop, State-centric, Multi-agent Framework for Passenger Load Estimation from Heterogeneous Data Streams](https://arxiv.org/abs/2605.19834)
...
### [167] [Optimal Reconstruction from Linear Queries](https://arxiv.org/abs/2605.19625)
...
### [168] [StableGrad: Backward Scale Control without Batch Normalization](https://arxiv.org/abs/2605.19856)
...
### [170] [Fast and Featureless Node Representation Learning with Partial Pairwise Supervision](https://arxiv.org/abs/2605.19916)
...
### [171] [Agentic Discovery of Cryomicroneedle Formulations](https://arxiv.org/abs/2605.19677)
...
### [172] [A Measure-Theoretic Analysis of Reasoning: Structural Generalization and Approximation Limits](https://arxiv.org/abs/2605.19944)
...
### [174] [Detecting Fluent Optimization-Based Adversarial Prompts via Sequential Entropy Changes](https://arxiv.org/abs/2605.19966)
...
### [175] [Block-Sphere Vector Quantization](https://arxiv.org/abs/2605.19972)
...
### [176] [B-cos GNNs: Faithful Explanations through Dynamic Linearity](https://arxiv.org/abs/2605.19778)
...
### [177] [Learning with Foresight: Enhancing Neural Routing Policy via Multi-Node Lookahead Prediction](https://arxiv.org/abs/2605.19975)
...
### [178] [LLM Benchmark Datasets Should Be Contamination-Resistant](https://arxiv.org/abs/2605.19999)
...
### [179] [LionMuon: Alternating Spectral and Sign Descent for Efficient Training](https://arxiv.org/abs/2605.19811)
...
### [180] [Training Neural Networks with Optimal Double-Bayesian Learning](https://arxiv.org/abs/2605.20009)
...
### [181] [When Critics Disagree: Adaptive Reward Poisoning Attacks in RIS-Aided Wireless Control System](https://arxiv.org/abs/2605.20037)
...
### [182] [General Lower Bounds for Differentially Private Federated Learning with Arbitrary Public-Transcript Interactions](https://arxiv.org/abs/2605.19813)
*Yicheng Li*
...
### [183] [INSHAPE: Instance-Level Shapelets for Interpretable Time-Series Classification](https://arxiv.org/abs/2605.20088)
...
### [184] [Draft Less, Retrieve More: Hybrid Tree Construction for Speculative Decoding](https://arxiv.org/abs/2605.20104)
...
### [185] [Beyond Isotropy in JEPAs: Hamiltonian Geometry and Symplectic Prediction](https://arxiv.org/abs/2605.20107)
...
### [186] [Set-Valued Policy Learning](https://arxiv.org/abs/2605.19830)
...
### [187] [Toto 2.0: Time Series Forecasting Enters the Scaling Era](https://arxiv.org/abs/2605.20119)
...
### [188] [Atoms of Thought: Universal EEG Representation Learning with Microstates](https://arxiv.org/abs/2605.20182)
...
### [189] [Fast Tensorization of Neural Networks via Slice-wise Feature Distillation](https://arxiv.org/abs/2605.19842)
...
### [190] [Hierarchical Contrastive Learning for Multi-Domain Protein-Ligand Binding](https://arxiv.org/abs/2605.19902)
...
### [191] [JAXenstein: Accelerated Benchmarking for First-Person Environments](https://arxiv.org/abs/2605.19926)
