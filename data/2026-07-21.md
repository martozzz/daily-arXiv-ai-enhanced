...
### [22] [Let the Data Decide: Supervision Analysis, Capability Trade-offs, and Adaptive Objective Routing in Continued Pre-Training via Off-Policy Distillation](https://arxiv.org/abs/2607.16246)
...
### [24] [High-accuracy Low-Bit KV-Cache Quantization via Local Distribution Restoration](https://arxiv.org/abs/2607.16248)
...
### [25] [Benchmarking Machine Learning Models for Multi-Omics-Based Breast Cancer Prediction](https://arxiv.org/abs/2607.16250)
...
### [26] [Learning Spatio-Temporal Foundation Models from Pure Synthetic Data](https://arxiv.org/abs/2607.16251)
...
### [27] [SOS-LoRA: Static Orthogonal-Subspace Low-Rank Adaptation with Fixed Multi-Scale Scaling](https://arxiv.org/abs/2607.16252)
...
### [28] [Comprehensive Evaluation of Machine Learning for Type 2 Diabetes Risk Prediction: Large-Scale External Validation and Fairness Analysis](https://arxiv.org/abs/2607.16253)
...
### [29] [More Than Memory: Task-Conditioned Signed FFN Writes in Long-Context Retrieval](https://arxiv.org/abs/2607.16254)
*Zhibo Yang*
...
### [30] [Feature Generation Using LLMs: An Evolutionary Algorithm Approach](https://arxiv.org/abs/2607.16255)
...
### [31] [Discovery by Dreaming: Cross-Domain Recombination in Artificial Memory](https://arxiv.org/abs/2607.16256)
...
### [32] [From Outcomes to Actions: Leveraging Hindsight for Long-Horizon Language Agent Training](https://arxiv.org/abs/2607.16257)
...
### [33] [Neural Controlled Differential Equations for EMT-Level Surrogate Modeling of Grid-Forming Inverters](https://arxiv.org/abs/2607.16258)
...
### [35] [AdaSurvMamba: Dynamic Fusion and Semantic Scanning for Multimodal Survival Analysis](https://arxiv.org/abs/2607.16260)
...
### [37] [Autonomous mechanistic discovery of colorectal cancer vulnerabilities via multi-scale AI swarms](https://arxiv.org/abs/2607.16262)
...
### [38] [Preference-based Antibody Expression Ranking: Scaling with Large-scale Weak Supervision](https://arxiv.org/abs/2607.16263)
...
### [39] [PsiLogic: Chaos-Aware Active Cancellation for Adam with a Fair Cross-Domain Benchmark](https://arxiv.org/abs/2607.16268)
*Ali Sultonov*
...
### [40] [A Predict-then-Correct Loop Based on Few-Shot Continuous Contextual Bandit for Demand Forecasting](https://arxiv.org/abs/2607.16354)
...
### [41] [Scaling Limits of Constant-Stepsize SGD at Flat Minima](https://arxiv.org/abs/2607.16384)
...
### [42] [Retrieval is Enough: Training-Free Interpretability with a Tool-Using Agent](https://arxiv.org/abs/2607.16448)
...
### [43] [EA-RMENet -- Path Loss Prediction in Urban Environments using Deep Learning](https://arxiv.org/abs/2607.16449)
...
### [44] [Compact convolutional neural networks for AI-based drone detection system](https://arxiv.org/abs/2607.16455)
...
### [45] [K-IPO: Kendall-constrained Importance Preserving Oversampling for Imbalanced Tabular Data](https://arxiv.org/abs/2607.16478)
...
### [46] [Leakage-Robust Evaluation and Data-Scale Sensitivity of Attention-Enhanced Multi-Task Learning for Joint Fault Diagnosis and Remaining Useful Life Estimation](https://arxiv.org/abs/2607.16493)
...
### [47] [Feedback Attribution and Representation Geometry: Metrics for Comparing Individual and Shared Rewards in MARL](https://arxiv.org/abs/2607.16524)
...
### [48] [Hierarchical Domain Generalization](https://arxiv.org/abs/2607.16528)
...
### [49] [Building2Building: A Large Scale Benchmark for Generalizable Real-World Reinforcement Learning](https://arxiv.org/abs/2607.16534)
...
### [50] [Discrete Ricci Curvature on Protein Contact Graphs for Lightweight Fold Classification](https://arxiv.org/abs/2607.16553)
*Jianru Shen*
...
### [51] [Capacity and Redundancy Trade-offs in Multi-Task Learning](https://arxiv.org/abs/2607.16554)
*Asif Khan*
...
### [52] [Learning from World Feedback: Why Model Uncertainty Fails as a Risk Signal in Model-Based RL](https://arxiv.org/abs/2607.16591)
*Zhaohui Wang*
...
### [53] [Privacy Cost as Equity Input: A Group Fairness Criterion for Differentially Private Machine Learning](https://arxiv.org/abs/2607.16620)
*Rakshit Naidu*
...
### [54] [Multimodal Attention-based Deep Learning for Emergency Triage with Electronic Health Records](https://arxiv.org/abs/2607.16662)
...
### [55] [CLDRoute: Conditional Latent Diffusion for Routability Map Generation in Physical Design](https://arxiv.org/abs/2607.16674)
...
### [56] [A Framework for Early Sepsis Prediction via Self-Supervised (JEPA) and Federated Representation Learning](https://arxiv.org/abs/2607.16681)
...
### [57] [Building a Neural Network from Scratch: Implementation, Evaluation, and Optimization](https://arxiv.org/abs/2607.16682)
*Yuanzhe Jia*
...
### [58] [Effects of width-dependent model hyperparameters and $\ell_2$-regularization on the loss landscape of two-layer ReLU networks](https://arxiv.org/abs/2607.16720)
...
### [59] [Half the Experts, All the Code: One-Shot Domain Pruning of Mixture-of-Experts LLMs for Coding](https://arxiv.org/abs/2607.16721)
*Anik Jha*
...
### [60] [Graph-Embedded Intuitionistic Fuzzy Broad Learning System: A Multi-view Framework](https://arxiv.org/abs/2607.16728)
...
### [61] [BG4Sea: Biogeochemical Seasonal Forecastability via Progressive Information Scaling](https://arxiv.org/abs/2607.16731)
...
### [62] [The Anatomy of a Truth Direction: Knowledge-Dependent Dimensionality, a Relational Law, and a Convergent Category Geometry in Small Language Models](https://arxiv.org/abs/2607.16741)
...
### [63] [Robust Losses from Univariate Base Functions for Noisy-Label Learning](https://arxiv.org/abs/2607.16768)
*Peng Hu,Jianwei Ma*
...
### [64] [On the Potential of Graph Neural Networks as Metamodels for Supply Chain Optimization: Dataset, Architectures, and Directions](https://arxiv.org/abs/2607.16769)
...
### [65] [MultiLoReFT: Decoupling Shared and Modality-Specific Subspaces in Multimodal Learning via Low-Rank Representation Fine-Tuning](https://arxiv.org/abs/2607.16789)
...
### [66] [Value-Monotonicity Matters: A Concordance Loss for Deep Survival Prediction](https://arxiv.org/abs/2607.16802)
...
### [67] [Interpretable Anomaly and Drift Detection with Gaussian Mixture Models](https://arxiv.org/abs/2607.16811)
*Behnam Asadi*
...
### [68] [Honest Physical-Support Inference after Latent Dictionary Learning: Collision Singularities and Minimax Resolution](https://arxiv.org/abs/2607.16813)
*Guan-Ju Peng*
...
### [69] [First-Order Predictable but Pairwise Fragile: Local Task Adaptation in Trained Transformers](https://arxiv.org/abs/2607.16821)
...
### [70] [Beyond Memory Leaderboards: Evaluating Scientific Memory as Budgeted Context Restoration](https://arxiv.org/abs/2607.16848)
...
### [71] [Principled Direction-Free Intrinsic Motivation through Model-Free Epistemic Free-Energy Estimators](https://arxiv.org/abs/2607.16858)
...
### [72] [Bridging battery design and health assessment through virtual sensing and physics-informed learning](https://arxiv.org/abs/2607.16864)
...
### [73] [HyBDM: Multi-Scale Hybrid Experts for Time Series Forecasting with Bidirectional Dependency Modeling](https://arxiv.org/abs/2607.16882)
...
### [74] [Certified-Gap Dual-Price Policies for Real-Time Truckload Bid Acceptance with Relocating, Clock-Constrained Resources](https://arxiv.org/abs/2607.16891)
...
### [75] [TVGL-CFM:Generating and Forecasting Time-Varying Trajectories of Dynamic Networks with Conditional Flow Matching](https://arxiv.org/abs/2607.16894)
...
### [76] [When Can Safe Controllers Adapt? Information before Commitment](https://arxiv.org/abs/2607.16895)
*Venkatesh Saligrama*
...
### [77] [Enhancing Personalized Bladder Cancer Treatment Through Reinforcement Learning: A Recurrent Patient State Transition Decision Support Framework](https://arxiv.org/abs/2607.16916)
...
### [78] [Investigation of Polycystic Ovary Syndrome (PCOS) Diagnosis Using Machine Learning Approaches](https://arxiv.org/abs/2607.16941)
...
### [79] [CADENCE: Closing the Reasoning Gap via Coverage-Adaptive On-Policy Distillation](https://arxiv.org/abs/2607.16955)
...
### [80] [SurvCF(t): Counterfactual Explanations for Survival Analysis in Predictive Maintenance Multivariate Time Series Data](https://arxiv.org/abs/2607.16969)
...
### [81] [TurboVec: A Case Study in Cost-Efficient Private Retrieval for Enterprise RAG via Codebook-Oblivious Quantization](https://arxiv.org/abs/2607.16973)
...
### [82] [Periodic Bootstrap Thompson Sampling For Periodically Non-Stationary Bandit Problems](https://arxiv.org/abs/2607.16986)
*Boning Shao*
...
### [83] [Counterfactual Shapley Credit Assignment](https://arxiv.org/abs/2607.16999)
...
### [84] [Scalable Causal Imitation Learning](https://arxiv.org/abs/2607.17003)
...
### [85] [Regularize or Localize: When Training-Time KV-Cache Geometry Pays Under Quantization](https://arxiv.org/abs/2607.17019)
...
### [86] [Interpretable Machine Learning for Air Pollution and Respiratory Health Prediction: A Socioeconomic Subgroup Analysis](https://arxiv.org/abs/2607.17024)
...
### [87] [ChemFusion: A Multimodal Cross-Attention Network for Reaction Yield Prediction](https://arxiv.org/abs/2607.17033)
*Qiwei Han,Chi Zhou*
...
### [88] [Apeliotes: A Diffusion-Based Modeling Framework for km-scale Multi-Level Atmospheric Fields](https://arxiv.org/abs/2607.17037)
...
### [89] [Solver-Hard Is Not Model-Hard: A Hardness-Controlled Diagnostic for LLM Constraint Reasoning](https://arxiv.org/abs/2607.17047)
*Lucky Verma*
...
### [90] [What does a Bayes-filtered transformer believe? A predictive Monte Carlo approach](https://arxiv.org/abs/2607.17060)
...
### [91] [Persistent Sparse Autoencoders: Learning Feature Timescales in Language Models](https://arxiv.org/abs/2607.17117)
...
### [92] [Robust Assamese Speech Recognition through Controlled Fine-Tuning of Whisper Models](https://arxiv.org/abs/2607.17164)
...
### [93] [Explaining and Tuning Transformer-based LLMs in Arithmetic Tasks with Human Strategies](https://arxiv.org/abs/2607.17166)
...
### [94] [DADIR: Density-Aware Data-level Imbalanced Regression Framework](https://arxiv.org/abs/2607.17178)
...
### [95] [DynImmune-BERT: Dynamic Immune Repertoire Modeling with Neural ODE Driven Continuous Transformers](https://arxiv.org/abs/2607.17244)
...
### [96] [Distilled Reinforcement Learning for LLM Post-training](https://arxiv.org/abs/2607.17247)
...
### [97] [Node4All: Learning Node Representation Beyond Datasets](https://arxiv.org/abs/2607.17272)
...
### [98] [AIGB-R1: Self-Evolving Generative Auto-Bidding via Hierarchical Planner-Executor Optimization](https://arxiv.org/abs/2607.17281)
...
### [99] [An Iterative Geometric Approach to Optimizing Separating Hyperplanes](https://arxiv.org/abs/2607.17282)
*Akos Hajnal*
...
### [100] [Lookahead Branching for Neural Network Verification](https://arxiv.org/abs/2607.17290)
...
### [101] [DRNOISE: Benchmarking Deep Research Agents in Misleading Evidence Environments](https://arxiv.org/abs/2607.17291)
...
### [102] [WAR: Workload-Aware Rollouts for Synchronous Agentic Reinforcement Learning](https://arxiv.org/abs/2607.17299)
...
### [103] [Rationalizing Boltzmann Rationality: An Axiomatic Characterization of Entropy-Regularized Policies](https://arxiv.org/abs/2607.17316)
*Silviu Pitis*
...
### [104] [TAPAS: Throughput-adaptive Perception for Autonomous Systems](https://arxiv.org/abs/2607.17317)
...
### [105] [Rethinking the Suitability of Reinforcement Learning Algorithms Under Practical Transfer Constraints](https://arxiv.org/abs/2607.17326)
...
### [106] [When Drift Detectors cry Wolf: False Alarm Rates in continuous ML Monitoring](https://arxiv.org/abs/2607.17336)
*Raj Shekhar Singh*
...
### [107] [A multiverse-consensus pipeline for reproducible feature selection in untargeted LC-MS metabolomics](https://arxiv.org/abs/2607.17345)
...
### [108] [Chebyshev Manifold Adaptation](https://arxiv.org/abs/2607.17377)
*Jiawen Li*
...
### [109] [CoEvoP&R: Co-Evolving Placement Objectives with Routing Feedback via Large Language Models](https://arxiv.org/abs/2607.17398)
...
### [110] [CORAL: Learning Amyloid Fibril Ligand Docking with Cooperative Binding Rewards](https://arxiv.org/abs/2607.17412)
...
### [111] [Grounded verification of chemical and materials reasoning: detection is the bottleneck](https://arxiv.org/abs/2607.17417)
...
### [112] [Kernelized Linear Attention: Breaking the Capacity Wall with Symmetric Cones](https://arxiv.org/abs/2607.17419)
...
### [113] [Decoder-Preserving Sparse Autoencoders: Which Readouts Survive Sparse Compression?](https://arxiv.org/abs/2607.17425)
*Aniket Deshpande*
...
### [114] [Abliteration Is Not a Scalpel: Off-Target Effects of Refusal Removal on Decision Disposition Across Model Families](https://arxiv.org/abs/2607.17427)
*Aleksander Fafuła*
...
### [115] [Calibrated Alzheimer's Conversion Risk in Mild Cognitive Impairment: Persistent Homology of Clinical Trajectories with Conformal Guarantees](https://arxiv.org/abs/2607.17442)
*Navin Bondade*
...
### [116] [Residual-Guided Multi-Resolution Refinement of Foundation Models: A Case Study in Drought Forecasting](https://arxiv.org/abs/2607.17507)
...
### [117] [Retrieval-Augmented Interpretable Learning: Towards Task-Specific Zero-Shot Models in Healthcare](https://arxiv.org/abs/2607.17508)
...
### [118] [Lightweight Wrappers for Adapting Time Series Foundation Models to Regional Drought Forecasting](https://arxiv.org/abs/2607.17511)
*Wentao Gao,Jiuyong Li,Lin Liu,Thuc Duy Le,Jixue Liu,Yanchang Zhao,Yun Chen*
...
### [119] [After the Euclidean Highway: Hyperbolic Expert AI as the Next Innovation](https://arxiv.org/abs/2607.17513)
...
### [120] [One-step lowest-variance selection in a Gaussian random-field model motivated by masked diffusion: Total correlation and a square root collision threshold](https://arxiv.org/abs/2607.17522)
*Linjun Li*
...
### [121] [FailureAtlas: A Taxonomy of Failure Modes in Multi-Provider LLM Serving Infrastructure](https://arxiv.org/abs/2607.17525)
...
### [122] [Program Synthesis for Simulation-Based Inference: Joint Model Selection and Parameter Estimation](https://arxiv.org/abs/2607.17540)
...
### [123] [Volatility-Aware Extreme Event Detection in High-Frequency Financial Markets](https://arxiv.org/abs/2607.17555)
...
### [124] [CoCurve: Cross-Module Co-Pruning Curvature for Training-Free Structured LLM Pruning](https://arxiv.org/abs/2607.17568)
...
### [125] [A Weisfeiler-Leman Characterization of Global-Attention Graph Transformers for Mixed-Integer Linear Programs](https://arxiv.org/abs/2607.17570)
...
### [126] [AGG: Jacobian-Aggregated Group Gradient for Efficient GRPO Training of Diffusion Models](https://arxiv.org/abs/2607.17572)
...
### [127] [ANNLib: A Development Framework for Efficient Approximate Nearest Neighbor Search](https://arxiv.org/abs/2607.17582)
...
### [128] [Concentration and Mean-Square Bounds for Contractive Stochastic Approximation: A Unified Elementary Approach](https://arxiv.org/abs/2607.17595)
*Siddharth Chandak*
...
### [129] [Trustworthy Protein-Ligand Binding Affinity Prediction via Reliability-Aware Multi-Engine Fusion](https://arxiv.org/abs/2607.17601)
...
### [130] [Optimizing the Preconditioner: A Black-box Online-to-Nonconvex Conversion with Static Regret Minimization Oracles](https://arxiv.org/abs/2607.17607)
...
### [131] [PoLoRA: A Preconditioned Orthogonalized LoRA Optimizer](https://arxiv.org/abs/2607.17620)
...
### [132] [Can Transformers Really Do It All? On the Compatibility of Inductive Biases Across Tasks](https://arxiv.org/abs/2607.17624)
...
### [133] [TypiCore: A Hybrid Active Query Strategy for Class-Incremental Learning on Time Series](https://arxiv.org/abs/2607.17632)
...
### [134] [Selectivity Matters: Source Node Influence Pruning for Unsupervised Graph Domain Adaptation](https://arxiv.org/abs/2607.17668)
...
### [135] [Beyond Objective Expressivity: Geometry Preservation in Multimodal Contrastive Learning](https://arxiv.org/abs/2607.17673)
...
### [138] [MXSens: Sensitivity-Aware Mixed-Precision Quantization for Efficient LLM Inference](https://arxiv.org/abs/2607.17733)
...
### [139] [Generalize and Guide: Decomposing Rewards for Few-Shot Inverse Reinforcement Learning](https://arxiv.org/abs/2607.17760)
...
### [141] [FIFA World Cup 2026 as a Contamination-Free Benchmark for LLM Forecasting Agents: Four Models, a Bookmaker, and 104 Matches](https://arxiv.org/abs/2607.17765)
...
### [142] [Feature Attribution-Based Explainability Analysis of Deep Learning Models in Predictive Process Monitoring](https://arxiv.org/abs/2607.17783)
...
### [143] [Towards Reliable Zero-Shot Crowd Forecasting: Evaluating Time Series Foundation Models for Special Event Pedestrian Forecasting](https://arxiv.org/abs/2607.17758)
...
### [144] [Phasor Attention: Mean Root Square Normalization for Phase Manifold Preservation](https://arxiv.org/abs/2607.17822)
...
### [145] [The Art of Not Forgetting](https://arxiv.org/abs/2607.17944)
...
### [146] [A Geometric Perspective on Stabilizing Value Conflict Resolution](https://arxiv.org/abs/2607.17946)
...
### [147] [Topological Signatures of Context-Level Reliability in TabPFN](https://arxiv.org/abs/2607.17962)
...
### [148] [The Concept of Representation in ML: Beyond Plato and Aristotle](https://arxiv.org/abs/2607.17800)
...
### [149] [Harness Engineering for LLM-Driven GPU Kernel Generation](https://arxiv.org/abs/2607.17979)
...
### [150] [MADA-RL: Multi-Agent Debate-Aware Reinforcement Learning for Parameter-Efficient Reasoning in Compact Models](https://arxiv.org/abs/2607.18006)
...
### [151] [Theoretical Foundations of $\max$@$k$ Reinforcement Learning](https://arxiv.org/abs/2607.17823)
...
### [152] [SGN: A Similarity-based Generative Network for Data Generation under Distribution Shift](https://arxiv.org/abs/2607.18072)
...
### [155] [Distributional Soft Bellman Operator under the Cramér Geometry](https://arxiv.org/abs/2607.17897)
...
### [156] [SelectInfer: Selective Neuron Loading and Computation for On-Device LLMs](https://arxiv.org/abs/2607.18081)
...
### [157] [Enhancing Rubric-based RL via Self-Distillation](https://arxiv.org/abs/2607.18082)
...
### [158] [Do Language Models Dream of Binding Molecules? Benchmarking LLMs under Spatial Constraints](https://arxiv.org/abs/2607.18144)
...
### [159] [Differentiable Logic Gate Networks for Low-Latency EEG Classification on Edge Devices](https://arxiv.org/abs/2607.18149)
...
### [160] [DiFA: Inference-Time Forward-Process Alignment for Diffusion Models](https://arxiv.org/abs/2607.17972)
*Shigui Li,Delu Zeng*
...
### [161] [OR Else: A Differentiable Trust Region for Policy Optimization](https://arxiv.org/abs/2607.18163)
...
### [162] [A Continual Validation, Updating, and Decision-Making Framework for Self-Adaptive Digital Twins via Robust Model Predictive Control: A Case Study in Additive Manufacturing](https://arxiv.org/abs/2607.18164)
...
### [163] [Information-Based Exploration via Random Features for Reinforcement Learning](https://arxiv.org/abs/2607.17981)
...
### [164] [fSRD: Fuzzy Spectral Region Decomposition -- Automated Multi Operator Koopman Representations via an Adaptive Spectral Learning Architecture](https://arxiv.org/abs/2607.17990)
...
### [165] [FlashPDE: A Drop-in Fused Triton Operator Library for Neural PDE Solvers](https://arxiv.org/abs/2607.18020)
...
### [166] [L1 Augmented Attention as an Improved Vector Similarity Metric](https://arxiv.org/abs/2607.18027)
*Kurt Godden*
...
### [167] [Adaptive Mamba Neural Operators](https://arxiv.org/abs/2607.18043)
...
### [168] [SEE: Structure-aware Exploring \& Exploiting for Long-horizon GUI Agent Trajectory Synthesis](https://arxiv.org/abs/2607.18046)
...
### [169] [Sobek: Streaming Equivariant Tensor Product Convolutions](https://arxiv.org/abs/2607.18074)
...
### [170] [The Label Complexity of Class-Conditional Coverage under Distribution Shift](https://arxiv.org/abs/2607.18088)
*Weijia Han,Lisha Qu*
...
### [171] [Empowering On-Device Model Adaptation with an Edge AI Inference Accelerator](https://arxiv.org/abs/2607.18101)
...
### [172] [LLM-as-a-Coach: Experiential Learning for Non-Verifiable Tasks](https://arxiv.org/abs/2607.18110)
...
### [173] [Manifold-Constrained Hyper-Connections for Parameter-Efficient Finetuning](https://arxiv.org/abs/2607.18130)
...
### [174] [Totally Positive Matrices and the Highest-Order Coefficients of the Characteristic Polynomial](https://arxiv.org/abs/2607.18148)
...
### [175] [The Calibration Channel Determines the Bayes-Error Proxy: An Exact Law for Temperature-Induced Distortion](https://arxiv.org/abs/2607.18162)
...
### [179] [Rater State Bias in RLHF Preference Data: An Audit Framework](https://arxiv.org/abs/2607.16195)
*Elena Kopteva,Vitaliy Hlynianyi-Zhuk*

Main category: cs.AI

TL;DR: 研究发现RLHF中标注者在压力状态下的偏好偏移会导致结构化偏差，提出可测试假设和审计框架来检测这种偏差。


<details>
  <summary>Details</summary>
Motivation: 在RLHF中，成对偏好标签本应反映输出比较，但也可能反映标注者标注时的状态。在持续压力或痛苦条件下，标注者的偏好可能随时间变化，导致偏好数据同时编码了标注者状态和响应质量判断。这种变化不同于普通的分歧或随机标签噪声，它具有状态依赖性，可在相似条件下工作的标注者之间共享，并可能通过奖励建模和策略优化传播。因此需要系统研究这种结构化偏差的来源。

Method: 1) 概念定义：明确定义标注者状态偏移、标注者状态混杂和相关性标注者状态偏差
2) 响应模式测量：定义生存水平情感真实性作为可测量的响应模式
3) 理论分析：分析相关性标注者状态偏差如何通过聚合进入学习的奖励信号
4) 预测推导：提出五个可证伪的预测和效应大小阈值
5) 审计设计：制定审计协议和试点研究计划，适用于公开可用的指令调优模型

Result: 提出了标注者状态偏移作为RLHF偏好数据中结构化偏差的合理且可测试的来源假设，并开发了相应的审计框架。该框架包括：1) 关键概念的定义；2) 可测量的响应模式指标（生存水平情感真实性）；3) 对偏差传播机制的分析；4) 五个具体的可证伪预测；5) 适用于公开模型的审计协议和试点研究计划。

Conclusion: 本研究确定了RLHF偏好数据中结构化偏差的一个潜在来源——标注者状态偏移，并提出了一个可测试的假设和审计框架。研究通过定义关键概念、推导可证伪预测，并制定审计协议，为理解和检测这种结构化偏差提供了系统性的方法框架。未来工作可应用该框架对公开模型进行实证审计。
...
### [180] [Design and Validation of a Lightweight 1D CNN for Affective Touch Classification in Soft Plush Companions](https://arxiv.org/abs/2607.16196)
...
TL;DR: 研究开发了用于软质伴侣情感触觉识别的开源深度学习框架，创建了公共数据集，发现压缩扩张1D CNN模型效果最佳（85%交叉验证准确率），并提出了混合推理管道实现实时嵌入式部署。


<details>
  <summary>Details</summary>
Motivation: 软质传感伴侣为社会辅助技术提供了物理安全和情感直观的接口，但其可变形性和多通道触觉传感使得对人类情感的稳健解释变得复杂。需要开发一种能够准确识别情感触觉的深度学习模型，以便在软质交互伴侣中实现情感意义的触觉解释。

Method: 本研究提出了一个完整的基于MATLAB的开源框架，用于开发适用于软质交互伴侣的情感触觉识别模型。研究贡献主要包括：收集并公开发布了一个包含1326个标记手势序列的FAIR标准数据集（来自儿童、青少年和成人的25名参与者），并通过对468个CNN模型的架构和超参数进行系统探索，确定了压缩扩张一维卷积神经网络（1D CNNs）为最有效解决方案。

Result: 研究结果表明，一个仅含13.2k参数的1D CNN模型在测试集上达到75%的准确率，在留一受试者交叉验证中达到85%的平均准确率。理论推理时间分析显示，量化部署仅需每窗口3.2 MMAC，兼容目标微控制器上的20Hz实时操作。PC端实时模拟显示，CNN能够解析先前启发式系统未能检测到的细微社交触摸，而高力度的负面交互则通过简单的阈值逻辑更可靠地捕捉。研究提出了混合推理管道（即时启发式过滤后接CNN精细手势分类）作为嵌入式部署策略。

Conclusion: 本研究表明，情感丰富的、保护隐私的触觉识别技术是可以在软质治疗伴侣中直接嵌入实现的，这为开发具有精细情感交互能力的社交辅助机器人提供了可行方案。
...
### [181] [Some Large Language Models Exhibit Consistent Risk Attitudes](https://arxiv.org/abs/2607.16197)
*Bowen Sun,Rui Min,Yuxi Wang,Brian Odegaard,Qi Wang,Jing Du*

Main category: cs.AI

TL;DR: LLM在不确定性下表现出稳定且一致的风险态度，具有任务内一致性、跨任务排序稳定性，且风险态度分布比人类更受限。


<details>
  <summary>Details</summary>
Motivation: 动机在于，当人工智能系统在开放式、高风险环境中部署时，一个关键维度未被测量：感知风险如何转化为行动。作者旨在测试大型语言模型（LLM）在不确定性下是否表现出系统性和一致的风险态度。

Method: 该方法引入了一个跨领域框架，将情境风险信念与分类决策解耦，并应用于六个代表性的LLM和100名人类参与者，涵盖空间导航、临床分诊和财务分配任务。使用回归模型提取每个代理的信念到决策映射，并量化风险敏感性和风险态度偏差。

Result: 研究发现，大多数测试的LLM表现出（i）任务内稳健一致性，表明在固定任务域内从情境信念到风险决策的稳定映射；（ii）跨领域排序稳定性，保持任务间相对风险姿态；（iii）相对于更广泛的人类基线，风险态度分布趋于受限。

Conclusion: 论文结论表明，风险态度是LLM行为中一个稳定且以前未被充分认识的特征维度，这为评估和对齐开放式决策中的AI系统奠定了基础，并促使进一步探究这些内在行为倾向的起源。
...
### [182] [A Survey on GNN-based Link Prediction: Techniques, Applications, and Challenges](https://arxiv.org/abs/2607.16198)
*Chengcheng Sun,Yajie Song,Cheng Zhai,Jiayun Tian,Jia Yang,Xiaobin Rui,Jian Zhang,Zhixiao Wang,Philip S. Yu*

Main category: cs.AI

TL;DR: 本文从GNN架构的专门视角系统性综述了基于图神经网络的链路预测研究，提出了技术和应用双维度的分类框架，分析了主要GNN编码器架构的特点与实际应用，讨论了当前挑战与未来方向。


<details>
  <summary>Details</summary>
Motivation: 虽然图神经网络已成为链路预测的主流范式，但现有的综述文章缺乏专门针对底层GNN架构和多样图结构的系统性探索。这种关键的空白阻碍了对该领域技术进展的系统理解，因此需要从新颖且专注的GNN视角提供全面的链路预测综述。

Method: 本文采用全面的文献综述方法，通过提出双层分类框架：技术视角（聚焦GCN、GAE、GAT、GFormer等GNN编码器架构）和应用视角（重点分析知识图谱和推荐系统的实际应用）。系统分析了各类方法的核心理念、架构特点、优点与局限性，并对现有挑战和未来方向进行了深入探讨。

Result: 通过对GNN-based链路预测的系统性综述，本文：1) 建立了全面的分类框架，从技术和应用两个维度梳理领域进展；2) 深入分析了GCN-based、GAE-based、GAT-based、GFormer-based等主要GNN编码器架构的特点与优劣；3) 展示了链路预测在知识图谱和推荐系统中的实际应用价值；4) 总结了当前面临的挑战并展望了未来研究方向。

Conclusion: 本文通过从GNN架构的独特视角出发，提出了一种创新的分类法来系统梳理基于GNN的链路预测研究，为学术界和工业界提供了有价值的参考框架，同时指出该领域仍面临数据稀疏性、可扩展性、过平滑等挑战，未来发展可能集中在自监督学习、因果推理和可解释性等方向。
...
### [183] [PlanFlip: Attacking Multi-Agent LLM Systems via Planning-Phase Prompt Injection](https://arxiv.org/abs/2607.16199)
*Yuhang Wang*

Main category: cs.AI

TL;DR: 研究揭示多智能体系统中规划阶段提示注入攻击的严重性，显示强模型反而更脆弱，同质系统存在安全盲点，提出有效检测方法。


<details>
  <summary>Details</summary>
Motivation: 识别多智能体LLM系统中规划阶段作为关键攻击面，单一注入可导致级联放大破坏所有下游子任务，需要分析不同LLM对此类攻击的脆弱性。

Method: 提出PlanFlip框架，包括四种规划阶段提示注入攻击（PF-1到PF-4），评估了9个前沿LLM在3,479个场景中的表现，并引入两种防御机制GoalAnchorCheck和CrossAgentConsensus。

Result: 发现三个关键结果：1)能力越强模型越脆弱（GPT-5攻击成功率最高）；2)同质化流水线存在盲点；3)推理增强模型能抵抗注入攻击。提出的防御方法在16个单元格中的15个优于同质基线。

Conclusion: 论文强调异构模型多样性是多智能体系统的安全先决条件，同质化冗余无法抵御规划阶段攻击，并提出了检测方法。
...
### [184] [Deterministic Replay for AI Agent Systems](https://arxiv.org/abs/2607.16200)
*Rasheed Mudasiru*

Main category: cs.AI

TL;DR: agrepl是一个开发人员优先的CLI框架，通过MITM代理拦截和重放AI代理的外部交互，解决了LLM代理系统的非确定性问题，实现了完全确定性重放。


<details>
  <summary>Details</summary>
Motivation: 当前基于大语言模型的AI代理系统存在固有的非确定性特性，包括LLM采样方差、外部API状态变化、CDN基础设施头和执行环境噪声等，导致现有可观测性平台无法在独立环境中准确重现代理执行。这给调试和复现带来了巨大挑战。

Method: agrepl采用了三种关键技术：1）通过MITM代理在传输层拦截所有外部交互；2）将交互序列化为结构化执行跟踪；3）在零外网访问的严格隔离环境中重放跟踪，并设计了噪声感知差异算法对HTTP头偏差进行分类。

Result: 实证评估显示，agrepl在五个工作负载（共250个重放实例）中实现了重放保真度F = 1.0，且中值每步延迟降低了98.3%，证明系统能够在严格隔离环境下实现完全确定性重放。

Conclusion: 本文开发了一个名为agrepl的CLI框架，能够通过MITM代理拦截并序列化AI代理的外部交互，实现确定性重放，有效解决了现有可观测性平台在AI代理系统调试中的不足，显著提升了调试效率和系统可重现性。
...
### [185] [Generative Ontology Induction: Domain-Agnostic Schema Discovery from Document Corpora Using Large Language Models](https://arxiv.org/abs/2607.16201)
*Sergei Sergienko*

Main category: cs.AI

TL;DR: GOI框架自动从示例生成结构化本体蓝图，在多种领域实现95-100%的节点覆盖，显著优于通用模板。


<details>
  <summary>Details</summary>
Motivation: 传统本体工程方法存在瓶颈：依赖预定义模式、局限于狭窄领域，或产生无结构输出，无法适应下游处理流程的需求。需要一种领域无关、自动化的解决方案。

Method: 开发了生成式本体归纳（GOI）框架，从示例语料中生成包含实体、维度、属性、关系和约束的本体蓝图，并将其导出为YAML/JSON格式的类型化图（6种节点类型，7种边类型）。提出了新颖的节点覆盖分数评估指标。

Result: 在四个对比本体上的验证显示，GOI提示的生成覆盖了95-100%的结构骨架，而通用的三字段模板在发票模式上达到97.8%，但在工作描述本体上降至52.2%，疼痛管理本体上62.2%，专业服务合同本体上78.3%。结构覆盖度不受文档类型对模型熟悉度的影响。

Conclusion: GOI框架通过从示例语料中自动生成结构化本体蓝图，有效解决了传统方法依赖预定义模式、领域受限或无结构化输出等问题，显著提升了本体生成的覆盖率和可扩展性。
...
### [186] [Democratizing AI with Small Language Models: Structured Benchmarking and Parameter-Efficient Fine-Tuning for Local Deployment](https://arxiv.org/abs/2607.16202)
*Daniel Cersosimo*

Main category: cs.AI

TL;DR: 研究发现3B参数以下的开源语言模型经过低成本微调后能够有效处理结构化专业任务，支持AI民主化在现实约束下的实现。


<details>
  <summary>Details</summary>
Motivation: 研究在普通机构可满足的硬件和治理约束下，是否能够通过选择、审计和专业化具备能力的模型来实现AI民主化，而非仅仅追求前沿模型的通用性。

Method: 在NVIDIA L4级硬件预算下，使用4位NF4量化和DoRA/LoRA风格适配器进行参数高效微调，并通过108个示例的保留集评估微调效果。

Result: 基础评估中，Qwen Coder 3B以75.67%的严格准确率领先；在微调后，Qwen Coder 3B提高了26.85个百分点，SmolLM2 1.7B提高了25.92个百分点，其他模型也有显著提升；实验表明微调后的3B以下模型能够胜任结构化专业工作负载。

Conclusion: 通过系统的基准测试、跨模型评估和低成本微调工作流，证明3B参数以下的模型经过专业化后能够成为结构化、专业化工作负载的可行本地解决方案，支持AI民主化在实际硬件和治理约束下的实现。
...
### [187] [Masked Diffusion Language Models are Strong and Steerable Text-Based World Models for Agentic RL](https://arxiv.org/abs/2607.16204)
*Darshan Deshpande*

Main category: cs.AI

TL;DR: 本研究提出一种使用掩码扩散语言模型进行文本环境世界建模的方法，以解决现有自回归模型在生成多样化、基础良好的世界状态时，因左至右偏见而无法条件于全局锚点的问题。结果表明，掩码扩散模型在连贯性、基础性和多样性方面优于更大参数的自回归模型，并通过一个可插拔训练框架实现了显著的零样本性能提升。


<details>
  <summary>Details</summary>
Motivation: 现有的手动精心制作的环境在模型性能提升后会变为无效信号，而长视野下的稀疏奖励容易导致在特定工作流程或工具结构上发生模式坍塌。虽然环境状态模拟的世界模型在纯滚轮性能上与原始环境相当，但现有的自回归世界模型受限于从左到右的生成偏见，无法有效条件于全局相互依赖的锚点(例如工具模式、之前的回合和预期结果)，从而限制了其在不同任务和环境上生成多样化、基础良好的世界状态的能力。

Method: 方法分两个主要方向：(i) 将基于文本的世界建模形式化为一个可引导的转移动态问题，分解为初始状态、任务上下文、工具模式、领域规则和引导指令五个组成部分；(ii) 策划了239,403条有基础的状态-动作轨迹，涉及九个开源环境和十二个前沿模型系列。通过比较自回归语言模型和掩码扩散语言模型，评估了它们在连贯性、基础性和可引导多样性方面的表现。

Result: 结果显示，通过双向锚点感知去噪的掩码扩散语言模型在连贯性、基础性和经验证实的滚轮多样性方面，优于参数规模为其4倍的自回归语言模型，同时推理延迟相近。引入了一个具有确定性状态检查的可插拔GRPO训练框架，在三个OOD环境（ScienceWorld, ALFWorld, AppWorld）和三个1.2B-7B的智能体主干模型（LFM2.5, Qwen3, Mistral）上实现了高达47%的绝对性能增益，而无需环境特定微调。还进行了对抗场景下的行为失败模式分析以及人工评估，评估了真实性、结果正确性和训练效用。

Conclusion: 研究最终证明了使用掩码扩散语言模型进行文本环境世界建模的有效性，特别是在生成多样化、连贯和可引导的世界状态方面。通过可插拔的GRPO训练框架，该方法在不同大小的智能体主干模型和环境上实现了显著的零样本性能提升，显示了其在免环境特定微调下扩展增强学习多样性的潜力。
...
### [188] [It Takes 8 Tokens: Weak-to-Strong Off-Policy RL via Auxiliary Branches](https://arxiv.org/abs/2607.16205)
*Dayu Wang,Jiaye Yang,Weikang Li,Jiahui Liang,Liwei Qian,Xin Pei,Jizhou Huang*

Main category: cs.AI

TL;DR: 本文提出W2SPO方法，通过引入弱辅助模型生成短片段来扩展目标模型的局部探索空间，解决了强化学习中样本语义冗余导致的奖励对比度不足问题，在数学推理任务上实现了性能提升和训练加速。


<details>
  <summary>Details</summary>
Motivation: 传统基于可验证奖励的强化学习方法在优化大型语言模型推理能力时存在支持限制瓶颈：在具有挑战性的推理任务中，目标模型的样本往往表现出语义冗余，收敛到相同的错误'推理盆地'中，导致奖励对比度不足，难以有效进行策略更新。

Method: 提出W2SPO方法，一种离策略强化学习方法，通过在目标模型轨迹中插入由弱辅助模型生成的短片段（通常仅8个标记），然后由目标模型从这些分流状态继续完成推理路径，并基于最终的可验证奖励仅对这些插入的短片段进行策略更新。

Result: W2SPO在数学推理基准测试中，在评估的4B规模模型中取得了优越性能，超过了评估的后训练基线。与相同采样预算下的普通GRPO相比，W2SPO将Pass@1从62.3%提升到64.2%，同时实现了3.55倍的训练加速。

Conclusion: 本研究通过提出W2SPO这一弱到强学习范式，有效解决了可验证奖励强化学习中的支持限制瓶颈问题，证明了通过引入计算效率高的弱辅助模型来扩展目标模型的局部探索空间，能够在减少训练成本的同时显著提升推理性能，为大规模语言模型的强化学习训练提供了新的思路和方法。
...
### [189] [PPO-HSC: An Exploratory Reinforcement Learning Framework Based on Wide-Area Policy Coverage Optimization](https://arxiv.org/abs/2607.16206)
*Yujie Shen,Haowen Chen*

Main category: cs.AI

TL;DR: PPO-HSC是一种增强探索的强化学习框架，通过高阶采样覆盖奖励解决LLM微调中的模式崩溃问题，在多样性和准确性之间取得更好平衡。


<details>
  <summary>Details</summary>
Motivation: 标准强化学习从可验证奖励的方法虽然能有效强化高奖励轨迹，但往往导致模型过度优化已知解决方案，牺牲了好奇心和探索更广泛解流形的能力。这被称为'无形枷锁'的模式崩溃问题，限制了大型语言模型在微调过程中的探索能力。

Method: PPO-HSC框架在标准的近端策略优化基础上，引入了高阶采样覆盖奖励机制。该方法维护一个动态的已验证独特解决方案轨迹库，通过可微分信号奖励语义新颖性，同时通过合理性约束确保结构理性。具体来说，HSC奖励激励模型发现'低相似性但高有效性'的推理模式。

Result: 在数学推理和代码生成任务上的实证评估表明，PPO-HSC在保持或超越最先进强化学习基线准确性和语法完整性的同时，显著增强了解决方案多样性和状态空间覆盖率。

Conclusion: PPO-HSC 成功解决了LLM微调中的模式崩溃问题，通过引入高阶采样覆盖奖励机制，在保持准确性和语法完整性的同时，显著提升了解决方案的多样性和状态空间覆盖率。该框架为增强语言模型的探索能力提供了一种有效方法，平衡了探索和利用之间的权衡。
...
### [190] [JUMP: Single-Pass Membership Inference on Fine-Tuned Diffusion Language Models](https://arxiv.org/abs/2607.16207)
*Yeachan Jun,Albert No*

Main category: cs.AI

TL;DR: JUMP是一种针对微调离散扩散语言模型的高效成员推理攻击方法，利用模型的并行和任意顺序解码特性，通过单次联合掩码查询实现优于现有SAMA方法的攻击性能，且查询成本更低。


<details>
  <summary>Details</summary>
Motivation: 针对微调的离散扩散语言模型（dLLMs），现有的基于损失模仿策略的SAMA攻击虽然利用了任意顺序接口，但仅将其作为随机化手段，且需要大量目标/参考查询。需要开发更高效的成员推理攻击方法来充分利用dLLMs的独特特性并降低查询成本。

Method: 提出了JUMP（Joint Uncertainty-Guided Mask Probing）单次评分攻击方法，利用离散扩散语言模型的两个独特属性：1）使用任意顺序解码能力选择低参考置信度位置；2）利用并行解码能力通过每个模型的单个联合掩码查询对所有选定位置进行评分。该方法将选定位置联合掩码，并计算裁剪后的目标/参考重建差距统计量。

Result: 在六个MIMIR领域的微调LLaDA-8B-Base模型上，JUMP将平均ROC-AUC从SAMA的0.82提升到0.90，并显著改善了低FPR检测性能，同时每个模型仅需要一次选择器传递和一次评分传递。

Conclusion: 针对微调离散扩散语言模型的成员推理攻击，JUMP通过联合不确定性引导掩码探测方法，显著提升了攻击效果，实现了更高的ROC-AUC值和更好的低FPR检测能力，同时大幅降低了查询成本。
...
### [191] [ColGraphRAG: Late-Interaction Evidence Retrieval for Multimodal GraphRAG](https://arxiv.org/abs/2607.16208)
*Seonok Kim*

Main category: cs.AI

TL;DR: 该论文提出用多向量评分替代单向量评分来改进图接地多模态问答中的图像检索，在MultimodalQA上验证了该方法能提升视觉证据检索效果和下游问答性能。


<details>
  <summary>Details</summary>
Motivation: 在图接地的多模态问答中，端到端准确性依赖于哪些多模态资产能够被高排名进入下游推理阶段。对于图关联图像，传统的单向量双编码器相似性计算可能会丢弃补丁和标记级别的结构信息，而这些信息对于细粒度对齐是必要的。

Method: 使用ColBERT/ColPali谱系的晚期交互多向量MaxSim风格评分替换图关联图像节点上的视觉候选排序操作符，同时保持离线图构建、文本和表格端检索、结构化抽取和下游推理不变。

Result: 在MultimodalQA数据集上，这一改变与图关联图像候选在检索阶段的点估计改进以及下游问答性能提升相关，在视觉证据最重要的地方表现出更大的改善，而在文本主导的问题上表现出混合趋势。

Conclusion: 该研究为图关联视觉证据在检索中的重要性提供了机制层面的证据，但作者也指出未来的工作需要更广泛的验证和更精细的图级诊断。
...
### [192] [Shapley Context Pruning: A Cooperative Game Perspective for Context Reranking and Pruning](https://arxiv.org/abs/2607.16209)
*Yanqiao Chen,Dongsheng Hou,Yuhan Rui,Zhen Cao,Yepang Liu*

Main category: cs.AI

TL;DR: 提出SCP框架，从合作博弈理论视角进行上下文排序与剪枝，使用Deep Sets架构和蒙特卡洛采样实现高效可扩展训练，并提供理论保证，在多任务上验证有效性。


<details>
  <summary>Details</summary>
Motivation: 当前RAG系统中的上下文重排序和剪枝方法缺乏可解释的统一框架，现有方法主要依赖词汇检索、交叉编码器架构、模型蒸馏等技术，大多基于启发式损失函数和经验属性。需要建立一个理论严谨且实用的上下文重要性评估框架。

Method: 1. 提出Shapley Context Pruning(SCP)框架，从合作博弈理论视角建模上下文重要性；2. 使用Deep Sets架构实现句子级别的排列不变值函数近似；3. 利用预训练语言模型作为句子编码器；4. 采用成对边缘排序损失进行优化；5. 使用蒙特卡洛采样实现高效训练和推理；6. 提供了Top-K子集排名的理论误差界和样本复杂度保证。

Result: 1. 提出了有理论保证的上下文排序与剪枝框架；2. 通过蒙特卡洛采样实现高效可扩展性；3. 在支持句召回、海量文本检索、长上下文QA和多跳推理等任务上进行了全面实验；4. 进行了嵌入质量和归因策略的严格消融研究；5. 在问答任务性能上与基准方法相比具有竞争力。

Conclusion: 本文提出了一种基于合作博弈理论的上下文排序与剪枝框架SCP，该框架通过Deep Sets架构和蒙特卡洛采样实现了高效可扩展的上下文重要性评估，为RAG系统的效率提升提供了理论保证，并在多种任务上展现出竞争力。
...
### [193] [A Survey on the Verification of Reinforcement Learning Policies](https://arxiv.org/abs/2607.16210)
*Luca Marzari,Ezio Bartocci,Enrico Marchesini*

Main category: cs.AI

TL;DR: 本文是关于强化学习策略验证方法的综述，提出了统一的分类框架来分析现有验证方法，澄清了概念关系并统一了理论基础，以解决神经网络策略缺乏行为保证的安全部署问题。


<details>
  <summary>Details</summary>
Motivation: 随着强化学习在复杂安全关键领域的应用日益增多，基于神经网络的策略缺乏严格的行为保证已成为主要部署障碍。策略表达能力和规模的提升加剧了这一问题，导致RL策略验证工作快速增长但概念上碎片化。

Method: 本文引入了一个三维分类法，从验证范式（形式化与概率性）、时间范围（逐步与多步）、保证强度三个维度对现有方法进行分类，统一了理论基础，并明确了各种方法的隐含假设和局限性。

Result: 该调查提供了一个统一的视角来分析RL验证方法，提出了清晰的分类框架，使不同方法之间的关系得以澄清，并为该领域的未来发展指明了方向。

Conclusion: 该调查通过统一视角澄清了RL策略验证领域的复杂概念和关系，建立了连贯的理论框架，为实际部署中的安全验证提供了理论指导和实践工具，有助于促进强化学习在安全关键领域的可靠应用。
...
### [194] [Accurate and Efficient Long-Term Memory for LLM Agents](https://arxiv.org/abs/2607.16211)
*Zicheng Zhao,Xinyang Guo,Luyao Lv,Menghan Wang,Ming Li,Shuaicheng Li*

Main category: cs.AI

TL;DR: MOSAIC是为LLM代理设计的结构化长期记忆框架，通过实体图存储、哈希加速检索和冲突检测，显著提高准确性和效率，在多项测试中超越现有系统。


<details>
  <summary>Details</summary>
Motivation: 现有持久内存增强的LLM代理系统存在两个主要问题：扁平化存储导致关系上下文丢失，依赖昂贵的LLM分类使其不适合延迟敏感的应用，且缺乏验证机制导致信息矛盾累积。

Method: 提出MOSAIC框架，包含实体类型图存储、哈希加速双路径检索和主动冲突检测三大核心能力，使用哈希代替昂贵的LLM分类进行快速查找。

Result: 在多个测试集上表现优异：LoCoMo准确率达89.35%，较最佳基线提升27.21个点；HaluMem提取F1得分最佳；能检测66%的注入事实冲突；哈希加速检索将平均搜索延迟保持在0.58秒。

Conclusion: MOSAIC是一种高效的长期记忆框架，通过结构化存储和冲突检测显著提升了LLM代理的准确性和响应速度。
...
### [195] [Symbolic Augmentation Closes a Canonical-Equivalence Blind Spot in Neural Fact-Checkers](https://arxiv.org/abs/2607.16212)
*Genpei Zhang*

Main category: cs.AI

TL;DR: 研究表明大模型在科学总结中会错误生成数字和单位，提出符号增强框架能有效解决等价数量识别盲点，提升检测准确性和鲁棒性。


<details>
  <summary>Details</summary>
Motivation: 大型语言模型在总结科学文本时会产生数字和单位的幻象，这类错误可能悄无声息地颠倒科学主张，现有神经事实检查器对此检测效果不佳，且存在结构盲点。

Method: 1）提出五类类型化数量错误分类并创建1500项基准数据集；2）使用ModernBERT编码器在该基准上微调；3）设计符号增强框架，通过反向运行符号验证器模块生成保留标签的增强数据。

Result: 1）微调ModernBERT在基准上达到宏F1=0.899；2）在规范等价改写测试中准确率下降至36.5%；3）应用符号增强后，规范等价鲁棒性提升至98.2%，宏F1微增至0.902；4）在外部基准SciFact-Open上宏F1从0.791提升至0.828；5）符号特征作为辅助输入无增益，噪声下的符号银标签会负面影响性能。

Conclusion: 本文发现虽然现代BERT编码器在检测数量单位错误方面表现良好，但存在结构盲点，而符号增强训练框架能有效解决这一问题，提升模型对等值表达的鲁棒性，证明训练时增强是符号与学习组件的最佳整合方式。
...
### [196] [SelKV: Selective KV Cache Merging with Per-Token Merge-or-Drop and Attention Compensation](https://arxiv.org/abs/2607.16213)
*Soumia Bouyahiaoui,Manel Kara laouar,Aicha Boutorh,Mohamed Hadj Ameur*

Main category: cs.AI

TL;DR: 提出训练自由的KV缓存压缩框架，通过软余弦门和注意力比率补偿机制，在仅保留25%缓存的情况下实现高效压缩，在长文本任务中保持质量并显著提升解码速度。


<details>
  <summary>Details</summary>
Motivation: 大型语言模型（LLMs）自回归生成文本时依赖的键值（KV）缓存会随上下文长度线性增长内存占用，成为主要瓶颈。现有的基于标记合并的压缩方法存在不加区分的聚合问题，会导致表征质量下降和注意力衰减，即合并标记与单个标记接收相同的softmax权重尽管编码了多个输入。

Method: 本研究提出了一种训练自由的双组件KV缓存压缩框架：首先使用软余弦门根据值向量相似度自适应调节合并决策，抑制或丢弃不相似标记以保持语义保真度；其次引入注意力比率补偿机制，基于预填充注意力统计量在解码时应用对数偏差，修正因合并引起的softmax不平衡问题。

Result: 在LongBench（16个英文数据集）评估中，仅保留25%的KV缓存时，该框架在代表性单次基线方法上实现了强劲的压缩性能。特别是在评估的分组查询注意力（GQA）模型上表现出强鲁棒性，保持了近乎无损的生成质量。此外，在复杂多文档QA任务上优于全缓存基线，并在10万标记长度下实现了3.3倍的解码加速。

Conclusion: 本研究提出的训练自由双组件框架在保持KV缓存压缩高效率和语义保真度之间取得了良好平衡，特别适用于长上下文场景，为LLMs的推理加速和内存优化提供了有效解决方案。
...
### [197] [RAIL Guard: Closing the Evaluation-to-Remediation Gap in Responsible AI for LLM Agents](https://arxiv.org/abs/2607.16215)
*Sumit Verma,Pritam Prasun,Pritish Kumar*

Main category: cs.AI

TL;DR: RAIL Guard是一个创新的闭环AI责任管道，通过迭代修复而非简单阻止来处理LLM输出安全问题，显著提高了修复效率，同时识别出需要架构解决方案的结构性问题维度。


<details>
  <summary>Details</summary>
Motivation: 现有的大型语言模型代理护栏系统通常作为二元分类器运行，直接阻止不安全内容，导致组织需要丢弃失败输出并从头重试。这种方法效率低下，且缺乏对失败内容的修复机制。

Method: 论文提出了RAIL Guard这一闭环式负责任AI管道，该系统通过评估-重写-再评估循环对LLM输出进行迭代修复。方法涵盖八个可测量维度，并针对4,276个内容输出和6,400个代理工具调用场景进行了实验验证。采用反馈驱动的自修复机制和预工具调用评估来减少不安全执行。

Result: 实验结果显示：1) 闭环修复实现96.9%的收敛率，显著高于阻塞重试方法的49.1%；2) 反馈驱动的自修复在可修复维度上达到86.6%的收敛率，且没有显著效用损失(p=0.177)；3) 预工具调用评估将不安全代理执行减少33%(p=0.007)，且对任务完成率无影响；4) 结构性维度（透明度93.0%、问责性92.8%、包容性82.5%的失败率）需要架构解决方案。

Conclusion: 研究总结指出，可修复维度和结构性维度之间存在关键区别，前者可通过修复算法处理，后者（如透明度、问责性和包容性）则需要架构而非算法解决方案。论文强调通过系统性的评估、重写、再评估循环来管理人工智能责任的重要性，并通过开源SDK提供了实际实现。
...
### [198] [Generalist AI Control: Towards Multi-purpose Adaptive Algorithms](https://arxiv.org/abs/2607.16313)
*Klinsmann Agyei,Pouria Sarhadi*

Main category: cs.AI

TL;DR: 提出了一个通用控制器，通过注意力机制和多专家混合架构，使单一神经网络能够控制不同阶次和动态特性的系统，无需针对特定系统调整，性能与专用控制器相当且具有良好的泛化能力。


<details>
  <summary>Details</summary>
Motivation: 传统控制器专为特定系统设计，无法在不同系统阶次和动态特性之间进行迁移，这限制了控制器的通用性和适应性。

Method: 引入了一种新颖的动态状态空间表示方法，采用带掩码的注意力机制，为每个系统分配系统标签；通过多尺度时间处理和混合专家架构，利用314,630个来自25个不同系统（包括稳定、不稳定、最小相位和非最小相位动态，涵盖线性与非线性系统）的演示数据进行一次性训练。

Result: 仿真结果表明，该通用控制器在所有测试系统（包括具有挑战性的非最小相位和不稳定动态系统）上均取得了与系统特定LQI控制器相当的性能，并能泛化到训练中未见过的工况，包括执行器饱和、噪声、干扰和未遇到的参考轨迹。

Conclusion: 该研究提出的通用控制器通过在单一神经网络中结合注意力机制和多专家混合架构，成功实现了对不同阶次和动态特性的SISO系统的统一控制，无需针对特定系统进行架构修改或参数调整，为动态系统家族内的通用控制策略迈出了重要一步。
...
### [199] [LaCache: Exact Caching and Precision-Adaptive Inference for Diffusion Large Language Models](https://arxiv.org/abs/2607.16339)
*Xingru Chen,Zelang Liang,Yongjia Ma,Jiqing Zhan,Shuling Yang,Lian Wen,Kun Zhan*

Main category: cs.AI

TL;DR: LaCache是一个无需训练的加速框架，通过无损缓存中间结果和混合精度量化，显著减少扩散大语言模型在并行生成时的计算冗余，实现最高40倍加速而不损失准确性。


<details>
  <summary>Details</summary>
Motivation: 当前基于扩散的大型语言模型在并行生成时存在严重的算子级冗余——在去噪步骤中重新计算整个序列，忽略了前缀和屏蔽后缀在块内保持不变的事实。这种冗余限制了实际推理效率。

Method: LaCache 框架采用两类主要技术：1. 损失状态记忆化(LSM)：缓存三种类型的中间结果(EmbedCache, RoPECache, FACache)，避免对不变令牌的重复计算；2. 分组FP8量化：针对扩散过程中不同步骤的激活分布特性，对FFN层实施动态量化策略，缓解内存带宽瓶颈。

Result: 实验表明，LaCache单独使用比原始DLLM实现获得了约1.3倍的端到端加速。当与现有加速方法结合时，能达到最高40.2倍的端到端加速，同时保持了相当的任务准确率。

Conclusion: LaCache 通过无损缓存和混合精度策略有效解决了扩散大语言模型中的计算冗余问题，在保持模型准确性的同时显著提升了推理速度。该方法为基于扩散的文本生成模型提供了一种高效实用的加速方案，尤其在与现有加速技术结合时能发挥更大的性能优势。
...
### [200] [Interactive Task Alignment as a POMDP](https://arxiv.org/abs/2607.16412)
*Andy Dai,Zexue He,Zhenyu Zhang,Alex Pentland,Jiaxin Pei*

Main category: cs.AI

TL;DR: 研究发现当前语言模型在模糊任务处理上存在缺陷，任务对齐能力明显落后于人类，亟需改进交互能力以实现可靠代理。


<details>
  <summary>Details</summary>
Motivation: 现有语言模型主要评估在完全明确任务上的执行能力，而真实用户任务往往存在歧义、不完整或探索性。研究人员提出任务对齐问题，研究模型如何在与用户交互中确认意图任务。

Method: 作者引入了一个通用框架，将明确任务转换为未明确指定的交互，并通过POMDP模型使模型能够从部分和演化的用户意图中推断潜在任务。该框架经过用户模拟器验证，并在多个应用场景中进行评估。

Result: 研究发现，模型在任务明确时表现良好，但在任务对齐方面仍然存在困难：模型过早行动、交互无效且无法解决模糊请求。模型平均仅在22-32%的情况下能成功恢复用户意图任务；同等环境下人类达到48%的成功率，优于所有评估模型。

Conclusion: 该研究强调当前语言模型在任务对齐能力上存在显著不足，无法有效处理模糊用户请求。尽管有监督微调和强化学习能带来改进，但模型仍需在交互式不确定解析方面追赶人类表现。
...
### [201] [When to Plan: Learning to Select Between Reactive Control and Deliberative Planning](https://arxiv.org/abs/2607.16421)
*Adam Labiosa,Josiah P. Hanna*

Main category: cs.AI

TL;DR: 研究提出一种基于强化学习的元推理策略训练方法，通过反应式策略不确定性评分动态分配计算资源，在需要时启动规划，实现了反应式控制与规划之间的智能切换。


<details>
  <summary>Details</summary>
Motivation: 长期以来，人类能够在快速反应式决策与缓慢审慎规划之间切换，即元推理能力。人工智能体如何学习这种能力是一个重要问题。反应式策略（直接从状态映射到动作）易于训练但泛化能力差；基于模型的决策时规划能在更广泛状态下产生良好动作，但计算耗时。如何在两者之间智能分配计算是一个关键挑战。

Method: 研究者提出了一种强化学习方法，训练一个元推理策略，该策略通过条件化于反应式策略的不确定性评分来分配计算资源。不确定性评分使元策略能够预测反应式策略何时可能表现不佳、何时需要规划。在运动规划和导航环境中进行实证研究，验证了该方法的效果。

Result: 实验结果表明，基于不确定性评分的元推理策略设计能够有效学习何时反应式策略提供的动作足够好、何时需要决策时规划。此外，该方法能使元智能体随着反应式策略的改进而自然地向完全反应式控制过渡。

Conclusion: 该研究通过基于不确定性评分的元推理策略设计，成功实现了自主决定何时使用反应式策略、何时启动规划的计算分配机制。随着反应式策略的改善，元智能体能自然地过渡到完全反应式控制，展现了计算效率与决策质量之间的有效权衡。
...
### [202] [Berkeley and Heiserman as an Unexhausted Architecture for Embodied Machine Intelligence](https://arxiv.org/abs/2607.16465)
*Christopher A. Tucker*

Main category: cs.AI

TL;DR: 本文重新解读Edmund C. Berkeley的著作，指出他不仅连接符号逻辑与计算机，更将其发展为机器设计语言，并影响了David L. Heiserman的自适应机器人架构，共同形成了一个至今仍具价值的具身机器人认知设计传统。


<details>
  <summary>Details</summary>
Motivation: 纠正对Edmund C. Berkeley贡献的片面理解——他不仅是一位将符号逻辑与计算机关联的作家，更是致力于将符号逻辑用作机器设计语言的先驱。论文旨在揭示伯克利及其后继者David L. Heiserman所代表的、以逻辑为基础、强调硬件实现与时间性行为的机器人认知架构传统，并论证该传统对当前具身机器人认知研究的持续价值。

Method: 通过文本分析法和历史分析法，以伯克利的《符号逻辑与智能机器》为核心文本，结合其更广泛的作品体系，并延伸对比海瑟曼的著作，系统解读两人如何将逻辑形式、硬件实现与控制、行为设计相连接。

Result: 分析表明，伯克利的核心贡献在于将智能机器定义为操作性的、由输入、输出、内存、计算、控制、状态和事件协调实现的系统，其思想超越了静态逻辑形式，指向与环境耦合的时序行为。海瑟曼则进一步发展了这一方向，构建了基于记忆、置信度和泛化的自适应“生物架构”。二人共同形成了一种强调硬件实现与具身行为的机器人认知架构路径。

Conclusion: 该论文将伯克利和海瑟曼的贡献视为一种历史悠久的、基于逻辑设计与硬件实现相结合的机器人认知架构方法，这种方法仍具有未被充分探索的潜力，尤其适合用于具身机器人如何整合感知、控制、记忆与自适应行为的系统化设计。
...
### [203] [SEER: Supervised Learning to Control Energetic Reasoning](https://arxiv.org/abs/2607.16523)
*Sascha Van Cauwelaert,Michele Lombardi,Pierre Schaus*

Main category: cs.AI

TL;DR: 提出使用机器学习构建预测器，动态决定何时运行复杂传播器，在 Energetic Reasoning 传播器上实验证明可行性，获得高预测准确率并提供特征选择建议。


<details>
  <summary>Details</summary>
Motivation: 约束编程的主要优势在于通过传播减少搜索空间，但传播是一把双刃剑：更强的剪枝能力意味着更高的计算时间成本。对于每个问题约束，最佳传播器取决于具体实例，并可能在搜索过程中动态变化。目前机器学习技术主要用于静态选择传播器，而基于活动的启发式方法用于动态调整传播强度，作者希望将这两种方法结合起来。

Method: 该方法提出使用机器学习技术构建一个预测函数，结合设计选择使其具有灵活性并易于集成到最先进的求解器中。论文重点研究了为 Energetic Reasoning 传播器构建预测器的可行性，通过实验评估不同分类特征的预测准确性。

Result: 实验表明，为 Energetic Reasoning 传播器构建预测器可以获得较高的预测准确率，研究还提供了关于分类特征选择的建议，并揭示了构建此类预测器时需要解决的重要问题。

Conclusion: 尽管实验结果提供了乐观的初步证据，表明构建用于 Energetic Reasoning 传播器的预测器是可行的，但作者也强调了在构建此类预测器时需要解决的重要问题，如特征选择、训练数据和预测模型的优化等，为未来研究指明了方向。
...
### [204] [Nonuniformity Principle in Human-AI Coworking](https://arxiv.org/abs/2607.16530)
*An Luo,Jie Ding*

Main category: cs.AI

TL;DR: 研究提出人机协同工作流中的非均匀性监督原则：最优监督阶段安排应具有非递减的时间间隔，可提高用户满意度同时减少不必要返工和计算资源消耗。


<details>
  <summary>Details</summary>
Motivation: 随着生成式AI广泛应用于复杂高风险工作流程，人工监督对确保AI输出质量至关重要。但由于人类时间和资源有限，人工监督与AI效率之间存在紧张关系。研究旨在为人机协同中的最优监督安排提供理论指导。

Method: 通过理论建模将监督阶段安排问题形式化，在合理假设下推导出非均匀性原则，并在写作文献综述和构建网站两个典型AI代理工作流程中进行实证验证。

Result: 理论推导表明最优监督安排遵循非均匀性原则，即监督阶段之间的间隔沿工作流程非递减排列。在两个实际AI工作流程中的实证验证支持了该原则的有效性。

Conclusion: 研究通过理论分析和实证验证，提出了在人机协同工作流程中安排监督阶段的非均匀性原则，为平衡AI效率与人工监督提供了可操作的指导原则。
...
### [205] [From Modalities to Propositions: A Language-Centric Framework for Multimodal Intelligence](https://arxiv.org/abs/2607.16560)
...
TL;DR: 提出了一种基于原子命题的多模态语言表示框架，将图像、视频和文本统一表示为原子命题集合，并通过全局语义代码本实现可解释的跨模态推理、理解和检索。


<details>
  <summary>Details</summary>
Motivation: 为了解决多模态数据（如图像、视频、文本）之间的语义鸿沟，实现跨模态的统一理解、解释性推理和复杂检索，需要一种能够将不同模态的数据映射到共享语义空间的表示方法。

Method: 将图像、视频或文本等观测数据表示为原子命题的集合，每个原子命题描述实体、动作和关系等场景元素。通过全局语义代码本将这些原子命题统一到一个共享的、可解释的语义空间，支持跨模态推理、理解、检索和合成。

Result: 在自动驾驶和开放世界数据集上的实验验证了该框架能够实现有效的跨模态理解、推理和检索，并支持复杂场景的构建和结构化检索。

Conclusion: 本文提出的统一语言表示框架通过原子命题的形式有效地实现了多模态数据的整合与理解，为复杂场景下的跨模态推理、检索和合成提供了有力的解决方案。
...
### [206] [Exact Network Surgery: Functional Invariance and Gradient Plasticity in Reactive Computational Graphs](https://arxiv.org/abs/2607.16568)
*Abdallah Khemais*

Main category: cs.AI

TL;DR: 本文提出了精确网络手术，一种在活计算图中原位插入残差块的方法，实现函数位精确保持，插入参数立即可训练，并通过理论证明和实验验证了其有效性。


<details>
  <summary>Details</summary>
Motivation: 现有的网络增长技术（如Net2Net和渐进堆叠）在扩展模型容量时，要么容忍数值扰动，要么需要重建整个训练程序，缺乏在活计算图中原位精确插入且保持函数不变的技术。

Method: 提出精确网络手术范式，包括：1) 门控残差块的身份同态定理；2) 结构局部性定理确保仅重新计算插入点的下游锥体；3) 使用梯度跟随门α从初始化逃逸。在Julia的NeuroDSL（反应式图引擎）中实现了参考实现。

Result: 在NeuroDSL中的实验验证表明：移植在1600个逻辑值上完全位精确（0个不匹配）；门在第一次优化器步骤中从零逃逸，第二次解锁分支梯度；退化配置中梯度始终为零；手术成本仅与下游锥体大小相关（r=0.9992）；移植物+失效簿记成本恒定（约0.75ms）；训练可在进程重启后位完全相同地恢复。

Conclusion: 论文提出了严格的精确网络手术范式，通过反应式计算图引擎NeuroDSL实现了在活的计算图中原位插入残差块，实现了函数保持、原位训练、无扰重启，并为残差块插入提供了理论依据和实验验证。
...
### [207] [FST.ai 2.5: Explainable and Uncertainty-Aware AI for Olympic and Para-Taekwondo Decision Support, Athlete Digital Twins, and Federation-Scale Analytics](https://arxiv.org/abs/2607.16597)
*Keivan Shariatmadar,Ahmad Osman,Ramin Rey*

Main category: cs.AI

TL;DR: 提出了FST·ai~2.5框架，这是一个用于奥运和残奥跆拳道的可解释、不确定性感知和安全的AI生态系统，整合了运动员智能、竞赛分析、数字孪生等多种功能，具有广泛适用性。


<details>
  <summary>Details</summary>
Motivation: 精英体育的快速数字化为整合人工智能、表现分析和决策支持系统创造了新机会，但现有解决方案仍处于碎片化状态，通常只解决孤立任务，如表现分析、运动员监控或裁判支持，缺乏统一的数字生态系统。

Method: FST·ai~2.5框架整合了多源竞争数据、运动员表现信息和上下文证据，通过可解释和不确定性感知的AI提供战术诊断、纵向运动员监控、表现预测、个性化发展计划和全联合会基准测试，并构建运动员和赛事的数字孪生模型。

Result: 原型部署证明了所提框架的可行性，该框架通过透明、安全和联合会感知的治理，支持世界跆拳道联合会、成员国家协会、教练、裁判、分析师和运动员，实现了战术诊断、运动员监控、表现预测等功能。

Conclusion: 尽管该框架专为奥运和残奥跆拳道开发，但其在可解释AI、数字孪生和可信决策支持方面的创新方法可广泛应用于格斗运动及其他高性能体育环境，具有广阔的推广前景。
...
### [208] [Just A Rather Very Intelligent Spoken Agent](https://arxiv.org/abs/2607.16610)
*Chen Chen,Zhehuai Chen*

Main category: cs.AI

TL;DR: 本文提出JarvisBench基准测试，用于评估长视野AI代理中介层的双重价值：改善任务完成情况和增强用户体验。初步实验表明Jarvis风格调解能提供基于执行轨迹的响应并在适当时注入用户指导时提升性能，但有效性高度依赖LLM技术。


<details>
  <summary>Details</summary>
Motivation: 当前长视野AI代理与用户的交互过于薄弱——用户仅提供初始指令，接收有限的文本更新，缺乏对代理行为的清晰了解以及适时介入的机会。这导致当前代理生态系统中缺少一个始终在线的Jarvis风格中介层，能够保持代理对用户的持续可访问性。

Method: 研究开发了JarvisBench基准测试，包含两个互补的评估轨道：1）代理协作轨道，测量调解是否能改善下游任务完成情况；2）用户交互轨道，测量调解是否使执行过程更易于理解、响应更快且更易于访问。研究者还在OpenClaw中实例化了一个模块化的Jarvis原型，对34个文本任务进行了评估。

Result: 初步实验使用GPT-5.5、Claude Opus 4.7、Gemini和GPT基础的工作代理显示：Jarvis风格的调解能够提供基于执行轨迹的用户问题回答，并在适当时机注入稀疏用户指导时改善任务性能。同时，结果也显示有效性强烈依赖于调解器的LLM大脑。

Conclusion: JarvisBench基准测试表明，AI代理中间件（如Jarvis风格的调解器）具有双重价值：既能提高任务执行效率，又能增强用户体验。然而，其有效性高度依赖于所采用的LLM技术，这凸显了构建强大中介层的技术挑战和社区协作需求。
...
### [209] [A Research Prototype for Closed-Loop Generative Design of Customized Foot Orthoses via Semantic-Physics Alignment](https://arxiv.org/abs/2607.16631)
...
### [210] [TopoTuner: Topological Finetuning of Large Language Models](https://arxiv.org/abs/2607.16637)
...
### [211] [Diversity-Oriented Fine-Tuning for Uncertainty-Based Hallucination Detection](https://arxiv.org/abs/2607.16643)
...
### [212] [DS@GT ARC at eRisk 2026: Hybrid Multi-Agent LLM System with Structured Algorithmic Guidance for Conversational Depression Screening](https://arxiv.org/abs/2607.16712)
...
### [213] [Tractable Query Answering under Epistemic Confidentiality Policies in DL Ontologies (extended version)](https://arxiv.org/abs/2607.16715)
...
### [214] [RECON: Benchmarking Agent Memory for Compositional Reasoning over Long Contexts](https://arxiv.org/abs/2607.16716)
...
### [215] [Constraint-Anchored Reasoning Traces](https://arxiv.org/abs/2607.16727)
...
### [216] [Supporting Autonomous Process Execution within a Multi-Perspective Constraint Frame via Numeric Planning](https://arxiv.org/abs/2607.16738)
...
### [217] [RELIC: Revealed Principles for Learning Interpretable Composable Skills in Multi-Agent Planning](https://arxiv.org/abs/2607.16745)
...
### [218] [FUSAR-R1: A Large-Scale Reasoning Model for Intelligent Interpretation of SAR Images](https://arxiv.org/abs/2607.16819)
...
### [219] [From Overload to Insights: How AI Agents Can Support Scientists in Analyzing Complex Data](https://arxiv.org/abs/2607.16845)
...
### [220] [AgentBrew: Lifelong Knowledge Brewing from Strong Teachers to Weak LLM Agents](https://arxiv.org/abs/2607.16851)
...
### [221] [Beyond Semantic Equivalence: Logical Graphs for LLM Uncertainty Quantification](https://arxiv.org/abs/2607.16868)
...
### [222] [Environment-free Synthetic Data Generation for API-Calling Agents](https://arxiv.org/abs/2607.16900)
...
### [223] [Lomekwi: Resource-Bounded Tool Discovery in LLM Agents](https://arxiv.org/abs/2607.16961)
...
### [224] [Training Continuous Chain of Thought Models: A Tale of Two Regimes](https://arxiv.org/abs/2607.16972)
...
### [225] [Expected Free Energy as Belief-Dependent Utility for rho-POMDPs](https://arxiv.org/abs/2607.16981)
...
### [226] [PriorProof: A Point-in-Time Measure of Technique Novelty for Formal Proofs](https://arxiv.org/abs/2607.16997)
*Neel Somani*
...
### [227] [Reward-Driven LLM Agent Workflows: Synthesizing POMDP Routing and Self-Correction for Autonomous Decision-Making](https://arxiv.org/abs/2607.17038)
...
### [228] [When LLMs Over-Answer: Measuring and Mitigating Quality Issues in LLM-Based Hardware Description Language Question Answering](https://arxiv.org/abs/2607.17063)
...
### [229] [Bridging the Information Gap: Semantic Densification and Hindsight Distillation for Cold-Start Prediction](https://arxiv.org/abs/2607.17070)
...
### [230] [Otap:Structure-Aware Optimal Transport for Evaluating Planning and Execution in Agent Trajectories](https://arxiv.org/abs/2607.17082)
...
### [231] [Fourier Geometric Wind Power Forecasting with Numerical Weather Prediction](https://arxiv.org/abs/2607.17095)
...
### [232] [Evidence Interfaces Shape How Retrieval-Augmented Readers Use Support](https://arxiv.org/abs/2607.17108)
...
### [233] [A Diagnostic Framework for AI Agent Behavior](https://arxiv.org/abs/2607.17149)
...
### [234] [Is Your Model Thinking or Just Stagnating? PUMA: Diagnosing Reasoning Pathology via Phase-Momentum Alignment](https://arxiv.org/abs/2607.17188)
...
### [235] [Toward Anthropomorphic Dialogue: A Closed-Loop Framework for Human-Like Chat Generation, Evaluation, and Preference Alignment](https://arxiv.org/abs/2607.17191)
...
### [236] [A Systematic Evaluation of Trajectory Data Curation for LoRA Fine-Tuning of Code Agents](https://arxiv.org/abs/2607.17205)
*Yunze Han*
...
### [237] [Constrained Path Reasoning: Measuring When Committed Stages Earn Their Cost](https://arxiv.org/abs/2607.17240)
*Honglin Li*
...
### [238] [LenGuard-GPC: Length Guarding with Guided-Prompt Consistency for Spatial Reasoning Reinforce Learning](https://arxiv.org/abs/2607.17243)
...
### [239] [Coordinated Disentanglement with Iterative Mode Discovery Under Hidden Correlations](https://arxiv.org/abs/2607.17264)
*Rong Hu,Ling Chen*
...
### [240] [An Explicit World Model Based on Data-First Ontology: DaoQL Multimodal Storage Validation and Counterfactual Reasoning Evaluation](https://arxiv.org/abs/2607.17269)
...
### [241] [Lossless but Not Free: An Empirical Anatomy of Speculative Decoding on Consumer Hardware](https://arxiv.org/abs/2607.17283)
*Param Chordiya*
...
### [242] [Learning-Driven Adaptive Audit Scheduling: A Sequential Decision Approach to Off-Chain Data Integrity](https://arxiv.org/abs/2607.17305)
...
### [243] [Agentic ERP: Multi-Agent Large Language Model Architecture for Autonomous Enterprise Resource Planning](https://arxiv.org/abs/2607.17331)
...
### [244] [DeeperRadar: End-to-End MIMO Radar Design and Multi-Modal Fusion for Autonomous Vehicle Perception](https://arxiv.org/abs/2607.17351)
...
### [245] [Self-Modifying Lean Proof Agents with Verifier-Grounded Benchmark Coevolution](https://arxiv.org/abs/2607.17352)
...
### [246] [Quantifying Diversity of Thought: A Predictive Law of Weighted LLM Ensemble Lift](https://arxiv.org/abs/2607.17384)
*Junade Ali*
...
### [247] [Intermittent Control Is Not Diluted Control: A Switching Effect in Artificial Agency](https://arxiv.org/abs/2607.17432)
*Veronique Ziegler*
...
### [248] [Empirical Grounding Improves the Realism of LLM Agents Simulating Human Behavior During Disruptions](https://arxiv.org/abs/2607.17437)
...
### [249] [AEC-DS: Adaptive Erasure Coding with PDP-Triggered Reputation and QoS-Aware Migration for Decentralized Storage](https://arxiv.org/abs/2607.17460)
...
### [251] [Pailitao-MMSearch: Building Native E-Commerce Multimodal Search Foundation](https://arxiv.org/abs/2607.17499)
...
### [252] [Can AI Agents Really Complete RTL-to-GDS? Lessons from Benchmarking Tool-Interactive EDA Workflows](https://arxiv.org/abs/2607.17528)
...
### [253] [The Curvature Shadow: An Apparent Failure of Maximum-Entropy Equilibrium Selection is a Removable Artifact](https://arxiv.org/abs/2607.17543)
*Luis Leal*
...
### [254] [Retain or Consolidate? Budget-Dependent Operator Selection for Language Agent Memory](https://arxiv.org/abs/2607.17545)
...
### [255] [Why Does Feedback-Augmented Self-Distillation Fail to Improve Retrieval-Interleaved Search Agents?](https://arxiv.org/abs/2607.17558)
...
### [256] [Reinforcement Learning: From Algorithms To Foundation Models](https://arxiv.org/abs/2607.17560)
*Zihan Ding*
...
### [257] [ZifaMem: Structured Memory for Persona, Preference, and Emotional Continuity in AI Companions](https://arxiv.org/abs/2607.17564)
...
### [258] [A Dual-Hypothesis Reasoning Framework for LLM Guardrails](https://arxiv.org/abs/2607.17575)
...
### [259] [Is Progressive Disclosure All You Need for Long-Context Agents?](https://arxiv.org/abs/2607.17598)
...
### [260] [Mechanistic Attention Guidance for Agent Memory Refinement](https://arxiv.org/abs/2607.17621)
...
### [261] [Verify, Repair, Repeat, or Stop? Robust Stopping for Noisy Verify-Repair Loops in LLM Agents](https://arxiv.org/abs/2607.17641)
...
### [262] [FlowBlock: Wavefront-Parallel Decoding for Self-Correcting Diffusion Language Models](https://arxiv.org/abs/2607.17652)
...
### [264] [Artificial Intelligence for Understanding and Managing Transportation Behavior in Sustainable Smart Cities](https://arxiv.org/abs/2607.17694)
...
### [265] [ProEvent: An Event-centric Benchmark for Proactive Agents](https://arxiv.org/abs/2607.17701)
...
### [266] [LaT: LLM-as-Trainer for Multi-Task Vehicle Routing Solvers](https://arxiv.org/abs/2607.17708)
...
### [267] [Learning to Detect Cross-Modal Negation: An Analysis of Latent Representations and an Attention-Based Solution](https://arxiv.org/abs/2607.17712)
...
### [268] [SR-Agent: An Experience-Driven Agentic Framework for Post-Ranking Strategies Refinement in E-Commerce Recommendation](https://arxiv.org/abs/2607.17719)
...
### [269] [Semantically Similar, Logically Distinct: Diagnosing the Semantic-Answerability Gap in Table RAG](https://arxiv.org/abs/2607.17742)
...
### [270] [WuYu-EnvLE-Bench: A Benchmark for Evaluating Large Language Models in Environmental Law Enforcement](https://arxiv.org/abs/2607.17745)
...
### [272] [Financial Audit Assistance using Misinformation Detection and Explanation](https://arxiv.org/abs/2607.17797)
...
### [273] [PGN: Design and Implementation of a Vision-Language Navigation System Based on Pangu Multimodal Foundation Model](https://arxiv.org/abs/2607.17806)
...
### [274] [A Hardware-oriented Approach for Efficient Bayesian Inference Computation and Deployment](https://arxiv.org/abs/2607.17855)
...
### [275] [Exploratory and Assimilating Reflection: Reflective Recall Cycle for Long-term Memory](https://arxiv.org/abs/2607.17879)
...
### [276] [ST-Veto: Spatio-Temporal Token Veto for Diffusion MLLMs via Taylor Prediction and Visual Grounding](https://arxiv.org/abs/2607.17884)
...
### [277] [Stress Testing Concept Erasure with Large Language Model Agents](https://arxiv.org/abs/2607.17890)
...
### [278] [PEARL: Auditable Repair for Scientific Reasoning Graph Extraction](https://arxiv.org/abs/2607.17917)
...
### [279] [The Autonomous Agency Scale: A Behavioral Framework for Measuring Self-Directed Behavior in AI Systems](https://arxiv.org/abs/2607.17947)
*Samuel Presgraves*
...
### [280] [Towards Agentic Agent-based Models: Feasibility, Performance, and Statistical Model Checking](https://arxiv.org/abs/2607.17948)
...
### [281] [OntoExtend: A Framework for Requirement-driven and Scalable Ontology Extension with LLMs](https://arxiv.org/abs/2607.17963)
...
### [282] [SAGE: Subgoal-Conditioned Action Generation for Latent World Model Planning](https://arxiv.org/abs/2607.17973)
...
### [283] [Do Maps Still Matter for Machines: Revisiting the Role of Choropleth Maps in Foundation Model Spatial Understanding](https://arxiv.org/abs/2607.17999)
...
### [284] [PAMD: Structured Adaptive Distances for Bisimulation Representations in Visual Reinforcement Learning](https://arxiv.org/abs/2607.18004)
...
### [285] [Rethinking Heterogeneous LLM Merging: A Weighted Model Averaging Perspective](https://arxiv.org/abs/2607.18026)
...
### [286] [AdaHome: An Adaptive Smart Home Assistant using Local Small Language Models](https://arxiv.org/abs/2607.18034)
...
### [287] [The Shared Discovery Paradox: How a One-Answer Rule Turns Better Information into Worse Search](https://arxiv.org/abs/2607.18045)
*Yohei Nakajima*
...
### [288] [WorldCupArena: Fine-Grained Evaluation of Language Models and Deep-Research Agents on Football Forecasting](https://arxiv.org/abs/2607.18084)
...
### [289] [Judge-dependent safety gains and model-specific helpfulness costs of evidence-sufficiency prompting in clinical LLMs](https://arxiv.org/abs/2607.18086)
*Koyar Afrasyab*
...
### [290] [Can We Break LLMs Out of Self-Loops? Fine-Grained Reasoning Control with Activation Steering](https://arxiv.org/abs/2607.18100)
...
### [291] [SGA: Plug&Play Geometric Verification for Educational Video Synthesis](https://arxiv.org/abs/2607.18116)
...
### [292] [Logical Judgments Under Pressure: Diagnosing Syllogistic Stability with Learned Soft Prefixes](https://arxiv.org/abs/2607.18228)
*Brian K Chen*
