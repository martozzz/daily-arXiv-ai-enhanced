...
TL;DR: A parameter-efficient alternative to Neural CDEs is proposed, reducing parameter count while maintaining effectiveness, likened to Continuous RNNs.


<details>
  <summary>Details</summary>
Motivation: The motivation stems from the drawbacks of Neural CDEs, particularly their high parameter requirements, prompting the search for a more efficient alternative.

Method: The method involves reimagining Neural CDEs as "Continuous RNNs," focusing on parameter efficiency without compromising the model's ability to analyze temporal sequences.

Result: The result is a parameter-efficient version of Neural CDEs that requires fewer parameters and draws a logical analogy to Continuous RNNs.

Conclusion: The paper concludes that the proposed parameter-efficient approach to Neural CDEs offers a viable alternative to traditional methods, reducing the number of parameters while maintaining effectiveness.
...
TL;DR: A multi-agent framework enables continual strategy evolution without fine-tuning, using dual-loop updates for latent vectors, showing convergence and adaptability in experiments.


<details>
  <summary>Details</summary>
Motivation: The aim is to liberate latent vectors of abstract concepts from traditional static semantic representations, allowing continuous updates through environmental interaction and reinforcement feedback.

Method: The paper introduces a multi-agent language framework with a dual-loop architecture: the behavior loop adjusts action preferences based on environmental rewards, while the language loop updates external latent vectors by reflecting on semantic embeddings of generated text.

Result: Experiments show agents' latent spaces exhibit clear convergence trajectories under reflection-driven updates, with structured shifts at critical moments. The system also demonstrates an emergent ability to implicitly infer and adapt to emotional agents without shared rewards.

Conclusion: The study demonstrates that an external latent space can provide language agents with a low-cost, scalable, and interpretable form of abstract strategic representation without modifying model parameters.
...
TL;DR: A zero-training analysis of transformer sentiment models on real social media data shows significant accuracy drops during events, with new drift metrics outperforming baselines for real-time monitoring.


<details>
  <summary>Details</summary>
Motivation: To analyze model instability and accuracy drops during event-driven periods, and to introduce novel drift metrics for robust detection capabilities.

Method: A comprehensive zero-training temporal drift analysis of transformer-based sentiment models, validated on authentic social media data from major real-world events, using systematic evaluation across three transformer architectures and rigorous statistical validation on 12,279 authentic social media posts.

Result: Demonstrated significant model instability with accuracy drops reaching 23.4% during event-driven periods, with maximum confidence drops of 13.0% (Bootstrap 95% CI: [9.1%, 16.5%]). Introduced four novel drift metrics that outperform embedding-based baselines while maintaining computational efficiency.
...
TL;DR: A framework using LLMs as knowledge curators (GKC) outperforms traditional methods in predicting lung cancer treatment outcomes, achieving higher accuracy by converting multimodal data into task-aligned features.


<details>
  <summary>Details</summary>
Motivation: Accurate prediction of treatment outcomes in lung cancer is challenging due to sparse, heterogeneous, and contextually overloaded electronic health data, with traditional models failing to capture semantic information across multimodal streams.

Method: The framework uses Large Language Models (LLMs) as Goal-oriented Knowledge Curators (GKC) to convert laboratory, genomic, and medication data into high-fidelity, task-aligned features, operating as an offline preprocessing step.

Result: GKC achieved a mean AUROC of 0.803 (95% CI: 0.799-0.807), outperforming expert-engineered features, direct text embeddings, and an end-to-end transformer, with an ablation study confirming the value of combining all three modalities.

Conclusion: The study demonstrates that reframing LLMs as knowledge curation engines provides a scalable, interpretable, and workflow-compatible pathway for advancing AI-driven decision support in oncology, with GKC outperforming traditional methods in predictive accuracy.
...
TL;DR: The paper addresses catastrophic forgetting in continual learning by quantifying alignment depth, detecting shallow alignment in real-time, and proposing mitigation strategies, showing improved robustness.


<details>
  <summary>Details</summary>
Motivation: The motivation stems from the challenge of catastrophic forgetting in continual learning, particularly the spurious forgetting caused by shallow task alignment.

Method: The paper introduces a framework with quantitative metrics, real-time detection methods, specialized analysis tools, and adaptive mitigation strategies to address shallow alignment issues.

Result: The results show 86.2-90.6% identification accuracy for shallow alignment and a 3.3-7.1% improvement in robustness against forgetting by promoting deep alignment.

Conclusion: The paper concludes that promoting deep alignment significantly improves robustness against catastrophic forgetting in continual learning for large language models, as demonstrated by extensive experiments.
...
TL;DR: SHRP, a structured pruning framework, reduces Transformer encoder redundancy by pruning attention heads, maintaining high accuracy while significantly cutting parameters and computation.


<details>
  <summary>Details</summary>
Motivation: Address the high inference latency and memory consumption of Transformer encoders by reducing architectural redundancy in the attention module.

Method: SHRP introduces Expert Attention and a lightweight shared expander feed-forward network, employing a Top-1 usage-driven mechanism for dynamic routing and deterministic pruning.

Result: Achieves 93% of original model accuracy with 48% parameter reduction, and under extreme compression, maintains 84% accuracy with 4.2x throughput gain.

Conclusion: SHRP demonstrates practical utility for large-scale, latency-sensitive web deployments by maintaining high accuracy while significantly reducing parameters and computation.
...
TL;DR: Gate-Norm prunes redundant attention layers in LLMs efficiently, boosting inference speed with minimal accuracy loss, validated across several benchmarks.


<details>
  <summary>Details</summary>
Motivation: The Attention Suppression Hypothesis suggests that some deep attention layers in LLMs learn to mute their own contribution during pre-training, making them redundant.

Method: Gate-Norm is a one-shot, weight-only criterion that ranks attention sublayers by query-key coupling and removes the least coupled ones, requiring no calibration data, forward passes, fine-tuning, or specialized kernels.

Result: Pruning 8-16 attention sublayers yields up to 1.30× higher inference throughput while maintaining average zero-shot accuracy within 2% of the unpruned baseline across multiple benchmarks.

Conclusion: Gate-Norm enables practical, data-free compression of LLMs by efficiently pruning attention sublayers without significant loss in accuracy, matching data-driven methods while being significantly faster.
...
TL;DR: Scientific ML models (Neural ODEs and UDEs) predict n body dynamics more efficiently, with UDEs needing only 20% of data vs. 90% for Neural ODEs, offering a practical solution for astrophysics.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of traditional ML models in astrophysics, which are data-intensive and lack interpretability by ignoring physical laws, this paper explores Scientific ML as a more efficient and interpretable alternative.

Method: The study employs Scientific ML frameworks, specifically Neural ODEs and UDEs, within the Julia programming language to model the n body problem, incorporating physical laws directly into the ML framework.

Result: The UDE model significantly outperforms the Neural ODE in data efficiency, needing only 20% of the data for accurate forecasting compared to the 90% required by Neural ODE.

Conclusion: The UDE model demonstrates superior data efficiency compared to Neural ODE, requiring only 20% of data for accurate forecasting, highlighting its potential for practical applications in astrophysics.
...
TL;DR: Q-RUN, a quantum-inspired classical model, emulates DRQC's advantages without quantum hardware, outperforming classical networks in efficiency and accuracy.


<details>
  <summary>Details</summary>
Motivation: The practical application of DRQC is limited by current quantum hardware scalability, prompting the development of a quantum-inspired classical model that maintains the benefits of quantum approaches.

Method: The paper introduces a quantum-inspired data re-uploading network (Q-RUN), which mathematically emulates the DRQC paradigm in classical models, retaining Fourier-expressive advantages without requiring quantum hardware.

Result: Q-RUN outperforms classical neural networks, reducing model parameters and error by one to three orders of magnitude in certain tasks, while enhancing performance across various neural architectures.

Conclusion: This work illustrates how principles from quantum machine learning can guide the design of more expressive artificial intelligence, with Q-RUN serving as a drop-in replacement for standard fully connected layers to improve neural architectures.
...
### [10] [MaskOpt: A Large-Scale Mask Optimization Dataset to Advance AI in Integrated Circuit Manufacturing](https://arxiv.org/abs/2512.20655)
*Yuting Hu,Lei Zhuang,Hua Xiang,Jinjun Xiong,Gi-Joon Nam*

Main category: cs.LG

TL;DR: MaskOpt is a real IC design dataset for deep learning in mask optimization, highlighting the need for context-aware and cell-aware inputs.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of existing datasets (synthetic layouts, lack of cell hierarchy, and context neglect) and improve deep learning applicability in practical mask optimization.

Method: The study presents MaskOpt, a dataset constructed from real IC designs at the 45nm node, including metal-layer and via-layer tiles with varying context window sizes. State-of-the-art deep learning models are evaluated to benchmark performance.

Result: Evaluation results show trade-offs across baseline models, with context size and input ablation studies confirming the significance of surrounding geometries and cell-aware inputs.

Conclusion: MaskOpt provides a large-scale, context-aware dataset for deep learning in IC mask optimization, demonstrating the importance of surrounding geometries and cell-aware inputs for accurate mask generation.
...
### [11] [Managing the Stochastic: Foundations of Learning in Neuro-Symbolic Systems for Software Engineering](https://arxiv.org/abs/2512.20660)
*Matthew Thompson*

Main category: cs.LG

TL;DR: Proposes a Dual-State Architecture to separate deterministic and stochastic processes in AI coding agents, improving reliability without scaling parameters.


<details>
  <summary>Details</summary>
Motivation: Current AI coding agents blur LLMs and agents, leading to stochastic failures. The paper aims to leverage software engineering practices to manage unpredictability.

Method: The paper proposes a Dual-State Architecture separating workflow state (deterministic control flow) from environment state (stochastic generation), using Atomic Action Pairs and Guard Functions.

Result: Task success rates improved by up to 66 percentage points at 1.2--2.1× baseline computational cost across 13 LLMs.

Conclusion: Architectural constraints can substitute for parameter scale in achieving reliable code generation, as demonstrated by the Dual-State Architecture.
...
### [12] [Dominating vs. Dominated: Generative Collapse in Diffusion Models](https://arxiv.org/abs/2512.20666)
*Hayeon Jeong,Jong-Seok Lee*

Main category: cs.LG

TL;DR: 研究发现文本到图像扩散模型在多概念生成中存在主导概念压制其他概念的现象（DvD失衡），通过实验和注意力机制分析揭示了数据多样性和架构设计的影响。


<details>
  <summary>Details</summary>
Motivation: 多概念提示生成时，一个概念标记常主导生成过程，抑制其他概念（DvD失衡），需系统分析其成因以改进模型。

Method: 引入DominanceBench，从数据和架构角度分析DvD失衡，通过实验验证训练数据多样性与跨注意力动态的影响，并进行头部消融研究。

Result: 训练数据实例多样性不足加剧概念间干扰，跨注意力机制中主导标记快速饱和注意力并逐步抑制其他标记，多头部注意力机制共同导致DvD行为。

Conclusion: 研究揭示了文本到图像扩散模型在多概念提示生成中的主导与受抑制现象（DvD失衡），通过DominanceBench和实验分析，发现训练数据实例多样性不足及跨注意力机制是主要原因，为更可靠和可控的图像生成提供了关键见解。
...
### [13] [Improving Cardiac Risk Prediction Using Data Generation Techniques](https://arxiv.org/abs/2512.20669)
*Alexandre Cabodevila,Pedro Gamallo-Fernandez,Juan C. Vidal,Manuel Lama*

Main category: cs.LG

TL;DR: A CVAE-based architecture synthesizes realistic clinical data to overcome database limitations, enhancing cardiac risk prediction models and reducing hazardous diagnostic needs.


<details>
  <summary>Details</summary>
Motivation: Address limitations of real-world medical databases, such as data scarcity, unsuitable records, and high prevalence of missing values, to enhance cardiac risk prediction models.

Method: The study employs a Conditional Variational Autoencoder (CVAE) to synthesize realistic clinical records that align with real-world observations.

Result: The architecture generates coherent and realistic synthetic data, improving classifier accuracy for cardiac risk detection and outperforming existing deep learning approaches.

Conclusion: The proposed CVAE-based architecture effectively generates realistic synthetic clinical data, improving cardiac risk prediction model performance and reducing reliance on hazardous diagnostic procedures.
...
### [14] [Disentangling Fact from Sentiment: A Dynamic Conflict-Consensus Framework for Multimodal Fake News Detection](https://arxiv.org/abs/2512.20670)
*Weilin Zhou,Zonghao Ying,Junjie Mu,Shengwei Tian,Quanchen Zou,Deyue Zhang,Dongdong Yang,Xiangzheng Zhang*

Main category: cs.LG

TL;DR: DCCF框架通过主动放大跨模态矛盾提升假新闻检测效果，实验显示其优于现有方法。


<details>
  <summary>Details</summary>
Motivation: 现有基于一致性的多模态假新闻检测方法误将关键跨模态差异视为噪声，导致过度平滑化，掩盖了伪造证据。

Method: 提出动态冲突-共识框架（DCCF），将输入解耦为独立的事实和情感空间，并采用物理启发的特征动态方法迭代极化表征，最后通过冲突-共识机制标准化局部差异。

Result: 在三个真实数据集上的实验表明，DCCF consistently outperforms state-of-the-art baselines，平均准确率提升3.52%。

Conclusion: DCCF通过主动放大跨模态矛盾而非抑制，显著提升了假新闻检测的准确性，实验证明其平均准确率提升3.52%。
...
### [15] [HyDRA: Hierarchical and Dynamic Rank Adaptation for Mobile Vision Language Model](https://arxiv.org/abs/2512.20674)
*Yuanhao Xi,Xiaohuan Bing,Ramin Yahyapour*

Main category: cs.LG

TL;DR: HyDRA框架通过分层和动态秩调度优化移动视觉语言模型，性能提升显著且高效。


<details>
  <summary>Details</summary>
Motivation: 解决移动视觉语言模型训练中的高计算需求问题，标准LoRA固定秩方法不足以处理多模态任务。

Method: HyDRA框架采用分层优化（粗粒度和细粒度）和动态调整策略，结合轻量级性能模型进行端到端自动优化。

Result: 在多个基准测试中，HyDRA性能优于基线，平均提升4.7%，且不增加可训练参数。

Conclusion: HyDRA框架通过分层和动态秩调度显著提升了移动视觉语言模型的性能，优于基线方法，并在某些任务中超越了全参数微调。
...
### [16] [Revisiting the Learning Objectives of Vision-Language Reward Models](https://arxiv.org/abs/2512.20675)
*Simon Roy,Samuel Barbeau,Giovanni Beltrame,Christian Desrosiers,Nicolas Thome*

Main category: cs.LG

TL;DR: A study comparing VLM-based reward models finds that a simple triplet loss outperforms complex methods, suggesting recent improvements are due to data and architecture differences, not learning objectives.


<details>
  <summary>Details</summary>
Motivation: To isolate the impact of the learning objective in contrastive vision language models (VLMs) used for learning generalizable reward functions, as meaningful comparison is difficult due to varying training data, architectures, and evaluation settings in recent work.

Method: The study evaluates recent VLM-based reward models under a unified framework, using identical backbones, finetuning data, and evaluation environments, specifically Meta-World tasks. Modeling accuracy is assessed by consistency with ground truth reward and correlation with expert progress.

Result: The findings show that a simple triplet loss achieves better performance than more complex state-of-the-art methods.

Conclusion: A simple triplet loss outperforms state-of-the-art methods, indicating that recent improvements in VLM-based reward models may largely stem from differences in data and architectures rather than learning objectives.
...
### [17] [PHOTON: Hierarchical Autoregressive Modeling for Lightspeed and Memory-Efficient Language Generation](https://arxiv.org/abs/2512.20687)
...
### [18] [FEM-Bench: A Structured Scientific Reasoning Benchmark for Evaluating Code-Generating LLMs](https://arxiv.org/abs/2512.20732)
...
### [19] [Stabilizing Multimodal Autoencoders: A Theoretical and Empirical Analysis of Fusion Strategies](https://arxiv.org/abs/2512.20749)
...
### [20] [Bridging Efficiency and Safety: Formal Verification of Neural Networks with Early Exits](https://arxiv.org/abs/2512.20755)
...
### [21] [Generalization of RLVR Using Causal Reasoning as a Testbed](https://arxiv.org/abs/2512.20760)
...
### [22] [TS-Arena Technical Report -- A Pre-registered Live Forecasting Platform](https://arxiv.org/abs/2512.20761)
...
### [23] [Subgroup Discovery with the Cox Model](https://arxiv.org/abs/2512.20762)
...
### [24] [Improving Matrix Exponential for Generative AI Flows: A Taylor-Based Approach Beyond Paterson--Stockmeyer](https://arxiv.org/abs/2512.20777)
...
### [25] [Symbolic regression for defect interactions in 2D materials](https://arxiv.org/abs/2512.20785)
...
### [26] [GraphFire-X: Physics-Informed Graph Attention Networks and Structural Gradient Boosting for Building-Scale Wildfire Preparedness at the Wildland-Urban Interface](https://arxiv.org/abs/2512.20813)
...
### [30] [Robustness Certificates for Neural Networks against Adversarial Attacks](https://arxiv.org/abs/2512.20865)
...
### [31] [From GNNs to Symbolic Surrogates via Kolmogorov-Arnold Networks for Delay Prediction](https://arxiv.org/abs/2512.20885)
...
### [32] [Time-Efficient Evaluation and Enhancement of Adversarial Robustness in Deep Neural Networks](https://arxiv.org/abs/2512.20893)
*Runqi Lin*
...
### [33] [DiEC: Diffusion Embedded Clustering](https://arxiv.org/abs/2512.20905)
*Haidong Hu*
...
### [34] [Towards a General Framework for Predicting and Explaining the Hardness of Graph-based Combinatorial Optimization Problems using Machine Learning and Association Rule Mining](https://arxiv.org/abs/2512.20915)
...
### [35] [RevFFN: Memory-Efficient Full-Parameter Fine-Tuning of Mixture-of-Experts LLMs with Reversible Blocks](https://arxiv.org/abs/2512.20920)
...
### [36] [Guardrailed Elasticity Pricing: A Churn-Aware Forecasting Playbook for Subscription Strategy](https://arxiv.org/abs/2512.20932)
*Deepit Sapru*
...
### [37] [A Multi-fidelity Double-Delta Wing Dataset and Empirical Scaling Laws for GNN-based Aerodynamic Field Surrogate](https://arxiv.org/abs/2512.20941)
...
### [38] [Solving Functional PDEs with Gaussian Processes and Applications to Functional Renormalization Group Equations](https://arxiv.org/abs/2512.20956)
...
### [39] [Can Agentic AI Match the Performance of Human Data Scientists?](https://arxiv.org/abs/2512.20959)
...
### [40] [Generalization of Diffusion Models Arises with a Balanced Representation Space](https://arxiv.org/abs/2512.20963)
...
### [41] [Generalised Linear Models in Deep Bayesian RL with Learnable Basis Functions](https://arxiv.org/abs/2512.20974)
...
### [42] [CoSeNet: A Novel Approach for Optimal Segmentation of Correlation Matrices](https://arxiv.org/abs/2512.21000)
...
### [43] [LLM Swiss Round: Aggregating Multi-Benchmark Performance via Competitive Swiss-System Dynamics](https://arxiv.org/abs/2512.21010)
...
### [44] [Understanding Scaling Laws in Deep Neural Networks via Feature Learning Dynamics](https://arxiv.org/abs/2512.21075)
...
### [45] [Shared Representation Learning for High-Dimensional Multi-Task Forecasting under Resource Contention in Cloud-Native Backends](https://arxiv.org/abs/2512.21102)
...
### [46] [A Mechanistic Analysis of Transformers for Dynamical Systems](https://arxiv.org/abs/2512.21113)
...
### [47] [STLDM: Spatio-Temporal Latent Diffusion Model for Precipitation Nowcasting](https://arxiv.org/abs/2512.21118)
...
### [48] [MODE: Multi-Objective Adaptive Coreset Selection](https://arxiv.org/abs/2512.21152)
...
### [49] [BALLAST: Bandit-Assisted Learning for Latency-Aware Stable Timeouts in Raft](https://arxiv.org/abs/2512.21165)
*Qizhi Wang*
...
### [50] [A Unified Framework for EEG Seizure Detection Using Universum-Integrated Generalized Eigenvalues Proximal Support Vector Machine](https://arxiv.org/abs/2512.21170)
...
### [51] [Analytic and Variational Stability of Deep Learning Systems](https://arxiv.org/abs/2512.21208)
*Ronald Katende*
...
### [52] [Improving the Convergence Rate of Ray Search Optimization for Query-Efficient Hard-Label Attacks](https://arxiv.org/abs/2512.21241)
...
### [53] [Model Merging via Multi-Teacher Knowledge Distillation](https://arxiv.org/abs/2512.21288)
...
### [54] [Transcriptome-Conditioned Personalized De Novo Drug Generation for AML Using Metaheuristic Assembly and Target-Driven Filtering](https://arxiv.org/abs/2512.21301)
...
### [55] [Learning to Solve PDEs on Neural Shape Representations](https://arxiv.org/abs/2512.21311)
...
### [56] [Does the Data Processing Inequality Reflect Practice? On the Utility of Low-Level Tasks](https://arxiv.org/abs/2512.21315)
...
### [57] [Measuring all the noises of LLM Evals](https://arxiv.org/abs/2512.21326)
*Sida Wang*
...
### [58] [BitRL-Light: 1-bit LLM Agents with Deep Reinforcement Learning for Energy-Efficient Smart Home Lighting Optimization](https://arxiv.org/abs/2512.20623)
*Ravi Gupta,Shabista Haider*

Main category: cs.AI

TL;DR: BitRL-Light uses 1-bit quantized LLMs and DQN for efficient, real-time smart lighting control, achieving significant energy savings and high user satisfaction on edge devices.
...
Method: BitRL-Light combines 1-bit quantized Large Language Models (LLMs) with Deep Q-Network (DQN) reinforcement learning for real-time smart home lighting control on edge devices.

Result: Experimental results demonstrate 32% energy savings compared to rule-based systems, with inference latency under 200ms on Raspberry Pi 4 and 95% user satisfaction.

Conclusion: This work establishes a practical framework for deploying adaptive AI on resource-constrained IoT devices, enabling intelligent home automation without cloud dependencies.
...
### [59] [Quantum-Inspired Multi Agent Reinforcement Learning for Exploration Exploitation Optimization in UAV-Assisted 6G Network Deployment](https://arxiv.org/abs/2512.20624)
*Mazyar Taghavi,Javad Vahidi*

Main category: cs.AI

TL;DR: A quantum-inspired MARL framework for UAV-assisted 6G networks improves exploration-exploitation balance, coverage, and efficiency, outperforming classical methods.


<details>
  <summary>Details</summary>
Motivation: To optimize the exploration-exploitation tradeoff in multiagent reinforcement learning for UAV-assisted 6G network deployment under partial observability and dynamic conditions.

Method: Integrates classical MARL algorithms with quantum-inspired optimization techniques, using VQCs and QAOA, complemented by Bayesian inference and Gaussian processes for probabilistic modeling. Adopts a CTDE paradigm with shared memory and local view grids.

Result: Improves sample efficiency, accelerates convergence, enhances coverage performance, and maintains robustness, outperforming PPO and DDPG baselines.

Conclusion: The proposed quantum-inspired MARL framework demonstrates superior performance in balancing exploration and exploitation, enhancing signal coverage and network expansion efficiency in UAV-assisted 6G networks.
...
### [60] [MegaRAG: Multimodal Knowledge Graph-Based Retrieval Augmented Generation](https://arxiv.org/abs/2512.20626)
*Chi-Hsiang Hsiao,Yi-Cheng Wang,Tzung-Sheng Lin,Yi-Ren Yeh,Chu-Song Chen*

Main category: cs.AI

TL;DR: A multimodal knowledge graph-based RAG method improves content understanding by incorporating visual cues, showing superior performance in QA tasks.


<details>
  <summary>Details</summary>
Motivation: Existing KG-based RAG solutions are limited to text-only inputs and lack the ability to leverage multimodal insights, hindering deep reasoning over complex content.

Method: The method integrates visual cues into knowledge graph construction, retrieval, and answer generation, enabling cross-modal reasoning.

Result: Experimental results demonstrate consistent outperformance over existing RAG-based approaches in global and fine-grained question answering tasks.

Conclusion: The proposed multimodal knowledge graph-based RAG approach effectively enhances content understanding by integrating visual cues, outperforming existing RAG methods in both textual and multimodal tasks.
...
### [61] [Proceedings of the 20th International Conference on Knowledge, Information and Creativity Support Systems (KICSS 2025)](https://arxiv.org/abs/2512.20628)
...
TL;DR: KICSS 2025 proceedings feature peer-reviewed research on AI and related fields, with selected papers recommended for further publication.


<details>
  <summary>Details</summary>
Motivation: To provide a multidisciplinary forum for researchers to share and discuss innovations in AI, knowledge engineering, HCI, and creativity support systems.

Method: Peer-reviewed papers were accepted through a double-blind review process.

Result: The conference successfully compiled peer-reviewed papers, with some recommended for additional publication in IEICE Transactions on Information and Systems.

Conclusion: The proceedings of KICSS 2025 highlight advancements in AI, knowledge engineering, HCI, and creativity support systems, with selected papers recommended for further publication.
...
### [62] [MicroProbe: Efficient Reliability Assessment for Foundation Models with Minimal Data](https://arxiv.org/abs/2512.20630)
*Aayam Bansal,Ishaan Gangwani*

Main category: cs.AI

TL;DR: microprobe is a novel method for efficient reliability assessment using 100 strategically selected probe examples, reducing costs by 90% while maintaining 95% coverage.


<details>
  <summary>Details</summary>
Motivation: Foundation model reliability assessment typically requires thousands of evaluation examples, making it computationally expensive and time-consuming for real-world deployment.

Method: Combines strategic prompt diversity across five key reliability dimensions with advanced uncertainty quantification and adaptive weighting.

Result: Achieves 23.5% higher composite reliability scores compared to random sampling baselines, with exceptional statistical significance (p < 0.001, Cohen's d = 1.21). Expert validation rates the approach 4.14/5.0.

Conclusion: microprobe addresses a critical gap in efficient model evaluation for responsible AI deployment by significantly reducing assessment cost while maintaining high reliability coverage.
...
### [63] [Erkang-Diagnosis-1.1 Technical Report](https://arxiv.org/abs/2512.20632)
*Jianbing Ma,Ao Feng,Zhenjie Gao,Xinyu Song,Li Su,Bin Chen,Wei Wang,Jiamin Wu*

Main category: cs.AI

TL;DR: Erkang-Diagnosis-1.1是基于Qwen-3的AI健康顾问，整合大量医学知识，在医学考试中超越GPT-4，旨在成为用户的智能健康伴侣。


<details>
  <summary>Details</summary>
Motivation: 开发一个安全、可靠且专业的AI健康顾问，提升初级医疗和健康管理。

Method: 结合增强预训练和检索增强生成的混合方法，整合约500GB高质量结构化医学知识。

Result: 通过3-5轮高效交互，能准确理解用户症状并提供初步诊断建议和健康指导。

Conclusion: Erkang-Diagnosis-1.1模型在综合医学考试中表现优于GPT-4，验证了其作为智能健康伴侣的有效性。
...
### [64] [Reasoning Relay: Evaluating Stability and Interchangeability of Large Language Models in Mathematical Reasoning](https://arxiv.org/abs/2512.20647)
*Leo Lu,Jonathan Zhang,Sean Chua,Spencer Kim,Kevin Zhu,Sean O'Brien,Vasu Sharma*

Main category: cs.AI

TL;DR: The paper explores if reasoning chains from one model can be continued by another, finding that hybrid chains often maintain or enhance accuracy and coherence, suggesting interchangeability as a viable property for collaborative AI.


<details>
  <summary>Details</summary>
Motivation: To explore whether partially completed reasoning chains from one model can be reliably continued by another, assessing the interchangeability of reasoning across different models as a means of examining inference-time trustworthiness.

Method: The study uses token-level log-probability thresholds to truncate reasoning at different stages from baseline models (Gemma-3-4B-IT and LLaMA-3.1-70B-Instruct) and conducts continuation experiments with other models (Gemma-3-1B-IT and LLaMA-3.1-8B-Instruct) to test intra-family and cross-family behaviors. A Process Reward Model (PRM) is used for evaluation.

Result: Hybrid reasoning chains often preserve or even improve final accuracy and logical structure, indicating that reasoning interchangeability is feasible.

Conclusion: The findings suggest that reasoning interchangeability is an emerging property of models, enabling new paradigms for reliable modular reasoning in collaborative AI systems.
...
### [65] [Mixture of Attention Schemes (MoAS): Learning to Route Between MHA, GQA, and MQA](https://arxiv.org/abs/2512.20650)
*Esmail Gumaan*

Main category: cs.AI

TL;DR: MoAS dynamically selects attention mechanisms per token via a learned router, balancing performance and efficiency, outperforming static methods.


<details>
  <summary>Details</summary>
Motivation: Addresses the trade-off between model quality and inference efficiency in Transformer models by optimizing attention mechanism selection.

Method: Introduces a learned router to dynamically choose between Multi-Head Attention (MHA), Grouped-Query Attention (GQA), or Multi-Query Attention (MQA) for each token.

Result: Dynamic routing (val loss 2.3074) outperforms static averaging (2.3093) on WikiText-2, achieving competitive performance with MHA while enhancing efficiency.

Conclusion: The proposed Mixture of Attention Schemes (MoAS) dynamically selects the optimal attention mechanism per token, balancing performance and efficiency, outperforming static approaches.
...
### [66] [Memory Bear AI A Breakthrough from Memory to Cognition Toward Artificial General Intelligence](https://arxiv.org/abs/2512.20651)
*Deliang Wen,Ke Sun*

Main category: cs.AI

TL;DR: Memory Bear enhances LLM memory with cognitive science principles, outperforming existing solutions in key metrics.


<details>
  <summary>Details</summary>
Motivation: Addressing LLM limitations like restricted context windows, knowledge forgetting, redundant information, and hallucinations to enhance sustained dialogue and personalized services.

Method: The paper proposes Memory Bear, a system integrating multimodal information perception, dynamic memory maintenance, and adaptive cognitive services to reconstruct LLM memory mechanisms.

Result: Memory Bear outperforms existing solutions (e.g., Mem0, MemGPT, Graphiti) in accuracy, token efficiency, and response latency, improving knowledge fidelity and reducing hallucinations.

Conclusion: Memory Bear represents a significant advancement in LLM memory mechanisms, transitioning AI from mere 'memory' to 'cognition' with improved performance across key metrics.
...
### [67] [AI-Driven Decision-Making System for Hiring Process](https://arxiv.org/abs/2512.20652)
*Vira Filatova,Andrii Zelenchuk,Dmytro Filatov*

Main category: cs.AI

TL;DR: An AI hiring assistant improves efficiency, reducing time and cost per qualified candidate while keeping human oversight.


<details>
  <summary>Details</summary>
Motivation: Early-stage candidate validation is a bottleneck due to heterogeneous inputs, necessitating an automated solution to streamline the process.

Method: The system integrates document and video preprocessing, structured profile construction, public-data verification, technical/culture-fit scoring with risk penalties, and human-in-the-loop validation, orchestrated by an LLM under strict constraints.

Result: The system achieved 1.70 hours per qualified candidate versus 3.33 hours for an experienced recruiter, with lower screening costs.

Conclusion: The AI-driven hiring assistant improves hiring efficiency, reducing time per qualified candidate and lowering screening costs while maintaining human oversight.
...
### [68] [From Fake Focus to Real Precision: Confusion-Driven Adversarial Attention Learning in Transformers](https://arxiv.org/abs/2512.20661)
*Yawei Liu*

Main category: cs.AI

TL;DR: AFA mechanism improves sentiment analysis by optimizing attention distributions via adversarial training and policy gradients, achieving top results.


<details>
  <summary>Details</summary>
Motivation: Existing Transformer-based models often focus on common words, neglecting less popular but task-relevant terms, leading to suboptimal accuracy.

Method: Adversarial Feedback for Attention (AFA) training mechanism with dynamic masking and policy gradient optimization.

Result: State-of-the-art results on three public datasets, with a 12.6% performance improvement in large language models.

Conclusion: The proposed AFA training mechanism significantly improves sentiment analysis performance by optimizing attention distributions, achieving state-of-the-art results and further enhancing large language models.
...
### [69] [Quantifying Laziness, Decoding Suboptimality, and Context Degradation in Large Language Models](https://arxiv.org/abs/2512.20662)
*Yiqing Ma,Jung-Hua Liu*

Main category: cs.AI

TL;DR: The paper finds LLMs struggle with laziness in complex tasks but show robustness in context retention, suggesting strategies to improve instruction compliance.


<details>
  <summary>Details</summary>
Motivation: The study aims to quantify and understand behavioral artifacts in LLMs, such as laziness, decoding suboptimality, and context degradation, to improve their reliability and instruction-following capabilities.

Method: Three controlled experiments (A, B, and C) were conducted to quantify behavioral artifacts (laziness, decoding suboptimality, context degradation) across advanced LLMs like OpenAI GPT-4 and DeepSeek.

Result: Results show widespread laziness in complex multi-part instructions, limited decoding suboptimality in simple reasoning tasks, and surprising robustness against context degradation in long conversations.

Conclusion: The study concludes that while modern LLMs face challenges in compliance with detailed instructions, they show unexpected robustness against context degradation. Strategies like self-refinement and dynamic prompting are recommended to improve instruction compliance.
...
### [70] [Eidoku: A Neuro-Symbolic Verification Gate for LLM Reasoning via Structural Constraint Satisfaction](https://arxiv.org/abs/2512.20664)
*Shinobu Miya*
...
### [71] [Bridging the AI Trustworthiness Gap between Functions and Norms](https://arxiv.org/abs/2512.20671)
...
### [72] [From Pilots to Practices: A Scoping Review of GenAI-Enabled Personalization in Computer Science Education](https://arxiv.org/abs/2512.20714)
...
### [73] [From artificial to organic: Rethinking the roots of intelligence for digital health](https://arxiv.org/abs/2512.20723)
...
### [74] [AgentMath: Empowering Mathematical Reasoning for Large Language Models via Tool-Augmented Agent](https://arxiv.org/abs/2512.20745)
...
### [75] [A Benchmark for Evaluating Outcome-Driven Constraint Violations in Autonomous AI Agents](https://arxiv.org/abs/2512.20798)
...
### [76] [Safety Alignment of LMs via Non-cooperative Games](https://arxiv.org/abs/2512.20806)
...
### [77] [Context-Sensitive Abstractions for Reinforcement Learning with Parameterized Actions](https://arxiv.org/abs/2512.20831)
...
### [78] [MAR:Multi-Agent Reflexion Improves Reasoning Abilities in LLMs](https://arxiv.org/abs/2512.20845)
...
### [79] [The Silent Scholar Problem: A Probabilistic Framework for Breaking Epistemic Asymmetry in LLM Agents](https://arxiv.org/abs/2512.20884)
...
### [80] [A Blockchain-Monitored Agentic AI Architecture for Trusted Perception-Reasoning-Action Pipelines](https://arxiv.org/abs/2512.20985)
...
### [81] [FinAgent: An Agentic AI Framework Integrating Personal Finance and Nutrition Planning](https://arxiv.org/abs/2512.20991)
...
### [82] [TrafficSimAgent: A Hierarchical Agent Framework for Autonomous Traffic Simulation with MCP Control](https://arxiv.org/abs/2512.20996)
...
### [83] [Agentic Explainable Artificial Intelligence (Agentic XAI) Approach To Explore Better Explanation](https://arxiv.org/abs/2512.21066)
...
### [84] [LLM Personas as a Substitute for Field Experiments in Method Benchmarking](https://arxiv.org/abs/2512.21080)
*Enoch Hyunwook Kang*
...
### [85] [Beyond Context: Large Language Models Failure to Grasp Users Intent](https://arxiv.org/abs/2512.21110)
...
### [86] [A Real-World Evaluation of LLM Medication Safety Reviews in NHS Primary Care](https://arxiv.org/abs/2512.21127)
...
### [87] [RoboSafe: Safeguarding Embodied Agents via Executable Safety Logic](https://arxiv.org/abs/2512.21220)
