...
TL;DR: 本文系统地探讨了将大语言模型和多模态模型整合到自动驾驶系统中的挑战和机遇，提出了认知层次框架来分析驾驶任务的推理复杂性，并识别了未来研究的关键方向。


<details>
  <summary>Details</summary>
Motivation: 自动驾驶技术发展面临从感知瓶颈转向推理瓶颈的挑战，现有系统在长尾场景和复杂社交互动中表现不足，而大语言和多模态模型为集成认知推理提供了新机遇。

Method: 提出认知层次框架来分解驾驶任务的认知和交互复杂性，系统化识别七个核心推理挑战，并从系统架构和评估两个角度综述最新研究进展。

Result: 研究发现当前技术正向整体可解释的"玻璃盒"智能体演进，但也揭示了LLM推理的高延迟性与毫秒级车辆控制需求之间的根本矛盾。

Conclusion: 未来研究需要解决符号到物理的鸿沟，开发可验证的神经符号架构、不确定性下的鲁棒推理以及可扩展的隐式社交协商模型。
...
TL;DR: 研究发现现有的LLM遗忘方法存在脆弱性，易被多跳查询绕过遗忘。提出动态评估框架，通过复杂结构化查询测试遗忘鲁棒性，能更好地检测遗忘失败案例，特别是在多跳推理场景中。


<details>
  <summary>Details</summary>
Motivation: 当前大语言模型的遗忘方法旨在提高模型安全性、减少偏见并满足法律要求，但这些方法存在脆弱性，容易通过多跳推理和实体别名等查询修改方式恢复被遗忘的信息。现有的静态评估基准往往产生效果幻觉，无法检测这些漏洞。

Method: 该研究提出了一种动态评估框架，通过构建从简单查询到多跳链式查询的针对性探针来测试遗忘方法的鲁棒性。该方法首先从目标模型（遗忘前）提取知识，利用LLM生成语义等效的问答对，实现了对查询难度的精确控制。

Result: 实验结果表明，该框架生成的探针在覆盖范围上与现有基准相当，且能复现已有的评估结果，更重要的是能够发现被其他基准遗漏的遗忘失败案例，特别是多跳推理场景。激活分析显示，单跳查询遵循主要计算通路，更易受到遗忘操作的影响，而多跳查询倾向于使用替代通路，这些通路在遗忘后仍然完整。

Conclusion: 该研究发现，当前的大语言模型遗忘方法在复杂结构化查询测试中表现出脆弱性，特别是多跳推理会利用替代计算通路来绕过遗忘机制。通过提出动态评估框架，能够更全面地检测遗忘方法的漏洞，为实际应用中的遗忘技术评估提供了更可靠的工具。
...
### [9] [RewardHackingAgents: Benchmarking Evaluation Integrity for LLM ML-Engineering Agents](https://arxiv.org/abs/2603.11337)
...
### [16] [Entropy Guided Diversification and Preference Elicitation in Agentic Recommendation Systems](https://arxiv.org/abs/2603.11399)
...
### [17] [Speak or Stay Silent: Context-Aware Turn-Taking in Multi-Party Dialogue](https://arxiv.org/abs/2603.11409)
...
### [18] [Adversarial Reinforcement Learning for Detecting False Data Injection Attacks in Vehicular Routing](https://arxiv.org/abs/2603.11433)
...
### [21] [Examining Users' Behavioural Intention to Use OpenClaw Through the Cognition--Affect--Conation Framework](https://arxiv.org/abs/2603.11455)
*Yiran Du*
...
### [22] [Multi-Agent Collaboration for Automated Design Exploration on High Performance Computing Systems](https://arxiv.org/abs/2603.11515)
...
### [23] [Expert Threshold Routing for Autoregressive Language Modeling with Dynamic Computation Allocation and Load Balancing](https://arxiv.org/abs/2603.11535)
...
### [24] [AI Knows What's Wrong But Cannot Fix It: Helicoid Dynamics in Frontier LLMs Under High-Stakes Decisions](https://arxiv.org/abs/2603.11559)
*Alejandro R Jadad*
...
### [25] [Leveraging Large Language Models and Survival Analysis for Early Prediction of Chemotherapy Outcomes](https://arxiv.org/abs/2603.11594)
...
### [26] [See, Symbolize, Act: Grounding VLMs with Spatial Representations for Better Gameplay](https://arxiv.org/abs/2603.11601)
...
### [27] [The Density of Cross-Persistence Diagrams and Its Applications](https://arxiv.org/abs/2603.11623)
...
### [28] [VisDoT : Enhancing Visual Reasoning through Human-Like Interpretation Grounding and Decomposition of Thought](https://arxiv.org/abs/2603.11631)
...
### [29] [LLMs can construct powerful representations and streamline sample-efficient supervised learning](https://arxiv.org/abs/2603.11679)
...
### [30] [Explicit Logic Channel for Validation and Enhancement of MLLMs on Zero-Shot Tasks](https://arxiv.org/abs/2603.11689)
...
### [31] [When OpenClaw Meets Hospital: Toward an Agentic Operating System for Dynamic Clinical Workflows](https://arxiv.org/abs/2603.11721)
...
### [32] [Gender Bias in Generative AI-assisted Recruitment Processes](https://arxiv.org/abs/2603.11736)
...
### [37] [An Automatic Text Classification Method Based on Hierarchical Taxonomies, Neural Networks and Document Embedding: The NETHIC Tool](https://arxiv.org/abs/2603.11770)
...
### [38] [From Debate to Deliberation: Structured Collective Reasoning with Typed Epistemic Acts](https://arxiv.org/abs/2603.11781)
*Sunil Prakash*
...
### [39] [DocSage: An Information Structuring Agent for Multi-Doc Multi-Entity Question Answering](https://arxiv.org/abs/2603.11798)
...
### [40] [A Semi-Decentralized Approach to Multiagent Control](https://arxiv.org/abs/2603.11802)
...
### [41] [Automating Skill Acquisition through Large-Scale Mining of Open-Source Agentic Repositories: A Framework for Multi-Agent Procedural Knowledge Extraction](https://arxiv.org/abs/2603.11808)
...
### [42] [VisiFold: Long-Term Traffic Forecasting via Temporal Folding Graph and Node Visibility](https://arxiv.org/abs/2603.11816)
...
### [43] [Automated Detection of Malignant Lesions in the Ovary Using Deep Learning Models and XAI](https://arxiv.org/abs/2603.11818)
...
### [44] [CreativeBench: Benchmarking and Enhancing Machine Creativity via Self-Evolving Challenges](https://arxiv.org/abs/2603.11863)
...
### [45] [Social, Legal, Ethical, Empathetic and Cultural Norm Operationalisation for AI Agents](https://arxiv.org/abs/2603.11864)
...
### [46] [AdaFuse: Accelerating Dynamic Adapter Inference via Token-Level Pre-Gating and Fused Kernel Optimization](https://arxiv.org/abs/2603.11873)
...
### [47] [Fair Learning for Bias Mitigation and Quality Optimization in Paper Recommendation](https://arxiv.org/abs/2603.11936)
...
### [48] [Prototype-Based Knowledge Guidance for Fine-Grained Structured Radiology Reporting](https://arxiv.org/abs/2603.11938)
...
### [49] [Learning Transferable Sensor Models via Language-Informed Pretraining](https://arxiv.org/abs/2603.11950)
...
### [50] [Normative Common Ground Replication (NormCoRe): Replication-by-Translation for Studying Norms in Multi-agent AI](https://arxiv.org/abs/2603.11974)
...
### [51] [LABSHIELD: A Multimodal Benchmark for Safety-Critical Reasoning and Planning in Scientific Laboratories](https://arxiv.org/abs/2603.11987)
...
### [52] [Few-for-Many Personalized Federated Learning](https://arxiv.org/abs/2603.11992)
...
### [53] [Can RL Improve Generalization of LLM Agents? An Empirical Study](https://arxiv.org/abs/2603.12011)
...
### [54] [XSkill: Continual Learning from Experience and Skills in Multimodal Agents](https://arxiv.org/abs/2603.12056)
...
### [55] [A Robust and Efficient Multi-Agent Reinforcement Learning Framework for Traffic Signal Control](https://arxiv.org/abs/2603.12096)
...
### [56] [Increasing intelligence in AI agents can worsen collective outcomes](https://arxiv.org/abs/2603.12129)
*Neil F. Johnson*
...
### [58] [Compiling Temporal Numeric Planning into Discrete PDDL+: Extended Version](https://arxiv.org/abs/2603.12188)
...
### [59] [Portfolio of Solving Strategies in CEGAR-based Object Packing and Scheduling for Sequential 3D Printing](https://arxiv.org/abs/2603.12224)
*Pavel Surynek*
...
### [61] [Comparison of Outlier Detection Algorithms on String Data](https://arxiv.org/abs/2603.11049)
*Philip Maus*

Main category: cs.LG

TL;DR: 该论文比较了两种字符串异常值检测算法：一种基于改进的局部离群因子算法，另一种基于分层左正则表达式学习的新方法。实验表明两种方法都能有效发现字符串数据中的异常值，但各有适用场景。


<details>
  <summary>Details</summary>
Motivation: 现有的异常值检测研究主要集中在数值数据上，对字符串数据异常值检测的研究相对匮乏。开发健壮的字符串异常值检测算法有助于数据清洗和系统日志文件中的异常检测。

Method: 1. 提出局部离群因子算法的变体，使用Levenshtein距离计算数据集密度，并引入考虑分层字符类别的加权Levenshtein度量。2. 提出基于分层左正则表达式学习的新算法，通过推导正则表达式来描述预期数据模式。

Result: 实验结果表明，两种算法都能在概念上发现字符串数据中的异常值。基于正则表达式的算法特别擅长在预期值具有明显结构且与异常值结构差异较大的情况下检测异常。而局部离群因子算法在异常值与预期数据之间的编辑距离显著时表现最佳。

Conclusion: 字符串异常值检测需要根据数据特性选择合适的算法：当数据具有明确结构模式时，正则表达式方法效果更好；当异常主要表现为编辑距离差异时，改进的局部离群因子算法更为合适。
...
### [62] [Fingerprinting Concepts in Data Streams with Supervised and Unsupervised Meta-Information](https://arxiv.org/abs/2603.11094)
*Ben Halstead,Yun Sing Koh,Patricia Riddle,Mykola Pechenizkiy,Albert Bifet,Russel Pears*

Main category: cs.LG

TL;DR: FiCSUM：一种使用包含多种元信息特征的概念指纹来表示概念行为的新框架，通过动态加权策略有效检测概念漂移，优于现有方法。


<details>
  <summary>Details</summary>
Motivation: 当前概念漂移检测方法存在以下问题：1）现有概念表示依赖少量元信息特征；2）这些表示往往无法有效区分不同概念；3）系统容易因概念表示能力不足而受到概念漂移影响。

Method: 提出FiCSUM框架，包括：1）构建概念指纹作为包含多种元信息特征的向量；2）采用动态加权策略学习哪些元信息特征对特定数据集的概念漂移描述更有效；3）支持监督和无监督学习场景；4）通过测试概念指纹与观察窗口的相似性来检测概念漂移。

Result: FiCSUM在11个真实世界和合成数据集上，在准确性和建模底层概念漂移方面均优于现有最先进方法。

Conclusion: FiCSUM提供了一个通用的、有效的概念表示框架，通过多特征融合和动态加权策略，显著提升了概念漂移检测的准确性，并能更好建模底层的概念漂移。
...
### [63] [Graph Tokenization for Bridging Graphs and Transformers](https://arxiv.org/abs/2603.11099)
...
### [64] [Task-Conditioned Routing Signatures in Sparse Mixture-of-Experts Transformers](https://arxiv.org/abs/2603.11114)
...
### [65] [Learning Tree-Based Models with Gradient Descent](https://arxiv.org/abs/2603.11117)
*Sascha Marton*

Main category: cs.LG

TL;DR: 提出基于梯度下降训练硬轴对齐决策树的新方法，使用带直通算子的反向传播联合优化所有参数，突破传统贪心算法局限，实现与深度学习框架的无缝集成，在多个领域取得SOTA结果。


<details>
  <summary>Details</summary>
Motivation: 传统决策树学习方法（如CART）存在两个主要局限：1）基于贪心搜索程序，只能在每个节点做出局部最优决策，限制了搜索空间并常导致次优树结构；2）需要定制训练方法，无法无缝集成到现代机器学习方法中。

Method: 提出了一种新颖的基于梯度下降的硬、轴对齐决策树学习方法，利用带有直通算子的反向传播技术在密集决策树表示上进行优化，实现所有树参数的联合优化。

Result: 在多个领域取得了state-of-the-art结果，包括小规模表格数据集的解释性决策树、复杂表格数据的高级模型、多模态学习以及无信息损失的解释性强化学习。

Conclusion: 该研究成功开发了一种基于梯度下降的硬、轴对齐决策树学习方法，通过反向传播和直通算子实现了所有树参数的联合优化，显著提升了决策树的性能和适用性，为树模型与深度学习的融合提供了新思路。
...
### [66] [Group Resonance Network: Learnable Prototypes and Multi-Subject Resonance for EEG Emotion Recognition](https://arxiv.org/abs/2603.11119)
*Renwei Meng*

Main category: cs.LG

TL;DR: 提出GRN模型，通过结合个体EEG动力学和离线的群体共振建模，提升跨被试EEG情绪识别的性能。


<details>
  <summary>Details</summary>
Motivation: 解决跨被试EEG情绪识别中的挑战，现有方法主要学习被试不变特征，但未能充分利用不同被试之间由刺激引发的群体规律和共振模式。

Method: GRN由三个组件组成：1) 个体编码器提取脑电的频带特征；2) 通过学习一组群体原型实现原型诱导共振；3) 基于PLV/相干性的多被试共振分支，通过一个小型参考集编码被试间的同步性。最后通过一个共振感知融合模块结合个体和群体层面的表示进行分类。

Result: 在SEED和DEAP数据集上的实验表明，GRN在依赖被试和留一被试交叉验证协议下均优于现有基线方法，消融实验也证实了原型学习和多被试共振建模的互补优势。

Conclusion: GRN在跨被试EEG情绪识别任务中表现出色，通过个体编码、原型学习和多被试共振的有效整合，证明了利用跨被试共享的群体规律对提升模型泛化能力的重要性。
...
### [67] [Beyond Barren Plateaus: A Scalable Quantum Convolutional Architecture for High-Fidelity Image Classification](https://arxiv.org/abs/2603.11131)
...
### [68] [Higher-Order Modular Attention: Fusing Pairwise and Triadic Interactions for Protein Sequences](https://arxiv.org/abs/2603.11133)
...
Conclusion: 显式的三阶项为蛋白质序列预测提供了互补的表示能力，且在可控的计算成本增加下实现这一目标
...
### [69] [Scaling Reasoning Efficiently via Relaxed On-Policy Distillation](https://arxiv.org/abs/2603.11137)
...
### [70] [H2LooP Spark Preview: Continual Pretraining of Large Language Models for Low-Level Embedded Systems Code](https://arxiv.org/abs/2603.11139)
*Amit Singh,Vedant Nipane,Pulkit Agrawal,Jatin Kishnani*

Main category: cs.LG

TL;DR: 我们介绍了一种名为H2LooP Spark Preview的持续预训练流程，它通过使用BF16 LoRA对OLMo-3-7B进行适配，使其专注于嵌入式系统编程领域。该模型在嵌入式代码补全任务上超越了更大规模的主流模型。


<details>
  <summary>Details</summary>
Motivation: 大语言模型在通用编程语言上表现出强大的代码生成能力，但在诸如低级嵌入式系统编程等专业领域仍存在局限。这些领域涉及硬件寄存器操作、特定供应商的SDK、实时操作系统API和硬件抽象层，而这些内容在标准的预训练语料库中代表性不足。

Method: 使用BF16格式的秩稳定缩放LoRA，基于专为嵌入式系统构建的大规模数据集，对OLMo-3-7B进行持续预训练。训练数据集来自存储库-数据手册配对，包含100B个原始代币，覆盖117个制造商，并通过一个分级的数据手册到代码映射过程进行策划，最终得到23.5B个代币的精选数据集，涵盖13个嵌入式领域。

Result: 持续预训练取得了显著成效，将领域内困惑度降低了70.4%，将保留存储库的困惑度降低了66.1%。在覆盖13个嵌入式领域的生成式代码补全基准测试中，该7B模型在8个类别的代币准确率上超越了Claude Opus 4.6和Qwen3-Coder-30B。

Conclusion: 持续的预训练流程，特别是结合高秩LoRA适配器的持续预训练，即使对于在专业领域（如嵌入式系统编程）上数据有限的较小开源模型，也能显著提升其领域特异性能力，使其能够与专门为通用编程设计的、规模更大的前沿模型相媲美。
...
### [71] [Procedural Fairness via Group Counterfactual Explanation](https://arxiv.org/abs/2603.11140)
*Gideon Popoola,John Sheppard*

Main category: cs.LG

TL;DR: GCIG通过正则化强制解释不变性来增强过程公平性，在减少跨群体解释差异的同时保持预测性能


<details>
  <summary>Details</summary>
Motivation: 当前机器学习公平性研究主要关注结果导向的公平标准，如均衡几率，而较忽视过程导向的公平性，即模型如何得出预测。忽视过程公平性可能导致模型对不同受保护群体产生不同的解释，从而侵蚀信任。

Method: 提出了组反事实积分梯度(GCIG)，一个内处理的正则化框架，通过对每个输入计算相对于多个组条件基线的解释，并在训练过程中惩罚这些归因的跨群体变化，从而实施跨群体的解释不变性。

Result: GCIG与六种最先进方法相比，显著减少了跨群体解释差异，同时保持了有竞争力的预测性能和准确率-公平性权衡。结果表明跨群体对齐模型推理为推进公平性提供了原则性且实用的途径。

Conclusion: 跨群体对齐模型推理为超越结果平等、推进公平性提供了一条原则性且实用的途径。
...
### [72] [Attention Gathers, MLPs Compose: A Causal Analysis of an Action-Outcome Circuit in VideoViT](https://arxiv.org/abs/2603.11142)
*Sai V R Chereddy*

Main category: cs.LG

TL;DR: 研究者通过机理可解释性技术发现，在视频Transformer中存在一个独立的'成功vs失败'信号计算回路，该回路通过注意力头作为'证据收集器'、MLP块作为'概念合成器'的协作方式运作，揭示了模型内部存在超出其分类任务的复杂知识表示。


<details>
  <summary>Details</summary>
Motivation: 探索可靠AI模型的内在表示机制，特别是模型如何表示微妙、隐含的语义信息，即使这些信息不影响最终分类结果。这对于构建真正可解释、可信赖的AI系统至关重要。

Method: 采用机理可解释性方法，特别是激活修补技术配合消融实验。在预训练的视频视觉Transformer中，反向工程了描述动作结果表示的内部回路。

Result: 发现了'成功vs失败'信号通过独特的放大级联计算：从第5层到第11层逐渐放大抽象语义表示。注意力头作为证据收集器提供低级信息，MLP块作为概念合成器主导生成成功信号。该分布式冗余回路解释了模型对简单消融的鲁棒性。

Conclusion: 即使在仅用于简单分类训练的模型中，也存在表示复杂结果的精密回路，这表明模型可能发展出超出其明确任务的'隐藏知识'，强调了构建真正可解释、可信赖AI系统时需要机理监督的必要性。
...
### [73] [Systematic Scaling Analysis of Jailbreak Attacks in Large Language Models](https://arxiv.org/abs/2603.11149)
...
### [75] [Huntington Disease Automatic Speech Recognition with Biomarker Supervision](https://arxiv.org/abs/2603.11168)
...
### [76] [Bayesian Optimization of Partially Known Systems using Hybrid Models](https://arxiv.org/abs/2603.11199)
...
### [77] [Representation Finetuning for Continual Learning](https://arxiv.org/abs/2603.11201)
...
### [78] [Reference-Guided Machine Unlearning](https://arxiv.org/abs/2603.11210)
...
### [79] [Monitoring and Prediction of Mood in Elderly People during Daily Life Activities](https://arxiv.org/abs/2603.11230)
...
### [80] [Differentiable Thermodynamic Phase-Equilibria for Machine Learning](https://arxiv.org/abs/2603.11249)
...
### [81] [Beyond the Class Subspace: Teacher-Guided Training for Reliable Out-of-Distribution Detection in Single-Domain Models](https://arxiv.org/abs/2603.11269)
...
### [82] [Duration Aware Scheduling for ASR Serving Under Workload Drift](https://arxiv.org/abs/2603.11273)
...
### [83] [Client-Conditional Federated Learning via Local Training Data Statistics](https://arxiv.org/abs/2603.11307)
*Rickard Brännvall*
...
### [84] [Heavy-Tailed Principle Component Analysis](https://arxiv.org/abs/2603.11308)
...
### [85] [On the Robustness of Langevin Dynamics to Score Function Error](https://arxiv.org/abs/2603.11319)
...
### [86] [Hindsight-Anchored Policy Optimization: Turning Failure into Feedback in Sparse Reward Settings](https://arxiv.org/abs/2603.11321)
...
### [87] [Meta-Reinforcement Learning with Self-Reflection for Agentic Search](https://arxiv.org/abs/2603.11327)
...
### [88] [Jailbreak Scaling Laws for Large Language Models: Polynomial-Exponential Crossover](https://arxiv.org/abs/2603.11331)
...
### [89] [Teleodynamic Learning a new Paradigm For Interpretable AI](https://arxiv.org/abs/2603.11355)
...
### [90] [Multilingual Financial Fraud Detection Using Machine Learning and Transformer Models: A Bangla-English Study](https://arxiv.org/abs/2603.11358)
...
### [91] [abx_amr_simulator: A simulation environment for antibiotic prescribing policy optimization under antimicrobial resistance](https://arxiv.org/abs/2603.11369)
...
### [92] [Relaxed Efficient Acquisition of Context and Temporal Features](https://arxiv.org/abs/2603.11370)
...
### [93] [Ensuring Safety in Automated Mechanical Ventilation through Offline Reinforcement Learning and Digital Twin Verification](https://arxiv.org/abs/2603.11372)
...
### [94] [ARROW: Augmented Replay for RObust World models](https://arxiv.org/abs/2603.11395)
...
### [95] [Harnessing Data Asymmetry: Manifold Learning in the Finsler World](https://arxiv.org/abs/2603.11396)
...
### [96] [A Stable Neural Statistical Dependence Estimator for Autoencoder Feature Analysis](https://arxiv.org/abs/2603.11428)
...
### [97] [ZTab: Domain-based Zero-shot Annotation for Table Columns](https://arxiv.org/abs/2603.11436)
...
### [98] [UniHetCO: A Unified Heterogeneous Representation for Multi-Problem Learning in Unsupervised Neural Combinatorial Optimization](https://arxiv.org/abs/2603.11456)
...
### [100] [Slack More, Predict Better: Proximal Relaxation for Probabilistic Latent Variable Model-based Soft Sensors](https://arxiv.org/abs/2603.11473)
...
### [101] [Deep Learning Network-Temporal Models For Traffic Prediction](https://arxiv.org/abs/2603.11475)
...
### [102] [Leveraging Phytolith Research using Artificial Intelligence](https://arxiv.org/abs/2603.11476)
...
### [103] [Grammar of the Wave: Towards Explainable Multivariate Time Series Event Detection via Neuro-Symbolic VLM Agents](https://arxiv.org/abs/2603.11479)
...
### [104] [Attention Sinks Are Provably Necessary in Softmax Transformers: Evidence from Trigger-Conditional Tasks](https://arxiv.org/abs/2603.11487)
*Yuval Ran-Milo*
...
### [105] [KEPo: Knowledge Evolution Poison on Graph-based Retrieval-Augmented Generation](https://arxiv.org/abs/2603.11501)
...
### [106] [Sharpness-Aware Minimization for Generalized Embedding Learning in Federated Recommendation](https://arxiv.org/abs/2603.11503)
...
### [107] [LongFlow: Efficient KV Cache Compression for Reasoning M](https://arxiv.org/abs/2603.11504)
...
### [108] [CFD-HAR: User-controllable Privacy through Conditional Feature Disentanglement](https://arxiv.org/abs/2603.11526)
...
### [109] [Multi-Task Anti-Causal Learning for Reconstructing Urban Events from Residents' Reports](https://arxiv.org/abs/2603.11546)
...
### [110] [CAETC: Causal Autoencoding and Treatment Conditioning for Counterfactual Estimation over Time](https://arxiv.org/abs/2603.11565)
...
### [111] [Survival Meets Classification: A Novel Framework for Early Risk Prediction Models of Chronic Diseases](https://arxiv.org/abs/2603.11598)
...
### [112] [Hybrid Energy-Aware Reward Shaping: A Unified Lightweight Physics-Guided Methodology for Policy Optimization](https://arxiv.org/abs/2603.11600)
...
### [113] [AutoScout: Structured Optimization for Automating ML System Configuration](https://arxiv.org/abs/2603.11603)
...
### [114] [Fractional Rotation, Full Potential? Investigating Performance and Convergence of Partial RoPE](https://arxiv.org/abs/2603.11611)
...
### [115] [Personalized Federated Learning via Gaussian Generative Modeling](https://arxiv.org/abs/2603.11620)
*Peng Hu,Jianwei Ma*
...
### [116] [Simple Recipe Works: Vision-Language-Action Models are Natural Continual Learners with Reinforcement Learning](https://arxiv.org/abs/2603.11653)
...
### [117] [Context-dependent manifold learning: A neuromodulated constrained autoencoder approach](https://arxiv.org/abs/2603.11673)
...
### [118] [Entropy-Preserving Reinforcement Learning](https://arxiv.org/abs/2603.11682)
...
### [119] [EvoFlows: Evolutionary Edit-Based Flow-Matching for Protein Engineering](https://arxiv.org/abs/2603.11703)
...
### [120] [Mitigating the Multiplicity Burden: The Role of Calibration in Reducing Predictive Multiplicity of Classifiers](https://arxiv.org/abs/2603.11750)
*Mustafa Cavus*
...
### [121] [Exploiting Expertise of Non-Expert and Diverse Agents in Social Bandit Learning: A Free Energy Approach](https://arxiv.org/abs/2603.11757)
...
### [122] [A Further Efficient Algorithm with Best-of-Both-Worlds Guarantees for $m$-Set Semi-Bandit Problem](https://arxiv.org/abs/2603.11764)
...
### [123] [Language Generation with Replay: A Learning-Theoretic View of Model Collapse](https://arxiv.org/abs/2603.11784)
...
### [124] [Disentangled Representation Learning through Unsupervised Symmetry Group Discovery](https://arxiv.org/abs/2603.11790)
...
### [125] [Exponential-Family Membership Inference: From LiRA and RMIA to BaVarIA](https://arxiv.org/abs/2603.11799)
*Rickard Brännvall*
...
### [126] [Inverse Neural Operator for ODE Parameter Optimization](https://arxiv.org/abs/2603.11854)
...
### [127] [On the Role of Reversible Instance Normalization](https://arxiv.org/abs/2603.11869)
...
### [128] [FlexRec: Adapting LLM-based Recommenders for Flexible Needs via Reinforcement Learning](https://arxiv.org/abs/2603.11901)
...
### [129] [Causal Representation Learning with Optimal Compression under Complex Treatments](https://arxiv.org/abs/2603.11907)
...
### [130] [EnTransformer: A Deep Generative Transformer for Multivariate Probabilistic Forecasting](https://arxiv.org/abs/2603.11909)
...
### [132] [MobileKernelBench: Can LLMs Write Efficient Kernels for Mobile Devices?](https://arxiv.org/abs/2603.11935)
...
### [133] [Exhaustive Circuit Mapping of a Single-Cell Foundation Model Reveals Massive Redundancy, Heavy-Tailed Hub Architecture, and Layer-Dependent Differentiation Control](https://arxiv.org/abs/2603.11940)
*Ihor Kendiukhov*
...
### [134] [Causal Matrix Completion under Multiple Treatments via Mixed Synthetic Nearest Neighbors](https://arxiv.org/abs/2603.11942)
...
### [135] [Effective Resistance Rewiring: A Simple Topological Correction for Over-Squashing](https://arxiv.org/abs/2603.11944)
...
### [136] [Geometry-Aware Probabilistic Circuits via Voronoi Tessellations](https://arxiv.org/abs/2603.11946)
...
### [137] [Statistical and structural identifiability in representation learning](https://arxiv.org/abs/2603.11970)
...
### [138] [Topological DeepONets and a generalization of the Chen-Chen operator approximation theorem](https://arxiv.org/abs/2603.11972)
*Vugar Ismailov*
...
### [139] [On-Average Stability of Multipass Preconditioned SGD and Effective Dimension](https://arxiv.org/abs/2603.11989)
...
### [140] [Deep Learning-Based Metamodeling of Nonlinear Stochastic Dynamic Systems under Parametric and Predictive Uncertainty](https://arxiv.org/abs/2603.12012)
...
### [141] [Flowcean - Model Learning for Cyber-Physical Systems](https://arxiv.org/abs/2603.12015)
...
### [142] [Efficient Generative Modeling with Unitary Matrix Product States Using Riemannian Optimization](https://arxiv.org/abs/2603.12026)
...
### [143] [Frequentist Consistency of Prior-Data Fitted Networks for Causal Inference](https://arxiv.org/abs/2603.12037)
...
### [144] [Slow-Fast Inference: Training-Free Inference Acceleration via Within-Sentence Support Stability](https://arxiv.org/abs/2603.12038)
...
### [145] [Chemical Reaction Networks Learn Better than Spiking Neural Networks](https://arxiv.org/abs/2603.12060)
...
### [146] [A Multi-Label Temporal Convolutional Framework for Transcription Factor Binding Characterization](https://arxiv.org/abs/2603.12073)
...
### [147] [Cross-Domain Policy Optimization via Bellman Consistency and Hybrid Critics](https://arxiv.org/abs/2603.12087)
...
### [148] [Resource-Efficient Iterative LLM-Based NAS with Feedback Memory](https://arxiv.org/abs/2603.12091)
...
### [149] [Taming the Adversary: Stable Minimax Deep Deterministic Policy Gradient via Fractional Objectives](https://arxiv.org/abs/2603.12110)
...
### [150] [Cornserve: A Distributed Serving System for Any-to-Any Multimodal Models](https://arxiv.org/abs/2603.12118)
...
### [151] [Automatic Generation of High-Performance RL Environments](https://arxiv.org/abs/2603.12145)
...
### [152] [IsoCompute Playbook: Optimally Scaling Sampling Compute for LLM RL](https://arxiv.org/abs/2603.12151)
...
### [153] [A Quantitative Characterization of Forgetting in Post-Training](https://arxiv.org/abs/2603.12163)
...
### [155] [Security Considerations for Artificial Intelligence Agents](https://arxiv.org/abs/2603.12230)
...
### [156] [Temporal Straightening for Latent Planning](https://arxiv.org/abs/2603.12231)
...
### [157] [Separable neural architectures as a primitive for unified predictive and generative intelligence](https://arxiv.org/abs/2603.12244)
...
### [159] [The Latent Color Subspace: Emergent Order in High-Dimensional Chaos](https://arxiv.org/abs/2603.12261)
