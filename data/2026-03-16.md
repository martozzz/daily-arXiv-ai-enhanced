...
TL;DR: 论文解开了表格机器学习的一个悖论：高维、共线、有误差的数据为何能实现最佳性能。研究揭示了稳健性源于数据结构与模型能力的协同，提出了基于信息论的新理论框架，并为直接从企业'数据沼泽'学习的'本地工厂'部署范式提供了理论依据。


<details>
  <summary>Details</summary>
Motivation: 探讨现代表格机器学习中存在的悖论：为何高维、共线、存在误差的数据能帮助模型取得最佳性能，这与'垃圾进、垃圾出'的传统观念相矛盾。

Method: 研究结合了信息论、潜在因子模型与心理测量学的原理，分析了预测变量空间中的噪声类别：'预测误差'与'结构性不确定性'。证明在高维场景下利用存在误差的预测变量集合能渐进地克服两种噪声，并探索了'信息性共线性'对可靠性的增强作用。提出了'主动数据为中心的AI'（Proactive DCAI）实践框架以高效识别提升稳健性的预测变量。

Result: 理论分析表明，在表格机器学习中，预测的稳健性源自数据结构与模型能力的协同作用，而非单纯的数据'洁净度'。高维、带有信息性共线性的错误预测变量集可以从理论上渐近地克服预测误差和结构性不确定性。研究还界定了'系统性误差机制'的边界，解释了模型吸收'异常'依赖可以缓解假设违反问题，并将潜在结构框架与良性过拟合联系起来。

Conclusion: 该研究通过重新定义数据质量的标准——从追求单个指标的完美转为关注整体数据结构，为'本地数据工厂'（直接从企业的原始'数据沼泽'中学习）提供了理论支持，推动了部署模式从'模型迁移'向'方法迁移'的转变，以克服静态泛化能力的局限性。
...
TL;DR: 这篇论文综述了脑信号生成技术如何解决脑机接口领域的数据稀缺问题，介绍了四种主要的生成方法并进行了基准实验比较。


<details>
  <summary>Details</summary>
Motivation: 脑机接口的发展受到神经记录数据有限、异构且隐私敏感的限制，需要生成生理上可信的合成脑信号来缓解数据稀缺问题并增强模型能力。

Method: 论文系统地采用四种分类方法：基于知识的方法、基于特征的方法、基于模型的方法和基于转换的方法。通过四个代表性脑机接口范式的基准实验来客观比较现有生成方法的性能。

Result: 提出了一个全面的脑机接口脑信号生成综述框架，公开了基准代码库，并对不同生成方法的性能进行了比较分析。

Conclusion: 当前的脑信号生成方法具有潜力但也面临挑战，未来研究应关注开发更加准确、数据高效且具备隐私保护能力的脑机接口系统。
...
### [4] [Global Evolutionary Steering: Refining Activation Steering Control via Cross-Layer Consistency](https://arxiv.org/abs/2603.12298)
...
### [5] [A Geometrically-Grounded Drive for MDL-Based Optimization in Deep Learning](https://arxiv.org/abs/2603.12304)
...
### [6] [HCP-DCNet: A Hierarchical Causal Primitive Dynamic Composition Network for Self-Improving Causal Understanding](https://arxiv.org/abs/2603.12305)
*Ming Lei,Shufan Wu,Christophe Baehr*
...
TL;DR: 该论文建立了漂移生成动态与Sinkhorn散度梯度流之间的理论联系，提出了Sinkhorn漂移方法，解决了先前漂移公式的可识别性问题，并显著改善了低温度下的生成性能。


<details>
  <summary>Details</summary>
Motivation: 本文旨在建立最近提出的

Method: 建立了

Result: 实验结果表明，Sinkhorn漂移方法能减少对核温度的敏感性并改善一步生成质量。在FFHQ-ALAE和MNIST数据集上的评估显示，在最低温度设置下，该方法将平均FID从187.7降至37.1，将平均潜在EMD从453.3降至144.4，并在温度扫描中保持了完整的类别覆盖。

Conclusion: 本文提出Sinkhorn漂移方法，通过将漂移动态与Sinkhorn散度的梯度流联系起来，解决了先前漂移公式中存在的可识别性间隙问题。该方法在保持推理过程不变的情况下，通过增加训练时间换取更稳定的优化，显著改善了低温度设置下的生成质量，在多项实验中获得了优越的性能表现。
...
### [10] [Overcoming the Modality Gap in Context-Aided Forecasting](https://arxiv.org/abs/2603.12451)
...
### [11] [Modal Logical Neural Networks for Financial AI](https://arxiv.org/abs/2603.12487)
*Antonin Sulc*
...
### [13] [Adaptive Conditional Forest Sampling for Spectral Risk Optimisation under Decision-Dependent Uncertainty](https://arxiv.org/abs/2603.12507)
*Marcell T. Kurbucz*
...
### [14] [Byzantine-Robust Optimization under $(L_0, L_1)$-Smoothness](https://arxiv.org/abs/2603.12512)
...
### [15] [Learning Pore-scale Multiphase Flow from 4D Velocimetry](https://arxiv.org/abs/2603.12516)
...
### [16] [Curriculum Sampling: A Two-Phase Curriculum for Efficient Training of Flow Matching](https://arxiv.org/abs/2603.12517)
*Pengwei Sun*
...
### [17] [When LLM Judge Scores Look Good but Best-of-N Decisions Fail](https://arxiv.org/abs/2603.12520)
*Eddie Landesberg*
...
### [18] [TERMINATOR: Learning Optimal Exit Points for Early Stopping in Chain-of-Thought Reasoning](https://arxiv.org/abs/2603.12529)
...
### [19] [A Reduction Algorithm for Markovian Contextual Linear Bandits](https://arxiv.org/abs/2603.12530)
...
### [20] [Embedded Quantum Machine Learning in Embedded Systems: Feasibility, Hybrid Architectures, and Quantum Co-Processors](https://arxiv.org/abs/2603.12540)
...
### [21] [As Language Models Scale, Low-order Linear Depth Dynamics Emerge](https://arxiv.org/abs/2603.12541)
...
### [22] [CALF: Communication-Aware Learning Framework for Distributed Reinforcement Learning](https://arxiv.org/abs/2603.12543)
...
### [23] [Deep Distance Measurement Method for Unsupervised Multivariate Time Series Similarity Retrieval](https://arxiv.org/abs/2603.12544)
...
### [24] [Asymptotic and Finite-Time Guarantees for Langevin-Based Temperature Annealing in InfoNCE](https://arxiv.org/abs/2603.12552)
*Faris Chaudhry*
...
### [25] [Reinforcement Learning for Diffusion LLMs with Entropy-Guided Step Selection and Stepwise Advantages](https://arxiv.org/abs/2603.12554)
...
### [26] [Scaling Laws and Pathologies of Single-Layer PINNs: Network Width and PDE Nonlinearity](https://arxiv.org/abs/2603.12556)
*Faris Chaudhry*
...
### [27] [CA-HFP: Curvature-Aware Heterogeneous Federated Pruning with Model Reconstruction](https://arxiv.org/abs/2603.12591)
...
### [28] [Lyapunov Stable Graph Neural Flow](https://arxiv.org/abs/2603.12557)
...
### [29] [Swap-guided Preference Learning for Personalized Reinforcement Learning from Human Feedback](https://arxiv.org/abs/2603.12595)
...
### [32] [Feynman: Knowledge-Infused Diagramming Agent for Scalable Visual Designs](https://arxiv.org/abs/2603.12597)
...
### [33] [Maximizing Incremental Information Entropy for Contrastive Learning](https://arxiv.org/abs/2603.12594)
...
### [36] [Spend Less, Reason Better: Budget-Aware Value Tree Search for LLM Agents](https://arxiv.org/abs/2603.12634)
...
### [37] [LightMoE: Reducing Mixture-of-Experts Redundancy through Expert Replacing](https://arxiv.org/abs/2603.12645)
...
### [38] [RetroReasoner: A Reasoning LLM for Strategic Retrosynthesis Prediction](https://arxiv.org/abs/2603.12666)
...
### [39] [Federated Hierarchical Clustering with Automatic Selection of Optimal Cluster Numbers](https://arxiv.org/abs/2603.12684)
...
### [40] [Cost-Efficient Multimodal LLM Inference via Cross-Tier GPU Heterogeneity](https://arxiv.org/abs/2603.12707)
*Donglin Yu*
...
### [41] [Graph In-Context Operator Networks for Generalizable Spatiotemporal Prediction](https://arxiv.org/abs/2603.12725)
...
### [43] [TaoBench: Do Automated Theorem Prover LLMs Generalize Beyond MathLib?](https://arxiv.org/abs/2603.12744)
...
### [44] [Residual SODAP: Residual Self-Organizing Domain-Adaptive Prompting with Structural Knowledge Preservation for Continual Learning](https://arxiv.org/abs/2603.12816)
...
### [45] [Sobolev--Ricci Curvature](https://arxiv.org/abs/2603.12652)
...
### [46] [Hierarchical Reference Sets for Robust Unsupervised Detection of Scattered and Clustered Outliers](https://arxiv.org/abs/2603.12847)
...
### [48] [Disentangled Latent Dynamics Manifold Fusion for Solving Parameterized PDEs](https://arxiv.org/abs/2603.12676)
...
### [50] [L2GTX: From Local to Global Time Series Explanations](https://arxiv.org/abs/2603.13065)
...
### [52] [GeoChemAD: Benchmarking Unsupervised Geochemical Anomaly Detection for Mineral Exploration](https://arxiv.org/abs/2603.13068)
...
### [53] [BoSS: A Best-of-Strategies Selector as an Oracle for Deep Active Learning](https://arxiv.org/abs/2603.13109)
...
### [55] [MXNorm: Reusing MXFP block scales for efficient tensor normalisation](https://arxiv.org/abs/2603.13180)
...
### [56] [Learnability and Privacy Vulnerability are Entangled in a Few Critical Weights](https://arxiv.org/abs/2603.13186)
...
### [57] [PhysMoDPO: Physically-Plausible Humanoid Motion with Preference Optimization](https://arxiv.org/abs/2603.13228)
...
### [65] [SCOPE: Semantic Coreset with Orthogonal Projection Embeddings for Federated learning](https://arxiv.org/abs/2603.12976)
...
### [66] [Exact Federated Continual Unlearning for Ridge Heads on Frozen Foundation Models](https://arxiv.org/abs/2603.12977)
...
### [67] [Retrieval-Enhanced Real Estate Appraisal](https://arxiv.org/abs/2603.12986)
...
### [68] [Dependency-Aware Parallel Decoding via Attention for Diffusion LLMs](https://arxiv.org/abs/2603.12996)
...
### [69] [Deconstructing the Failure of Ideal Noise Correction: A Three-Pillar Diagnosis](https://arxiv.org/abs/2603.12997)
...
### [70] [PISmith: Reinforcement Learning-based Red Teaming for Prompt Injection Defenses](https://arxiv.org/abs/2603.13026)
...
### [71] [OpenACMv2: An Accuracy-Constrained Co-Optimization Framework for Approximate DCiM](https://arxiv.org/abs/2603.13042)
...
### [72] [3DTCR: A Physics-Based Generative Framework for Vortex-Following 3D Reconstruction to Improve Tropical Cyclone Intensity Forecasting](https://arxiv.org/abs/2603.13049)
...
### [73] [Causal Cellular Context Transfer Learning (C3TL): An Efficient Architecture for Prediction of Unseen Perturbation Effects](https://arxiv.org/abs/2603.13051)
...
### [74] [Fractals made Practical: Denoising Diffusion as Partitioned Iterated Function Systems](https://arxiv.org/abs/2603.13069)
*Ann Dooms*
...
### [75] [Influence Malleability in Linearized Attention: Dual Implications of Non-Convergent NTK Dynamics](https://arxiv.org/abs/2603.13085)
...
### [76] [Breaking the Tuning Barrier: Zero-Hyperparameters Yield Multi-Corner Analysis Via Learned Priors](https://arxiv.org/abs/2603.13092)
...
### [78] [Representation Learning for Spatiotemporal Physical Systems](https://arxiv.org/abs/2603.13227)
...
### [79] [Context-Enriched Natural Language Descriptions of Vessel Trajectories](https://arxiv.org/abs/2603.12287)
...
TL;DR: 提出一个将AIS轨迹转换为结构化、语义丰富的表示的框架，以支持LLM生成自然语言描述并促进海事分析。   , 


<details>
  <summary>Details</summary>
Motivation: 原始AIS记录存在噪声且缺乏语义，难以用于LLM推理和人类理解。需要结构化且包含地理实体、导航特征、天气等多源上下文的丰富语义表示。

Method: 提出语境感知的轨迹抽象框架，将噪声AIS序列分割为独立航次，每个航次包含洁净、带移动标注的片段，并用多源上下文（地理实体、导航特征、天气）增强。这种表示支持使用多个LLM生成受控自然语言描述，并进行质量检验。

Result: 通过多个LLM在AIS数据和开放上下文特征上生成描述，证明该框架能产生高质量语义表示。通过提高语义密度和降低时空复杂性，支持下游分析与LLM集成。

Conclusion: 该抽象框架能促进下游分析，并支持与LLM集成，从而实现更高层次的海事推理任务
...
### [80] [Efficient Reasoning with Balanced Thinking](https://arxiv.org/abs/2603.12372)
...
### [81] [On Using Machine Learning to Early Detect Catastrophic Failures in Marine Diesel Engines](https://arxiv.org/abs/2603.12733)
*Francesco Maione,Paolo Lino,Giuseppe Giannino,Guido Maione*

Main category: cs.AI

TL;DR: 提出一种基于随机森林和偏差导数分析的船舶发动机灾难性故障早期检测方法。


<details>
  <summary>Details</summary>
Motivation: 船舶发动机的灾难性故障具有突发性和不可预测性，对航行安全和人员构成严重威胁，而现有研究主要关注部件逐渐退化，对突发异常现象的检测研究有限。

Method: 基于随机森林算法，通过监测传感器读数与预期值的偏差导数来检测异常动态。

Result: 仿真结果和真实数据验证表明，该方法能有效提前预警灾难性故障的发生，具有鲁棒性和实用价值。

Conclusion: 该方法能够提前检测到异常信号，为操作人员提供足够的时间采取措施，从而防止灾难性故障的发生，提高了船舶航行的安全性。
...
### [82] [AI Model Modulation with Logits Redistribution](https://arxiv.org/abs/2603.12755)
...
### [83] [Context is all you need: Towards autonomous model-based process design using agentic AI in flowsheet simulations](https://arxiv.org/abs/2603.12813)
*Pascal Schäfer,Lukas J. Krinke,Martin Wlotzka,Norbert Asprion*

Main category: cs.AI

TL;DR: 研究提出了一个基于大语言模型的多智能体AI框架，用于化工过程流程图模拟，能够将工程问题分解并自动生成Chemasim代码，展示了在多个典型化工流程建模场景中的有效性。


<details>
  <summary>Details</summary>
Motivation: 尽管基于大语言模型的智能体AI系统在软件开发等领域已得到广泛应用，但在化工过程流程图建模领域的应用仍处于未充分探索状态。本研究旨在开发一个能够在工业流程图模拟环境中提供协助的智能体AI框架。

Method: 基于GitHub Copilot与先进LLM（如Claude Opus 4.6）开发了一个多智能体系统：一个智能体利用工程知识解决抽象问题，另一个智能体将解决方案实现为Chemasim代码。系统使用技术文档和注释示例作为上下文来生成有效语法。

Result: 该框架在典型流程图建模示例中表现出有效性，包括：反应/分离过程、压力波动蒸馏、以及包含夹带剂选择的异相共沸蒸馏。

Conclusion: 尽管该框架在化工流程模拟领域展现出了有前景的潜力，但仍存在一定局限性，如对技术文档质量的依赖、复杂工程推理能力有限等；需要未来研究来进一步提升其能力，特别是在处理更复杂工程问题和提高代码生成可靠性方面。
...
### [84] [ODRL Policy Comparison Through Normalisation](https://arxiv.org/abs/2603.12926)
*Jaime Osvaldo Salas,Paolo Pareti,George Konstantinidis*

Main category: cs.AI

TL;DR: 针对ODRL语言的复杂性导致策略比较和处理困难的问题，提出语义保持的归一化方法将策略转化为规范形式，实现策略简化和标准化。


<details>
  <summary>Details</summary>
Motivation: ODRL语言作为数字权益表达的标准语言，其复杂性阻碍了实际应用，导致相关理论和实践工作专注于ODRL的不同片段且彼此不互通。此外，语义相同的策略可以有多种不同表达方式，这使得策略比较和处理变得困难。

Method: 基于现有语义定义，提出参数化归一化方法，将ODRL策略转化为最小组件形式，将包含权限和禁止的策略转化为仅包含权限的策略，并将复杂逻辑约束简化为简单约束。提供了计算ODRL策略标准形式和简化数值及符号约束的算法。

Result: 证明了算法能够保持策略语义不变，并分析了结果大小复杂度，即与属性数量呈指数关系，与属性唯一值数量呈线性关系。展示了该方法如何使复杂策略在更基本的ODRL片段中表示，并将策略比较问题简化为检查两条规则是否相同的简单问题。

Conclusion: 本研究通过为ODRL策略设计归一化和简化算法，有效降低了语言的复杂性，为解决策略比较和处理的难题提供了自动化解决方案，使复杂策略能在基本ODRL片段中表示。
...
### [85] [Efficient and Interpretable Multi-Agent LLM Routing via Ant Colony Optimization](https://arxiv.org/abs/2603.12933)
...
### [86] [Beyond Final Answers: CRYSTAL Benchmark for Transparent Multimodal Reasoning Evaluation](https://arxiv.org/abs/2603.13099)
...
### [87] [Steve-Evolving: Open-World Embodied Self-Evolution via Fine-Grained Diagnosis and Dual-Track Knowledge Distillation](https://arxiv.org/abs/2603.13131)
...
### [88] [When Right Meets Wrong: Bilateral Context Conditioning with Reward-Confidence Correction for GRPO](https://arxiv.org/abs/2603.13134)
*Yu Li,Tian Lan,Zhengling Qi*

Main category: cs.AI

TL;DR: 该论文提出了对GRPO（Group Relative Policy Optimization）方法的改进，通过引入BICC（双边上下文条件化）和RCC（奖励置信度修正）机制，利用正确与错误解之间的对比信息来增强推理模型的训练效果


<details>
  <summary>Details</summary>
Motivation: 现有GRPO方法虽然基于组均值计算优势函数，但在优化时将每个输出视为独立样本，忽略了同一组内正确解与错误解之间的自然对比信号，未能充分利用成功与失败推理轨迹之间的对比信息

Method: 1) 通过对比重述GRPO，揭示其目标隐式最大化正确与错误样本策略比率之间的边际；2) 提出BICC机制，使模型在优化过程中能够交叉参考成功与失败的推理轨迹；3) 引入RCC机制，通过奖励-置信度协方差动态调整GRPO中的优势基线以稳定训练

Result: 在数学推理基准测试上的实验表明，该方法在各种模型和算法上都带来了持续的改进，且无需额外采样或辅助模型，可适配所有GRPO变体

Conclusion: 通过显式利用正确与错误推理轨迹之间的对比信息，并引入BICC和RCC机制，显著提升了GRPO方法的训练效果，为推理模型优化提供了新的有效方法
...
### [89] [Developing and evaluating a chatbot to support maternal health care](https://arxiv.org/abs/2603.13168)
...
TL;DR: 本文介绍了一个基于手机聊天机器人的印度孕产妇健康信息系统，采用多层防御深度设计和多方法评估框架，结合智能分流、混合检索和LLM生成技术来提供可信的健康信息。


<details>
  <summary>Details</summary>
Motivation: 在资源匮乏地区，用户健康素养低且医疗服务有限，提供可信的孕产妇健康信息具有重要影响。然而，用户查询简短、模糊、多语言混杂，答案需要地域特异性，症状信息不全使安全分流困难，部署技术挑战大。

Method: 1. stage-aware triage, routing high-risk queries to expert templates\n2. hybrid retrieval over curated maternal/newborn guidelines\n3. evidence-conditioned generation from an LLM\nCore contribution: evaluation workflow for high-stakes deployment including: (i) labeled triage benchmark (N=150), (ii) synthetic multi-evidence retrieval benchmark (N=100), (iii) LLM-as-judge comparison on real queries (N=781), (iv) expert validation

Result: 分流基准实现86.7%紧急情况召回率，明确报告了漏诊与过度升级权衡；评估框架展示在有限专家监督下，需防御深度设计和多方法评估相结合，而非单一模型选择。

Conclusion: 在多语言嘈杂环境中构建可信医疗助手需要防御深度设计与多方法评估相结合的系统方法，而非依赖单一模型或评估方法选择，通过合作伙伴关系和全面评估流程可以应对资源匮乏地区孕产妇健康信息部署的技术挑战。
...
### [90] [Semantic Invariance in Agentic AI](https://arxiv.org/abs/2603.13173)
